...
!0,!this.finished)?(ControlMode.mode!==ControlMode.Pointer&&androidWrapper&&ControlMode.processAndroidAcceleration(),b.step(this.paused),a=View.gl,a.draw(this.levelTexture,LevelSpriteSheet.LevelModelCoordinates,this.globalAlpha[0],LevelSpriteSheet.FullTextureCoordinates,0,-(this.viewY[0]*scaleFactor|0)),a.prepareNativeDraw(View.sheetTexture),cLib._render(a.verticesPtr,b.levelPtr,LevelSpriteSheet.LevelSpriteSheetPtr,scaleFactor)&&(this.finished=!0,this.pointerCursorAttached[0]=0,this.victory[0]?a.clearColor(253/
255,190/255,148/255,1):a.clearColor(.8,.8,1,1),this.preview?this.pause(null):(this.totalElapsedMilliseconds&&(b=this.checkRecord(),null===b?(UISpriteSheet.change(this.timeDisplayImage,UISpriteSheet.Clock),this.timeDisplayText.nodeValue=LevelCache.formatLevelRecordTime(this.totalElapsedMilliseconds[0]),this.editNameButton.style.display="none"):(b&&LevelCache.setLevelRecord(this.level.name,this.totalElapsedMilliseconds[0],b),UISpriteSheet.change(this.timeDisplayImage,UISpriteSheet.Trophy),this.setTimeDisplayTextRecord(b),
