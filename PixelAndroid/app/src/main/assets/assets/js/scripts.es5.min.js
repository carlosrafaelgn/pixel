...
enumerable:!1,configurable:!0});b.prototype.resize=function(){var c=css(63),e=css(maxHeight),d=css(b.BrushWidths[this.lastBrushWidth]);this.toolbarTop.style.height=toolbarAvailableHeightCss;this.toolbarTop.style.borderBottomWidth=borderWidthCss;this.toolbarBottom.style.height=toolbarAvailableHeightCss;this.toolbarBottom.style.borderTopWidth=borderWidthCss;this.canvas.style.height=e;this.setGridBackground();this.scrollContainer.containerElement.style.backgroundSize=c+" "+c;this.scrollContainer.resize(toolbarTotalHeight,
baseHeight-(toolbarTotalHeight<<1));this.pointerCursor.style.borderWidth=borderWidthCss;this.pointerCursor.style.width=d;this.pointerCursor.style.height=d;c=this.level.objects;for(e=c.length-1;0<=e;e--){d=c[e];var f=this.objectImages[e];f.style.left=css(d.x-iconRadius);f.style.top=css(d.y-iconRadius);UISpriteSheet.resize(f)}a.prototype.resize.call(this)};b.prototype.attach=function(){return __awaiter(this,void 0,void 0,function(){var c,e,d,f,g,h,l;return __generator(this,function(k){switch(k.label){case 0:View.glCanvas.style.display=
"none";if(this.level)return[3,2];c=this;return[4,LevelCache.loadLevelFromOptions(this.loadOptions)];case 1:c.level=k.sent();this.loadOptions&&(this.loadOptions.levelNameOverride&&(this.level.name=this.loadOptions.levelNameOverride),this.loadOptions=null);e=this.level.objects;d=e.length;for(f=0;f<d;f++)this.addObject(e[f],!0);k.label=2;case 2:return this.pointerHandler=new PointerHandler(this.canvas,this.mouseDown.bind(this),this.mouseMove.bind(this),this.mouseUp.bind(this)),this.scrollContainer.attach(),
[4,loadImage(b.brushesImageDataBase64)];case 3:g=k.sent();this.brushCanvas=document.createElement("canvas");this.brushCanvas.width=g.width;this.brushCanvas.height=g.height;this.brushContext=this.brushCanvas.getContext("2d",{alpha:!0});this.brushContext.drawImage(g,0,0);this.updateBrushColor(colors[this.lastPencilColor]);this.context=this.canvas.getContext("2d",{alpha:!0});this.context.globalCompositeOperation="source-over";this.context.clearRect(0,0,baseWidth,maxHeight);setContextQuality(this.context,
!1);if(!this.level.image)return[3,5];l=(h=this.context).drawImage;return[4,loadImage(this.level.image)];case 4:l.apply(h,[k.sent(),0,0]),k.label=5;case 5:return this.context.globalCompositeOperation=this.contextGlobalCompositeOperation,this.boundDocumentKeyUp&&document.addEventListener("keyup",this.boundDocumentKeyUp,!0),[2]}})})};b.prototype.detach=function(){return __awaiter(this,void 0,void 0,function(){return __generator(this,function(c){View.glCanvas.style.display="";this.pointerHandler&&(this.pointerHandler.destroy(),
this.pointerHandler=null);this.scrollContainer.detach();this.brushContext=this.brushCanvas=this.context=null;this.boundDocumentKeyUp&&document.removeEventListener("keyup",this.boundDocumentKeyUp,!0);return[2]})})};b.prototype.destroyInternal=function(c){this.save()};b.prototype.save=function(){if(this.dirty||!this.level.image)this.level.modifiedAt=(new Date).getTime(),this.level.createdAt||(this.level.createdAt=this.level.modifiedAt),this.level.thumbnailImage="",this.level.image=this.canvas.toDataURL("image/png"),
this.level.processedImage="",this.level.polygons=[],LevelCache.saveEditorLevel(this.level),this.dirty=!1};b.prototype.updatePointerCursor=function(c,e){var d=cssNumber(.5*b.BrushWidths[this.lastBrushWidth]+1);this.pointerCursor.style.left=c-d+"px";this.pointerCursor.style.top=e-d+this.scrollContainer.topCss+"px"};b.prototype.mouseDown=function(c){if(View.loading)return!1;var e=this.scrollContainer.containerElement.getBoundingClientRect(),d=c.clientX-e.left;c=c.clientY-e.top;this.dirty=!0;switch(this.tool){case b.ToolPencil:case b.ToolEraser:this.pointerCursorAttached||
(this.pointerCursorAttached=!0,this.updatePointerCursor(d,c),this.scrollContainer.element.appendChild(this.pointerCursor));this.draw((this.pointerLastX=model(d)-1)+1,this.pointerLastY=model(c));break;default:this.handleObjectToolDown(d,c)}return!0};b.prototype.mouseMove=function(c){var e=this.scrollContainer.containerElement.getBoundingClientRect(),d=c.clientX-e.left;c=c.clientY-e.top;switch(this.tool){case b.ToolPencil:case b.ToolEraser:e=model(d);var f=model(c);if(this.pointerLastX!==e||this.pointerLastY!==
f)this.updatePointerCursor(d,c),this.draw(e,f),this.pointerLastX=e,this.pointerLastY=f;break;default:this.handleObjectToolMove(d,c)}};b.prototype.mouseUp=function(c){this.objectImageDrag=null;this.pointerCursorAttached&&(this.pointerCursorAttached=!1,this.scrollContainer.element.removeChild(this.pointerCursor));switch(this.tool){case b.ToolPencil:case b.ToolEraser:return}c=this.level.objects;var e=this.objectImages;e.sort(function(h,l){h=h.object;l=l.object;return h.type-l.type||l.y-h.y});for(var d=
e.length-1,f=1;0<=d;d--,f++){var g=e[d];g.style.zIndex=f.toString();c[d]=g.object}};b.prototype.draw=function(c,e){c-=this.pointerLastX;e-=this.pointerLastY;var d=Math.abs(c),f=Math.abs(e);if(d||f){var g=b.BrushWidths[this.lastBrushWidth],h=g>>1,l=b.BrushOffsets[this.lastBrushWidth];d=Math.max(d,f);f=this.pointerLastX;var k=this.pointerLastY;c/=d;for(e/=d;0<d;)d--,f+=c,k+=e,d&1||(this.lastPencilColor===colors.length-1&&(this.lastPencilRainbowIndex++,this.lastPencilRainbowIndex>=rainbowColors.length&&
(this.lastPencilRainbowIndex=0),this.updateBrushColor(rainbowColors[this.lastPencilRainbowIndex])),this.context.drawImage(this.brushCanvas,l,0,g,g,(f|0)-h,(k|0)-h,g,g))}};b.prototype.handleObjectToolDown=function(c,e){var d=model(c),f=model(e);if(this.tool>=b.ToolBall&&this.tool<=b.ToolCucumber){this.objectImageDrag=this.findObjectWithinRadius(-1,d,f);if(!this.objectImageDrag&&(this.objectImageDrag=this.addObject(new LevelObject(this.lastObjectType,d,f),!1),!this.objectImageDrag))return;d=this.scrollContainer.containerElement.getBoundingClientRect();
