...
a.About6='<p>Voc\u00ea tamb\u00e9m pode <a href="https://play.google.com/store/apps/details?id=br.com.carlosrafaelgn.pixel" target="_blank">instalar uma vers\u00e3o para Android</a> (apenas para manter a tela ligada mesmo sem que ela seja tocada).</p>',a.About7='<p>O c\u00f3digo-fonte do jogo pode ser encontrado no <a href="https://github.com/carlosrafaelgn/pixel" target="_blank">GitHub</a> e \u00e9 licenciado sob a <a href="https://github.com/carlosrafaelgn/pixel/blob/master/LICENSE" target="_blank">MIT License</a>. O jogo usa o motor de f\u00edsica <a href="https://github.com/slembcke/Chipmunk2D" target="_blank">Chipmunk2D</a>, licenciado sob a <a href="https://github.com/slembcke/Chipmunk2D/blob/master/LICENSE.txt" target="_blank">MIT License</a>, e tamb\u00e9m usa a fonte <a href="https://github.com/google/fonts/tree/master/ofl/pressstart2p" target="_blank">Press Start 2P</a>, licenciada sob a <a href="https://github.com/google/fonts/blob/master/ofl/pressstart2p/OFL.txt" target="_blank">SIL Open Font License</a>.</p>',
a.LevelDeleted="Fase exclu\u00edda! ",a.LevelDownloaded="Download da fase conclu\u00eddo! ",a.TryToDownloadAgain="Por favor, tente realizar o download da fase novamente, depois de conceder permiss\u00e3o.",a.DownloadFailedFileExists="Desculpe! N\u00e3o foi poss\u00edvel realizar o download da fase porque j\u00e1 existe um arquivo com o mesmo nome na pasta Download ",a.LevelImageDownloaded="Download da imagem conclu\u00eddo! ",a.TryToDownloadLevelImageAgain="Por favor, tente realizar o download da imagem novamente, depois de conceder permiss\u00e3o.",
...
this.vertexShader=this.program=null;this.verticesPtr=this.rectangleCount=0;this.context=this.vertices=null;this.contextVersion=0;this.framebufferTexture=this.framebuffer=null}a.prototype.clearErrors=function(){for(var b=this.context,c=3;b.getError()!==b.NO_ERROR&&0<c--;)b.getError()};a.prototype.throwIfError=function(b){void 0===b&&(b=1);var c=this.context.getError();if(!b||c!==this.context.NO_ERROR)throw Error("WebGL error: "+c);};a.prototype.prepareNativeDraw=function(b){this.flush();this.currentTexture=
b};a.prototype.drawNative=function(b){this.rectangleCount=b;this.flush()};a.prototype.checkRecreate=function(b){return!this.context||this.context.isContextLost()||b.width!==this.viewWidth||b.height!==this.viewHeight};a.nextPowerOfTwo=function(b){if(!(b&b-1))return b;b|=b>>>1;b|=b>>>2;b|=b>>>4;b|=b>>>8;return(b|b>>>16)+1};a.prototype.recreate=function(b,c,e){var d=b.width,f=b.height;this.destroy(!0);if(!isIOSOrSafari&&"undefined"!==typeof WebGL2RenderingContext)try{this.context=b.getContext("webgl2",
{alpha:!1,depth:!1,stencil:!1,antialias:!1,premultipliedAlpha:!0}),this.contextVersion=2}catch(h){}if(!this.context)try{this.context=b.getContext("webgl",{alpha:!1,depth:!1,stencil:!1,antialias:!1,premultipliedAlpha:!0}),this.contextVersion=1}catch(h){}this.context||(this.context=b.getContext("experimental-webgl",{alpha:!1,depth:!1,stencil:!1,antialias:!1,premultipliedAlpha:!0}),this.contextVersion=1);if(!this.context)throw Error("WebGL apparently not supported");b=this.context;this.clearErrors();
this.viewWidth=d;this.viewHeight=f;d=this.program=b.createProgram();this.throwIfError(d);f=this.vertexShader=b.createShader(b.VERTEX_SHADER);this.throwIfError(f);b.shaderSource(f,2===this.contextVersion?a.VertexShaderSource2:a.VertexShaderSource);b.compileShader(f);if(!b.getShaderParameter(f,b.COMPILE_STATUS))throw Error("WebGL vertex shader compilation error: "+b.getShaderInfoLog(f));this.throwIfError();var g=this.fragmentShader=b.createShader(b.FRAGMENT_SHADER);this.throwIfError(g);b.shaderSource(g,
2===this.contextVersion?a.FragmentShaderSource2:a.FragmentShaderSource);b.compileShader(g);if(!b.getShaderParameter(g,b.COMPILE_STATUS))throw Error("WebGL fragment shader compilation error: "+b.getShaderInfoLog(g));this.throwIfError();b.attachShader(d,f);b.attachShader(d,g);b.linkProgram(d);b.useProgram(d);this.throwIfError();this.uniformViewConstants=b.getUniformLocation(d,"uViewConstants");b.activeTexture(b.TEXTURE0);b.uniform1i(b.getUniformLocation(d,"uTexture"),0);this.throwIfError();b.disable(b.DEPTH_TEST);
b.disable(b.CULL_FACE);b.disable(b.DITHER);b.disable(b.SCISSOR_TEST);b.disable(b.POLYGON_OFFSET_FILL);b.disable(b.SAMPLE_ALPHA_TO_COVERAGE);b.disable(b.SAMPLE_COVERAGE);b.disable(b.STENCIL_TEST);b.enable(b.BLEND);b.pixelStorei(b.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!0);this.setDefaultComposition();this.throwIfError();this.vertexBuffer=b.createBuffer();this.vertexBuffer=b.createBuffer();this.indexBuffer=b.createBuffer();this.allocateRectangleBuffers();f=a.nextPowerOfTwo(c);g=a.nextPowerOfTwo(e);c=Math.ceil(c*
LevelSpriteSheet.TextureWidth/f);e=Math.ceil(e*LevelSpriteSheet.TextureHeight/g);this.framebufferTextureViewWidth=c*f/LevelSpriteSheet.TextureWidth|0;this.framebufferTextureViewHeight=e*g/LevelSpriteSheet.TextureHeight|0;this.framebufferTexture=new Texture(this,null,f,g);LevelSpriteSheet.FramebufferTextureCoordinates.setCoordinates(0,0,c,e);this.throwIfError();this.framebuffer=b.createFramebuffer();this.throwIfError();b.bindFramebuffer(b.FRAMEBUFFER,this.framebuffer);b.framebufferTexture2D(b.FRAMEBUFFER,
b.COLOR_ATTACHMENT0,b.TEXTURE_2D,this.framebufferTexture.texture,0);this.useFramebuffer(!1);e=b.getAttribLocation(d,"aPosition");c=b.getAttribLocation(d,"aAlphaTextureCoordinates");b.enableVertexAttribArray(e);b.enableVertexAttribArray(c);b.vertexAttribPointer(e,a.FloatsPerPosition,b.FLOAT,!1,a.BytesPerVertex,a.BufferIndexPosition);b.vertexAttribPointer(c,a.FloatsPerAlphaTextureCoordinates,b.FLOAT,!1,a.BytesPerVertex,a.BufferIndexAlphaTextureCoordinates)};a.prototype.destroy=function(b){var c=this.context,
e=this.verticesPtr,d=this.vertices;c&&(c.bindFramebuffer(c.FRAMEBUFFER,null),this.framebufferTexture&&this.framebufferTexture.destroy(),this.framebuffer&&c.deleteFramebuffer(this.framebuffer),this.program&&c.deleteProgram(this.program),this.vertexShader&&c.deleteShader(this.vertexShader),this.fragmentShader&&c.deleteShader(this.fragmentShader),this.vertexBuffer&&c.deleteBuffer(this.vertexBuffer),this.indexBuffer&&c.deleteBuffer(this.indexBuffer));zeroObject(this);b?(this.verticesPtr=e,this.vertices=
d):e&&cLib._freeBuffer(e)};a.prototype.flush=function(){var b=this.rectangleCount;if(b){var c=this.context;c.bufferSubData(c.ARRAY_BUFFER,0,this.vertices.subarray(0,a.FloatsPerRectangle*b));c.bindTexture(c.TEXTURE_2D,this.currentTexture.texture);c.drawElements(c.TRIANGLES,6*b,c.UNSIGNED_SHORT,0);this.rectangleCount=0}};a.prototype.clearColor=function(b,c,e,d){this.context.clearColor(b,c,e,d)};a.prototype.checkForLostContextUseFrameBufferAndClear=function(){var b=this.context;if(!b)return!1;if(b.isContextLost())return this.destroy(!0),
!1;this.useFramebuffer(!0);b.clear(b.COLOR_BUFFER_BIT);return!0};a.prototype.setSumComposition=function(){var b=this.context;b.blendFunc(b.ONE,b.ONE)};a.prototype.setDefaultComposition=function(){var b=this.context;b.blendFunc(b.ONE,b.ONE_MINUS_SRC_ALPHA)};a.prototype.allocateRectangleBuffers=function(){this.verticesPtr||(this.verticesPtr=cLib._allocateBuffer(a.BytesPerRectangle*a.RectangleCapacity),this.vertices=new Float32Array(cLib.HEAP8.buffer,this.verticesPtr,a.FloatsPerRectangle*a.RectangleCapacity));
for(var b=6*a.RectangleCapacity,c=new Uint16Array(b),e=0,d=0;e<b;e+=6,d+=4)c[e]=d,c[e+1]=d+1,c[e+2]=d+2,c[e+3]=d+2,c[e+4]=d+1,c[e+5]=d+3;b=this.context;b.bindBuffer(b.ELEMENT_ARRAY_BUFFER,this.indexBuffer);b.bufferData(b.ELEMENT_ARRAY_BUFFER,c,b.STATIC_DRAW);b.bindBuffer(b.ARRAY_BUFFER,this.vertexBuffer);b.bufferData(b.ARRAY_BUFFER,this.vertices,b.DYNAMIC_DRAW);b.bufferSubData(b.ARRAY_BUFFER,0,this.vertices)};a.prototype.useFramebuffer=function(b){var c=this.context;if(b){c.bindFramebuffer(c.FRAMEBUFFER,
this.framebuffer);b=this.framebufferTextureViewWidth;var e=this.framebufferTextureViewHeight}else c.bindFramebuffer(c.FRAMEBUFFER,null),b=this.viewWidth,e=this.viewHeight;c.uniform2f(this.uniformViewConstants,2/b,-2/e);c.viewport(0,0,b,e)};a.prototype.draw=function(b,c,e,d,f,g){if(this.currentTexture!==b||this.rectangleCount>=a.RectangleCapacity)this.flush(),this.currentTexture=b;cLib._draw(this.verticesPtr+a.BytesPerRectangle*this.rectangleCount,c.ptr,e,d.ptr,f,g);this.rectangleCount++};a.prototype.drawScale=
function(b,c,e,d,f,g,h){if(this.currentTexture!==b||this.rectangleCount>=a.RectangleCapacity)this.flush(),this.currentTexture=b;cLib._drawScale(this.verticesPtr+a.BytesPerRectangle*this.rectangleCount,c.ptr,e,d.ptr,f,g,h);this.rectangleCount++};a.prototype.drawRotate=function(b,c,e,d,f,g,h){if(this.currentTexture!==b||this.rectangleCount>=a.RectangleCapacity)this.flush(),this.currentTexture=b;cLib._drawRotate(this.verticesPtr+a.BytesPerRectangle*this.rectangleCount,c.ptr,e,d.ptr,f,g,h);this.rectangleCount++};
a.prototype.drawScaleRotate=function(b,c,e,d,f,g,h,l){if(this.currentTexture!==b||this.rectangleCount>=a.RectangleCapacity)this.flush(),this.currentTexture=b;cLib._drawScaleRotate(this.verticesPtr+a.BytesPerRectangle*this.rectangleCount,c.ptr,e,d.ptr,f,g,h,l);this.rectangleCount++};a.RectangleCapacity=512;a.FloatsPerPosition=2;a.FloatsPerAlphaTextureCoordinates=1;a.FloatsPerVertex=a.FloatsPerPosition+a.FloatsPerAlphaTextureCoordinates;a.BytesPerVertex=4*a.FloatsPerVertex;a.FloatsPerRectangle=4*a.FloatsPerVertex;
...
function(){this.levelPtr&&cLib._viewResized(this.levelPtr,baseWidth,baseHeight)};a.prototype.createLevelPtr=function(){this.destroyLevelPtr();for(var b=this.polygons,c=this.objects,e=4,d=b.length-1;0<=d;d--){var f=b[d].points.length;e+=2===f?1:f}f=this.objects.length;var g=cLib.stackSave();d=cLib.HEAP8.buffer;var h=e<<3,l=f<<2,k=f<<3,m=cLib.stackAlloc(h),p=cLib.stackAlloc(h),n=cLib.stackAlloc(h);h=cLib.stackAlloc(h);l=cLib.stackAlloc(l);var q=cLib.stackAlloc(k),v=cLib.stackAlloc(k);k=cLib.stackAlloc(k);
var r=new Float32Array(d,m,e),w=new Float32Array(d,p,e),x=new Float32Array(d,n,e),y=new Float32Array(d,h,e),B=new Int32Array(d,l,f),C=new Float32Array(d,q,f),D=new Float32Array(d,v,f),E=new Float32Array(d,k,f);r[0]=-1;w[0]=-1;x[0]=this.width;y[0]=-1;r[1]=this.width;w[1]=-1;x[1]=this.width;y[1]=this.height;r[2]=this.width;w[2]=this.height;x[2]=-1;y[2]=this.height;r[3]=-1;w[3]=this.height;x[3]=-1;y[3]=-1;d=0;for(var t=4;d<b.length;d++){for(var u=b[d].points,A=u.length-1,z=0;z<A;z++)r[t]=u[z].x,w[t]=
u[z].y,x[t]=u[z+1].x,y[t]=u[z+1].y,t++;1<A&&(r[t]=u[A].x,w[t]=u[A].y,x[t]=u[0].x,y[t]=u[0].y,t++)}for(d=0;d<f;d++)b=c[d],B[d]=b.type,C[d]=b.x,D[d]=b.y,E[d]=b.radius;this.levelPtr=cLib._init(this.height,baseWidth,baseHeight,e,m,p,n,h,f,l,q,v,k);cLib.stackRestore(g)};a.prototype.destroyLevelPtr=function(){this.levelPtr&&(cLib._destroy(this.levelPtr),this.levelPtr=0)};a.prototype.clearImage=function(){this.width=baseWidth;this.height=maxHeight;this.thumbnailImage=this.processedImage=this.image=""};a.prototype.clearObjects=
function(){this.polygons=[];this.objects=[]};a.prototype.restart=function(){this.createLevelPtr()};a.prototype.step=function(b){this.levelPtr&&cLib._step(this.levelPtr,ControlMode.accelerationX,ControlMode.accelerationY,ControlMode.mode,b)};a.MaxPolygonCountMessage="Level.MaxPolygonCount";a.MaxPointCountMessage="Level.MaxPointCount";a.MaxPolygonCount=5E3;a.MaxPointCount=2E4;a.MaxObjectCount=256;a.MaxBallCount=40;return a}(),LevelCache=function(){function a(){}a.loadBuiltInLevels=function(){return new Promise(function(b,
c){a.BuiltInLevelIds?b():a.BuiltInLevelsLoadFinished=b})};a.builtInLevelThumbnailPath=function(b){if(0>b||b>=a.BuiltInLevelThumbnails.length)throw Error("Invalid id");return a.BuiltInLevelThumbnails[b]};a.loadBuiltInLevel=function(b){if(0>b||b>=a.BuiltInLevels.length)throw Error("Invalid id");try{return Level.revive(a.BuiltInLevels[b])}catch(c){return null}};a.isNameValid=function(b){b=(b||"").trim();return!!b&&!b.endsWith(a.LevelInfoExtension)&&!/^\.+$/.test(b)&&!/[\\\/\?\*:<>%]/.test(b)&&!/^\d+$/.test(b)};
a.getLevelNames=function(b){void 0===b&&(b=!0);return __awaiter(this,void 0,void 0,function(){var c,e,d,f,g,h,l,k;return __generator(this,function(m){switch(m.label){case 0:b&&(View.loading=!0),m.label=1;case 1:return m.trys.push([1,4,5,6]),[4,caches.open(a.CacheName)];case 2:return c=m.sent(),[4,c.keys()];case 3:e=m.sent();if(!e||!e.length)return[2,[]];d=Array(e.length>>1);f=a.LevelInfoExtension;g=e.length-1;for(h=0;0<=g;g--)l=e[g].url,l.endsWith(f)||(k=l.lastIndexOf("/"),d[h++]=decodeURIComponent(0>
k?l:l.substr(k+1)));d.sort();return[2,d];case 4:return m.sent(),[2,[]];case 5:return b&&(View.loading=!1),[7];case 6:return[2]}})})};a.loadLevelInfo=function(b,c){void 0===c&&(c=!0);return __awaiter(this,void 0,void 0,function(){var e,d,f;return __generator(this,function(g){switch(g.label){case 0:if(!a.isNameValid(b))throw Error("Invalid name");c&&(View.loading=!0);g.label=1;case 1:return g.trys.push([1,5,6,7]),[4,caches.open(a.CacheName)];case 2:return e=g.sent(),[4,e.match(encodeURIComponent(b+
a.LevelInfoExtension))];case 3:return(d=g.sent())?[4,d.text()]:[2,null];case 4:f=g.sent();if(!f)return[2,null];try{return[2,JSON.parse(f)]}catch(h){return[2,null]}case 5:return g.sent(),[2,null];case 6:return c&&(View.loading=!1),[7];case 7:return[2]}})})};a.saveLevel=function(b,c){void 0===c&&(c=!0);return __awaiter(this,void 0,void 0,function(){var e,d;return __generator(this,function(f){switch(f.label){case 0:if(!b||!a.isNameValid(b.name))throw Error("Invalid level");c&&(View.loading=!0);e=b.thumbnailImage;
f.label=1;case 1:return f.trys.push([1,,5,6]),[4,caches.open(a.CacheName)];case 2:return d=f.sent(),[4,d.put(encodeURIComponent(b.name+a.LevelInfoExtension),new Response(new Blob([JSON.stringify(b.toLevelInfo())],{type:"application/json"})))];case 3:return f.sent(),b.thumbnailImage=null,[4,d.put(encodeURIComponent(b.name),new Response(new Blob([JSON.stringify(b)],{type:"application/json"})))];case 4:return f.sent(),[3,6];case 5:return b.thumbnailImage=e,c&&(View.loading=!1),[7];case 6:return[2]}})})};
a.loadLevel=function(b,c){void 0===c&&(c=!0);return __awaiter(this,void 0,void 0,function(){var e,d,f;return __generator(this,function(g){switch(g.label){case 0:if(!a.isNameValid(b))throw Error("Invalid name");c&&(View.loading=!0);g.label=1;case 1:return g.trys.push([1,,5,6]),[4,caches.open(a.CacheName)];case 2:return e=g.sent(),[4,e.match(encodeURIComponent(b))];case 3:return(d=g.sent())?[4,d.text()]:[2,null];case 4:f=g.sent();if(!f)return[2,null];try{return[2,Level.revive(f)]}catch(h){return[2,
null]}case 5:return c&&(View.loading=!1),[7];case 6:return[2]}})})};a.deleteLevel=function(b,c){void 0===c&&(c=!0);return __awaiter(this,void 0,void 0,function(){var e;return __generator(this,function(d){switch(d.label){case 0:if(!a.isNameValid(b))throw Error("Invalid name");c&&(View.loading=!0);d.label=1;case 1:return d.trys.push([1,,5,6]),[4,caches.open(a.CacheName)];case 2:return e=d.sent(),[4,e.delete(encodeURIComponent(b))];case 3:return d.sent(),[4,e.delete(encodeURIComponent(b+a.LevelInfoExtension))];
case 4:return d.sent(),a.deleteLevelRecord(b),[3,6];case 5:return c&&(View.loading=!1),[7];case 6:return[2]}})})};a.downloadLevel=function(b,c,e){void 0===c&&(c=-1);void 0===e&&(e=!0);return __awaiter(this,void 0,void 0,function(){var d,f,g,h,l;return __generator(this,function(k){switch(k.label){case 0:if(!a.isNameValid(b))throw Error("Invalid name");if(!BlobDownloader.supported)return[2,a.DownloadLevelError];e&&(View.loading=!0);k.label=1;case 1:k.trys.push([1,7,8,9]);f=d=void 0;if(!(0<=c&&c<a.BuiltInLevels.length))return[3,
2];d=a.BuiltInLevels[c];f=d.indexOf('"name":"')+8;d=d.substr(0,f)+b+d.substr(d.indexOf('"',f));return[3,6];case 2:return[4,caches.open(a.CacheName)];case 3:return g=k.sent(),[4,g.match(encodeURIComponent(b))];case 4:return(h=k.sent())?[4,h.text()]:[2,a.DownloadLevelError];case 5:d=k.sent();if(!d)return[2,a.DownloadLevelError];k.label=6;case 6:return b+=".json",f=d.indexOf('"processedImage":'),0<=f&&(f+=17,'"'===d.charAt(f)&&(l=d.indexOf('"',f+1),l>f&&(d=d.substr(0,f)+"null"+d.substr(l+1)))),f=d.indexOf('"thumbnailImage":'),
0<=f&&(f+=17,'"'===d.charAt(f)&&(l=d.indexOf('"',f+1),l>f&&(d=d.substr(0,f)+"null"+d.substr(l+1)))),f=d.indexOf('"polygons":'),0<=f&&(f+=11,"["===d.charAt(f)&&(l=d.indexOf("],",f+1),l>f?d=d.substr(0,f)+"null"+d.substr(l+1):(l=d.indexOf("}]}]}",f+1),l>f&&(d=d.substr(0,f)+"null"+d.substr(l+4))))),[2,androidWrapper?androidWrapper.downloadLevel(b,d,null):BlobDownloader.download(d,b,"application/json")?a.DownloadLevelSuccess:a.DownloadLevelError];case 7:return k.sent(),[2,a.DownloadLevelError];case 8:return e&&
(View.loading=!1),[7];case 9:return[2]}})})};a.downloadLevelImage=function(b,c,e){void 0===e&&(e=!0);return __awaiter(this,void 0,void 0,function(){var d,f;return __generator(this,function(g){a.isNameValid(b)||(b=Strings.Level);if(!BlobDownloader.supported)return[2,a.DownloadLevelError];e&&(View.loading=!0);try{return b+=".png",androidWrapper?(d=c.toDataURL("image/png"),f=d.indexOf("data:image/png;base64,"),0<=f&&(d=d.substr(f+22)),[2,androidWrapper.downloadLevel(b,null,d)]):[2,new Promise(function(h,
l){c.toBlob(function(k){h(k&&BlobDownloader.download(k,b,"image/png")?a.DownloadLevelSuccess:a.DownloadLevelError)},"image/png")})]}catch(h){return[2,a.DownloadLevelError]}finally{e&&(View.loading=!1)}return[2]})})};a.renameLevel=function(b,c,e){void 0===e&&(e=!0);return __awaiter(this,void 0,void 0,function(){var d,f;return __generator(this,function(g){switch(g.label){case 0:if(!a.isNameValid(b)||!a.isNameValid(c))throw Error("Invalid name");e&&(View.loading=!0);g.label=1;case 1:return g.trys.push([1,
,6,7]),[4,a.loadLevel(b,!1)];case 2:return d=g.sent(),[4,a.loadLevelInfo(b,!1)];case 3:f=g.sent();if(!d||!f)return[2,!1];d.name=c;d.thumbnailImage=f.thumbnailImage;return[4,a.saveLevel(d,!1)];case 4:return g.sent(),[4,a.deleteLevel(b,!1)];case 5:return g.sent(),[2,!0];case 6:return e&&(View.loading=!1),[7];case 7:return[2]}})})};a.sendLevelToEditor=function(b,c,e){void 0===c&&(c=null);void 0===e&&(e=!0);return __awaiter(this,void 0,void 0,function(){var d,f,g;return __generator(this,function(h){switch(h.label){case 0:if(!b&&
!c||b&&c||b&&!a.isNameValid(b))throw Error("Invalid level");e&&(View.loading=!0);h.label=1;case 1:return h.trys.push([1,,7,8]),d=null,b?[4,caches.open(a.CacheName)]:[3,5];case 2:return f=h.sent(),[4,f.match(encodeURIComponent(b))];case 3:return(g=h.sent())?[4,g.text()]:[2,!1];case 4:return d=h.sent(),[3,6];case 5:d=JSON.stringify(c),h.label=6;case 6:if(!d)return[2,!1];localStorage.setItem(a.EditorLevelName,d);return[2,!0];case 7:return e&&(View.loading=!1),[7];case 8:return[2]}})})};a.loadEditorLevel=
function(){return Level.revive(localStorage.getItem(a.EditorLevelName))};a.saveEditorLevel=function(b){b?localStorage.setItem(a.EditorLevelName,JSON.stringify(b)):localStorage.removeItem(a.EditorLevelName)};a.loadLevelFromOptions=function(b){return __awaiter(this,void 0,void 0,function(){var c,e,d;return __generator(this,function(f){switch(f.label){case 0:if(b)return[3,1];c=a.loadEditorLevel();return[3,6];case 1:return(e=b.level)?[3,5]:b.levelName?[4,a.loadLevel(b.levelName,!1)]:[3,3];case 2:return d=
f.sent(),[3,4];case 3:d=a.loadBuiltInLevel(b.levelId),f.label=4;case 4:e=d,f.label=5;case 5:c=e,f.label=6;case 6:return[2,c]}})})};a.getLevelRecord=function(b){if(!a.LevelRecords){try{var c=localStorage.getItem(a.LevelRecordsName);c&&(a.LevelRecords=JSON.parse(c))}catch(d){}if(a.LevelRecords)for(var e in a.LevelRecords){if(c=a.LevelRecords[e])if(0<=c.fmt.indexOf(Strings.OppositeDecimalSeparator))c.fmt=c.fmt.replace(Strings.OppositeDecimalSeparator,Strings.DecimalSeparator);else break}else a.LevelRecords=
{};a.LastRecordName=localStorage.getItem(a.LastRecordNameName)}return a.LevelRecords[b]||null};a.setLevelRecord=function(b,c,e){var d=a.getLevelRecord(b);e=e?e.trim():"";d?(d.time=c,d.name=e||"-",d.fmt=a.formatLevelRecordTime(c)):a.LevelRecords[b]={time:c,name:e||"-",fmt:a.formatLevelRecordTime(c)};localStorage.setItem(a.LevelRecordsName,JSON.stringify(a.LevelRecords));a.LastRecordName!==e&&localStorage.setItem(a.LastRecordNameName,a.LastRecordName=e)};a.deleteLevelRecord=function(b){a.getLevelRecord(b)&&
(delete a.LevelRecords[b],localStorage.setItem(a.LevelRecordsName,JSON.stringify(a.LevelRecords)))};a.clearLastRecordName=function(){a.LastRecordName&&localStorage.setItem(a.LastRecordNameName,a.LastRecordName="")};a.formatLevelRecordTime=function(b){if(!b||0>b)return"-";b=b/10|0;99999<b&&(b=99999);return(b/100|0)+Strings.DecimalSeparator+format2(b%100)+" s"};a.DownloadLevelSuccess=1;a.DownloadLevelError=0;a.DownloadLevelNoPermission=-1;a.DownloadLevelFileAlreadyExists=-2;a.BuiltInLevelIds=null;a.BuiltInLevels=
null;a.BuiltInLevelThumbnails=null;a.BuiltInLevelsLoadFinished=null;a.LevelInfoExtension=".levelinfo";a.CacheName="pixel-level-cache";a.EditorLevelName="pixel-editor-level";a.LastRecordNameName="pixel-editor-last-name";a.LevelRecordsName="pixel-editor-level-records";a.LevelRecords=null;a.LastRecordName=null;return a}(),LevelSpriteSheet=function(){function a(){}a.allocateCoordinates=function(){var b=cLib._initLevelSpriteSheet();a.LevelSpriteSheetPtr=b;a.LevelModelCoordinates=new ModelCoordinates(b);
b+=16;a.FullTextureCoordinates=new TextureCoordinates(b);b+=16;a.FramebufferTextureCoordinates=new TextureCoordinates(b);b+=16;for(var c=0;c<a.BackgroundModelCoordinates.length;c++)a.BackgroundModelCoordinates[c]=new ModelCoordinates(b),b+=16;for(c=0;c<a.BackgroundTextureCoordinates.length;c++)a.BackgroundTextureCoordinates[c]=new TextureCoordinates(b),b+=16;a.LevelObjectModelCoordinates=new ModelCoordinates(b);b+=16;for(c=0;c<a.LevelObjectTextureCoordinatesByType.length;c++)a.LevelObjectTextureCoordinatesByType[c]=
new TextureCoordinates(b),b+=16;a.FullViewModelCoordinates=new ModelCoordinates(b);b+=16;a.ExplosionBgTextureCoordinates=new TextureCoordinates(b);b+=16;a.FadeBgModelCoordinates=new ModelCoordinates(b);b+=16;a.FadeBgTextureCoordinates=new TextureCoordinates(b);b+=16;a.FadeBgSadTextureCoordinates=new TextureCoordinates(b);b+=16;for(c=0;c<a.FragmentModelCoordinates.length;c++)a.FragmentModelCoordinates[c]=new ModelCoordinates(b),b+=16;for(c=0;c<a.FragmentTextureCoordinates.length;c++)a.FragmentTextureCoordinates[c]=
new TextureCoordinates(b),b+=16;a.CursorCenterModelCoordinates=new ModelCoordinates(b);b+=16;a.CursorCenterTextureCoordinates=new TextureCoordinates(b);b+=16;a.CursorTargetModelCoordinates=new ModelCoordinates(b);b+=16;a.CursorTargetTextureCoordinates=new TextureCoordinates(b);b+=16;a.FaceModelCoordinates=new ModelCoordinates(b);b+=16;a.SadFaceTextureCoordinates=new TextureCoordinates(b);a.HappyFaceTextureCoordinates=new TextureCoordinates(b+16)};a.setupFixedCoordinates=function(){a.FullTextureCoordinates.setCoordinates(0,
0,a.TextureWidth,a.TextureHeight);var b=a.BackgroundScale,c=a.BackgroundScaleRightShift,e=baseWidth<<1>>c,d=Math.ceil(Math.sqrt(2)*(baseWidth>>c));a.BackgroundModelCoordinates[0].setCoordinates(e>>c,-.4*b*baseWidth,e,d);a.BackgroundModelCoordinates[1].setCoordinates(e>>c,-.38*b*baseWidth,e,d);a.BackgroundModelCoordinates[2].setCoordinates(e>>c,-.36*b*baseWidth,e,d);a.BackgroundModelCoordinates[3].setCoordinates(e>>c,-.34*b*baseWidth,e,d);a.BackgroundModelCoordinates[4].setCoordinates(e>>c,-.32*b*
baseWidth,e,d);a.BackgroundModelCoordinates[5].setCoordinates(e>>c,-.3*b*baseWidth,e,d);a.BackgroundModelCoordinates[6].setCoordinates(e>>c,-.28*b*baseWidth,e,d);a.BackgroundModelCoordinates[7].setCoordinates(e>>c,-.26*b*baseWidth,e,d);a.BackgroundModelCoordinates[8].setCoordinates(e>>c,-.24*b*baseWidth,e,d);a.BackgroundModelCoordinates[9].setCoordinates(e>>c,-.2*b*baseWidth,e,d);a.BackgroundModelCoordinates[10].setCoordinates(e>>c,-.16*b*baseWidth,e,d);a.BackgroundModelCoordinates[11].setCoordinates(e>>
c,-.12*b*baseWidth,e,d);a.BackgroundModelCoordinates[12].setCoordinates(e>>c,-.08*b*baseWidth,e,d);a.BackgroundModelCoordinates[13].setCoordinates(e>>c,-.04*b*baseWidth,e,d);a.BackgroundModelCoordinates[14].setCoordinates(e>>c,-0*b*baseWidth,e,d);a.BackgroundTextureCoordinates[0].setCoordinates(3,53,2,72);a.BackgroundTextureCoordinates[1].setCoordinates(9,53,2,72);a.BackgroundTextureCoordinates[2].setCoordinates(15,53,2,72);a.BackgroundTextureCoordinates[3].setCoordinates(21,53,2,72);a.BackgroundTextureCoordinates[4].setCoordinates(27,
...
b,1*b,3*b,3*b),a.FragmentModelCoordinates[4].setCoordinates(1*b,2*b,3*b,4*b),a.FragmentModelCoordinates[5].setCoordinates(1*b,2*b,3*b,4*b),a.FragmentModelCoordinates[6].setCoordinates(1*b,2*b,3*b,4*b),a.FragmentModelCoordinates[7].setCoordinates(1*b,1*b,3*b,3*b),a.CursorCenterModelCoordinates.setCoordinates(.5*a.CursorCenterSize*b|0,.5*a.CursorCenterSize*b|0,a.CursorCenterSize*b,a.CursorCenterSize*b),a.CursorTargetModelCoordinates.setCoordinates(.5*a.CursorTargetSize*b|0,.5*a.CursorTargetSize*b|0,
a.CursorTargetSize*b,a.CursorTargetSize*b),a.FaceModelCoordinates.setCoordinates(15*b,15*b,31*b,31*b))};a.preload=function(){return __awaiter(this,void 0,void 0,function(){var b;return __generator(this,function(c){switch(c.label){case 0:if(a.image)return[3,2];b=a;return[4,loadImage("assets/images/sheet.png")];case 1:b.image=c.sent(),c.label=2;case 2:return[2]}})})};a.createTexture=function(b){return new Texture(b,a.image)};a.TextureWidth=128;a.TextureHeight=128;a.CursorCenterSize=25;a.CursorTargetSize=
25;a.LevelSpriteSheetPtr=0;a.BackgroundCount=15;a.BackgroundScale=.5;a.BackgroundScaleRightShift=1;a.LevelModelCoordinates=null;a.FullTextureCoordinates=null;a.FramebufferTextureCoordinates=null;a.BackgroundModelCoordinates=Array(a.BackgroundCount);a.BackgroundTextureCoordinates=Array(8);a.LevelObjectModelCoordinates=null;a.LevelObjectTextureCoordinatesByType=Array(LevelObject.TypeCount);a.FullViewModelCoordinates=null;a.ExplosionBgTextureCoordinates=null;a.FadeBgModelCoordinates=null;a.FadeBgTextureCoordinates=
null;a.FadeBgSadTextureCoordinates=null;a.FragmentModelCoordinates=Array(8);a.FragmentTextureCoordinates=Array(16);a.CursorCenterModelCoordinates=null;a.CursorCenterTextureCoordinates=null;a.CursorTargetModelCoordinates=null;a.CursorTargetTextureCoordinates=null;a.FaceModelCoordinates=null;a.SadFaceTextureCoordinates=null;a.HappyFaceTextureCoordinates=null;a.image=null;a.scaleFactor=0;return a}(),ControlMode=function(){function a(){}Object.defineProperty(a,"mode",{get:function(){return a._mode},enumerable:!1,
configurable:!0});Object.defineProperty(a,"accelerationSupported",{get:function(){return a._accelerationSupported},enumerable:!1,configurable:!0});Object.defineProperty(a,"modeImage",{get:function(){return a.ImagesByMode[a._mode]},enumerable:!1,configurable:!0});a.toggleMode=function(){var b=a._mode+1;if(b>a.AccelerometerVI||!a._accelerationSupported)b=a.Pointer;a._mode=b;localStorage.setItem(a.ControlModeName,b.toString());a.prepare()};a.init=function(){a._accelerationSupported=androidWrapper&&androidWrapper.isSupported()||
"DeviceMotionEvent"in window;if(a._accelerationSupported){var b=parseInt(localStorage.getItem(a.ControlModeName));a._mode=isNaN(b)||b<a.Pointer||b>a.AccelerometerVI?a.Pointer:b}else a._mode=a.Pointer;a.prepare()};a.prepare=function(){window.removeEventListener("devicemotion",a.deviceMotion);a.invertXY=a._mode===a.AccelerometerV||a._mode===a.AccelerometerVI;a.invertSign=a._mode===a.AccelerometerHI||a._mode===a.AccelerometerVI;a._mode!==a.Pointer&&window.addEventListener("devicemotion",a.deviceMotion)};
a.processAndroidAcceleration=function(){if(a.skipAndroid)a.skipAndroid=!1;else{a.skipAndroid=!0;if(a.invertXY){var b=androidWrapper.getY();var c=androidWrapper.getX()}else b=-androidWrapper.getX(),c=androidWrapper.getY();a.invertSign&&(b=-b,c=-c);-.3<b&&.3>b&&(b=0);-.3<c&&.3>c&&(c=0);a.accelerationX=.8*a.accelerationX+.2*b;a.accelerationY=.8*a.accelerationY+.2*c}};a.deviceMotion=function(b){var c=b.accelerationIncludingGravity;a.invertXY?(b=c.y,c=c.x):(b=-c.x,c=c.y);a.invertSign&&(b=-b,c=-c);-.3<
b&&.3>b&&(b=0);-.3<c&&.3>c&&(c=0);a.accelerationX=.8*a.accelerationX+.2*b;a.accelerationY=.8*a.accelerationY+.2*c};a.ControlModeName="pixel-control-mode";a.ImagesByMode=[UISpriteSheet.Hand,UISpriteSheet.DeviceH,UISpriteSheet.DeviceV,UISpriteSheet.DeviceHI,UISpriteSheet.DeviceVI];a.Pointer=0;a.AccelerometerH=1;a.AccelerometerV=2;a.AccelerometerHI=3;a.AccelerometerVI=4;a._mode=a.Pointer;a._accelerationSupported=!1;a.skipAndroid=!1;a.invertXY=!1;a.invertSign=!1;a.accelerationX=0;a.accelerationY=0;return a}(),
FullscreenControl=function(){function a(){}a.requestFullscreen=function(b){b||(b=document.body);var c=!0,e=null;try{"requestFullscreen"in b?e=b.requestFullscreen():"webkitRequestFullscreen"in b?e=b.webkitRequestFullscreen():"mozRequestFullScreen"in b?e=b.mozRequestFullScreen():"msRequestFullScreen"in b?e=b.msRequestFullScreen():c=!1}catch(d){c=!1}c||b===document.body?ignorePromise(e):a.requestFullscreen(null)};a.exitFullscreen=function(){var b=null;try{"exitFullscreen"in document?b=document.exitFullscreen():
"webkitExitFullscreen"in document?b=document.webkitExitFullscreen():"mozExitFullScreen"in document?b=document.mozExitFullScreen():"msExitFullscreen"in document&&(b=document.msExitFullscreen())}catch(c){}ignorePromise(b)};Object.defineProperty(a,"fullscreenElement",{get:function(){var b=null;try{"fullscreenElement"in document&&(b=document.fullscreenElement),!b&&"webkitFullscreenElement"in document&&(b=document.webkitFullscreenElement),!b&&"mozFullscreenElement"in document&&(b=document.mozFullscreenElement),
!b&&"msFullscreenElement"in document&&(b=document.msFullscreenElement)}catch(c){}return b},enumerable:!1,configurable:!0});Object.defineProperty(a.prototype,"onfullscreenchange",{get:function(){try{if("onfullscreenchange"in document)return document.onfullscreenchange;if("onwebkitfullscreenchange"in document)return document.onwebkitfullscreenchange;if("onmozfullscreenchange"in document)return document.onmozfullscreenchange;if("onmsfullscreenchange"in document)return document.onmsfullscreenchange}catch(b){}return null},
enumerable:!1,configurable:!0});Object.defineProperty(a,"onfullscreenchange",{set:function(b){try{"onfullscreenchange"in document&&(document.onfullscreenchange=b),"onwebkitfullscreenchange"in document&&(document.onwebkitfullscreenchange=b),"onmozfullscreenchange"in document&&(document.onmozfullscreenchange=b),"onmsfullscreenchange"in document&&(document.onmsfullscreenchange=b)}catch(c){}},enumerable:!1,configurable:!0});a.toggleFullscreen=function(){a.fullscreenMode=!a.fullscreenMode};Object.defineProperty(a,
"fullscreenMode",{get:function(){return!!a.fullscreenElement},set:function(b){b?a.requestFullscreen():a.exitFullscreen()},enumerable:!1,configurable:!0});return a}(),PointerHandler=function(){function a(b,c,e,d){void 0===c&&(c=null);void 0===e&&(e=null);void 0===d&&(d=null);this.documentTarget=document.documentElement||document.body;this.element=b;this.downCallback=c;this.moveCallback=e;this.upCallback=d;"ontouchstart"in b?(this.documentDownEvent="touchstart",this.documentMoveEvent="touchmove",this.documentUpEvent=
"touchend",this.documentCancelEvent="touchcancel",this.boundDocumentDown=this.touchStart.bind(this),this.boundDocumentUp=this.touchEnd.bind(this),this.boundDocumentMove=this.touchMove.bind(this)):"onpointerdown"in b?(this.documentDownEvent="pointerdown",this.documentMoveEvent="pointermove",this.documentUpEvent="pointerup",this.documentCancelEvent="pointercancel",this.boundDocumentDown=this.pointerDown.bind(this),this.boundDocumentUp=this.pointerUp.bind(this),this.boundDocumentMove=this.pointerMove.bind(this)):
(this.documentDownEvent="mousedown",this.documentMoveEvent="mousemove",this.documentUpEvent="mouseup",this.documentCancelEvent=null,this.boundDocumentDown=this.mouseDown.bind(this),this.boundDocumentUp=this.mouseUp.bind(this),this.boundDocumentMove=this.mouseMove.bind(this));b.addEventListener(this.documentDownEvent,this.boundDocumentDown);this.captured=!1;this.pointerId=-1}a.prototype.destroy=function(){this.element&&this.boundDocumentDown&&this.element.removeEventListener(this.documentDownEvent,
...
if(!(b.button||View.fading||b.target&&b.target!==this.element)){if(this.downCallback&&!this.downCallback(b))return cancelEvent(b);this.captured=!0;this.documentTarget.addEventListener(this.documentMoveEvent,this.boundDocumentMove,{capture:!0,passive:!1});this.documentTarget.addEventListener(this.documentUpEvent,this.boundDocumentUp,!0);this.documentCancelEvent&&this.documentTarget.addEventListener(this.documentCancelEvent,this.boundDocumentUp,!0);return cancelEvent(b)}};a.prototype.mouseMove=function(b){if(this.captured)return this.moveCallback&&
this.moveCallback(b),cancelEvent(b)};a.prototype.mouseUp=function(b){if(this.captured)return this.documentTarget.removeEventListener(this.documentUpEvent,this.boundDocumentUp,!0),this.documentTarget.removeEventListener(this.documentMoveEvent,this.boundDocumentMove,!0),this.documentCancelEvent&&this.documentTarget.removeEventListener(this.documentCancelEvent,this.boundDocumentUp,!0),this.captured=!1,this.upCallback&&this.upCallback(b),cancelEvent(b)};return a}(),ScrollContainer=function(){function a(b,
c,e,d){void 0===c&&(c=!1);void 0===e&&(e=null);void 0===d&&(d=null);d?(this.parent=d.parentNode,this.container=d):(this.parent=b,this.container=document.createElement("div"),b.appendChild(this.container));this.container.className=c?"container":"container scrollable-container";this.scrollContainer=document.createElement("div");this.scrollContainer.className=e?"scroll-container "+e:"scroll-container";this.container.appendChild(this.scrollContainer);this.scrollThumb=UISpriteSheet.create(UISpriteSheet.ScrollThumb,
this.parent);this.scrollThumb.className="scroll-thumb";this.containerPointerHandler=this.pointerHandler=null;this.boundDocumentWheel=this.documentWheel.bind(this);this.scrollThumbInitialTopCss=this.scrollThumbTopCss=this.scrollThumbTopPercent=this.scrollContainerTopCss=this.contentHeight=this.availableHeight=this.containerTopCss=this.pointerLastY=0;this.scrollThumbOnly=c;this.ignoreScroll=!1;c||(this.container.onscroll=this.containerScroll.bind(this))}Object.defineProperty(a.prototype,"topCss",{get:function(){return this.scrollContainerTopCss},
enumerable:!1,configurable:!0});Object.defineProperty(a.prototype,"element",{get:function(){return this.container},enumerable:!1,configurable:!0});Object.defineProperty(a.prototype,"containerElement",{get:function(){return this.scrollContainer},enumerable:!1,configurable:!0});a.prototype.resize=function(b,c){this.containerTopCss=cssNumber(b);this.availableHeight=c;1>this.availableHeight&&(this.availableHeight=1);this.container.style.top=css(b);this.container.style.height=css(c);UISpriteSheet.resize(this.scrollThumb);
b=this.scrollContainer.getBoundingClientRect();this.contentHeight=model(b.bottom-b.top);1>this.contentHeight&&(this.contentHeight=1);b=this.contentHeight<=this.availableHeight?"none":"";this.scrollThumb.style.display!==b&&(this.scrollThumb.style.display=b);this.scrollTo(this.scrollThumbTopPercent)};a.prototype.attach=function(){this.pointerHandler=new PointerHandler(this.scrollThumb,this.mouseDown.bind(this),this.mouseMove.bind(this));document.addEventListener("wheel",this.boundDocumentWheel,{capture:!0,
passive:!1})};a.prototype.detach=function(){this.pointerHandler&&(this.pointerHandler.destroy(),this.pointerHandler=null);document.removeEventListener("wheel",this.boundDocumentWheel,!0)};a.prototype.adjustScrollUI=function(b,c){void 0===c&&(c=-1);this.contentHeight<=this.availableHeight||0>=b?c=b=0:(1<b&&(b=1),0>c&&(c=cssNumber(b*(this.availableHeight-scrollThumbHeight))));this.scrollThumbTopPercent=b;this.scrollThumbTopCss=c;this.scrollThumb.style.top=this.containerTopCss+c+"px";this.scrollContainerTopCss=
this.contentHeight<=this.availableHeight?0:cssNumber(-this.scrollThumbTopPercent*(this.contentHeight-this.availableHeight))};a.prototype.scrollTo=function(b,c){void 0===c&&(c=-1);this.adjustScrollUI(b,c);this.scrollThumbOnly?this.scrollContainer.style.marginTop=this.scrollContainerTopCss+"px":(this.ignoreScroll=!0,this.container.scrollTop=-this.scrollContainerTopCss)};a.prototype.mouseDown=function(b){var c=this.container.getBoundingClientRect();this.pointerLastY=b.clientY-c.top;this.scrollThumbInitialTopCss=
this.scrollThumbTopCss;return!0};a.prototype.mouseMove=function(b){var c=this.container.getBoundingClientRect();b=this.scrollThumbInitialTopCss+(b.clientY-c.top-this.pointerLastY);b=0>b?0:model(b)+scrollThumbHeight>this.availableHeight?cssNumber(this.availableHeight-scrollThumbHeight):(b*pixelRatio|0)/pixelRatio;b!==this.scrollThumbTopCss&&this.scrollTo(model(b)/(this.availableHeight-scrollThumbHeight),b)};a.prototype.documentWheel=function(b){return Modal.visible?!1:(0>b.deltaY?this.scrollTo(this.scrollThumbTopPercent-
.1):0<b.deltaY&&this.scrollTo(this.scrollThumbTopPercent+.1),cancelEvent(b))};a.prototype.containerScroll=function(b){this.ignoreScroll?this.ignoreScroll=!1:(b=this.contentHeight-this.availableHeight,this.adjustScrollUI(0>=b||!this.availableHeight?0:model(this.container.scrollTop)/b))};return a}(),Modal=function(){function a(b){var c=this;this.options=b;this.containerElement=document.createElement("div");this.containerElement.className="base-element modal-container";this.modalElement=document.createElement("form");
this.modalElement.className="modal";this.modalElement.onsubmit=this.submit.bind(this);this.modalHeaderElement=document.createElement("div");this.modalHeaderElement.className="modal-decoration";this.modalHeaderElement.innerHTML=b.title||Strings.Oops;this.modalBodyElement=document.createElement("div");this.modalBodyElement.className="modal-body";"string"===typeof b.html?this.modalBodyElement.innerHTML=b.html:this.modalBodyElement.appendChild(b.html);var e=this.modalBodyElement.getElementsByTagName("button");
if(e&&e.length)for(var d=function(l){var k=e[l];prepareButtonBlink(k,!0,function(){if(c.fading)return!1;if(c.options.onbuttonclick)c.options.onbuttonclick(k.id,k);return!0})},f=e.length-1;0<=f;f--)d(f);if((d=this.modalBodyElement.getElementsByTagName("span"))&&d.length)for(f=d.length-1;0<=f;f--){var g=d[f];g.getAttribute(UISpriteSheet.SheetId)&&UISpriteSheet.finishHTMLCreation(g)}this.modalFooterElement=document.createElement("div");this.modalFooterElement.className="modal-decoration";this.defaultSubmitButton=
this.defaultCancelButton=null;d=function(l){var k=b.buttons[l],m=document.createElement("button");k.defaultCancel&&(h.defaultCancelButton=m);k.defaultSubmit&&(h.defaultSubmitButton=m);m.style.height=buttonHeightCss;m.style.borderWidth=borderWidthCss;k.className&&(m.className=k.className);l&&(m.style.float="right");m.setAttribute("type","button");UISpriteSheet.create(k.iconId,m);m.appendChild(document.createTextNode(k.text));prepareButtonBlink(m,!0,function(){if(c.fading)return!1;if(k.onclick)k.onclick(k.id,
m);if(c.options.onbuttonclick)c.options.onbuttonclick(k.id,m);return!0});h.modalFooterElement.appendChild(m)};var h=this;for(f=0;f<b.buttons.length;f++)d(f);this.modalElement.appendChild(this.modalHeaderElement);this.modalElement.appendChild(this.modalBodyElement);this.modalElement.appendChild(this.modalFooterElement);this.containerElement.appendChild(this.modalElement);View.main.appendChild(this.containerElement);this.boundDocumentKeyDown=this.documentKeyDown.bind(this);document.addEventListener("keydown",
this.boundDocumentKeyDown,!0);this.fading=!0;setTimeout(function(){if(b.onshowing)b.onshowing();c.resizeInternal();c.containerElement.classList.add("visible");setTimeout(function(){c.fading=!1;View.pushHistoryStateIfNecessary();if(c.options.onshown)c.options.onshown()},520)},50)}Object.defineProperty(a,"visible",{get:function(){return!!a.modal},enumerable:!1,configurable:!0});Object.defineProperty(a,"currentModalElement",{get:function(){return a.modal?a.modal.modalElement:null},enumerable:!1,configurable:!0});
Object.defineProperty(a,"currentModalHeaderElement",{get:function(){return a.modal?a.modal.modalHeaderElement:null},enumerable:!1,configurable:!0});Object.defineProperty(a,"currentModalBodyElement",{get:function(){return a.modal?a.modal.modalBodyElement:null},enumerable:!1,configurable:!0});Object.defineProperty(a,"currentModalFooterElement",{get:function(){return a.modal?a.modal.modalFooterElement:null},enumerable:!1,configurable:!0});a.show=function(b){if(a.modal)return!1;b.okcancel?b.buttons=[{id:"cancel",
defaultCancel:!0,iconId:UISpriteSheet.Back,text:Strings.Cancel,onclick:b.oncancel||a.hide},{id:"ok",defaultSubmit:b.okcancelsubmit,iconId:UISpriteSheet.AcceptGreen,text:Strings.OK,className:"accept",onclick:b.onok||a.hide}]:b.buttons&&b.buttons.length||(b.buttons=[{id:"cancel",defaultCancel:!0,iconId:UISpriteSheet.Back,text:Strings.Close,onclick:a.hide}]);a.modal=new a(b);return!0};a.hide=function(){a.modal&&a.modal.hideInternal()};a.defaultCancelAction=function(){a.modal&&a.modal.defaultCancelActionInternal()};
a.windowResized=function(){a.modal&&a.modal.resizeInternal()};a.prototype.hideInternal=function(){var b=this;a.modal!==this||this.fading||this.options.onhiding&&!1===this.options.onhiding()||(document.removeEventListener("keydown",this.boundDocumentKeyDown,!0),this.fading=!0,this.containerElement.classList.remove("visible"),setTimeout(function(){a.modal=null;View.popHistoryStateIfNecessary();if(b.options.onhidden)b.options.onhidden();View.main.removeChild(b.containerElement);for(var c=b.options.buttons.length-
1;0<=c;c--)zeroObject(b.options.buttons[c]);zeroObject(b.options);zeroObject(b)},520))};a.prototype.documentKeyDown=function(b){"Escape"!==b.key&&27!==b.keyCode||this.defaultCancelActionInternal()};a.prototype.defaultCancelActionInternal=function(){this.defaultCancelButton&&this.defaultCancelButton.click()};a.prototype.submit=function(b){cancelEvent(b);this.defaultSubmitButton&&this.defaultSubmitButton.click();return!1};a.prototype.resizeInternal=function(){if(a.modal===this){this.modalElement.style.fontSize=
fontSizeCss;this.modalElement.style.maxWidth=css(this.options.large?baseWidth:baseWidth>>1);this.modalElement.style.margin=this.options.large?"0":iconSizeCss+" auto";this.modalHeaderElement.style.padding=buttonPaddingCss;this.modalBodyElement.style.padding=iconSizeCss+" "+buttonPaddingCss;this.modalBodyElement.style.lineHeight=iconSizeCss;this.modalFooterElement.style.padding=buttonPaddingCss;var b=this.modalElement.querySelectorAll("[data-style]");if(b&&b.length)for(var c=b.length-1;0<=c;c--)for(var e=
b[c],d=e.getAttribute("data-style").split(";"),f=0;f<d.length;f++){var g=d[f],h=g.indexOf(":");0<=h&&(e.style[g.substr(0,h)]=css(parseInt(g.substr(h+1))))}if((b=this.modalElement.getElementsByTagName("input"))&&b.length)for(e=css(2),c=b.length-1;0<=c;c--)d=b[c],d.style.borderWidth=borderWidthCss,d.style.padding=e,d.style.marginTop=e;if((b=this.modalElement.getElementsByTagName("button"))&&b.length)for(c=b.length-1;0<=c;c--)e=b[c],e.style.height=buttonHeightCss,e.style.borderWidth=borderWidthCss,e.style.fontSize=
fontSizeCss,e.style.lineHeight=iconSizeCss,e.style.paddingLeft=buttonPaddingCss,e.style.paddingRight=buttonPaddingCss;if((b=this.modalElement.getElementsByTagName("span"))&&b.length)for(c=b.length-1;0<=c;c--)e=b[c],e.getAttribute(UISpriteSheet.SheetId)&&(UISpriteSheet.resize(e),"BUTTON"===e.parentNode.tagName&&(e.style.marginRight=buttonMarginCss));if(this.options.onresized)this.options.onresized()}};a.modal=null;return a}(),View=function(){function a(){var b=this;this.destroy=function(c){return __awaiter(b,
void 0,void 0,function(){var e;return __generator(this,function(d){switch(d.label){case 0:if(!this.initialElements)return[3,3];if(!this.attached)return[3,2];for(e=a.main.childNodes.length-1;3<=e;e--)a.main.removeChild(a.main.childNodes[e]);this.attached=!1;return[4,this.detach()];case 1:d.sent(),d.label=2;case 2:this.destroyInternal(c),c||zeroObject(this),d.label=3;case 3:return[2]}})})};this.buttons=[];this.buttonsWithMargin=[];this.buttonsWithLargeMargin=[];this.buttonImages=[];this.initialElements=
[];this.attached=!1}a.drawBackground=function(b,c,e){var d=a.gl;if(!d.checkForLostContextUseFrameBufferAndClear())return a.recreateResourcesTimeout||(a.recreateResourcesTimeout=setTimeout(a.recreateResourcesFromTimeout,1E3)),!1;d.prepareNativeDraw(a.sheetTexture);cLib._renderBackground(d.verticesPtr,c,LevelSpriteSheet.LevelSpriteSheetPtr,baseHeight,b,e);d.useFramebuffer(!1);d.draw(d.framebufferTexture,LevelSpriteSheet.FullViewModelCoordinates,1,LevelSpriteSheet.FramebufferTextureCoordinates,0,0);
d.flush();return!0};a.recreateResourcesFromTimeout=function(){a.recreateResourcesTimeout&&(a.recreateResourcesTimeout=0,a.recreateResources())};a.recreateResources=function(){a.recreateResourcesTimeout&&(clearTimeout(a.recreateResourcesTimeout),a.recreateResourcesTimeout=0);var b=a.currentView,c=b&&b.usesGL;c&&b.releaseResources();a.sheetTexture.release();a.backgroundFrameRequest&&(cancelAnimationFrame(a.backgroundFrameRequest),a.backgroundFrameRequest=0);try{a.gl.recreate(a.glCanvas,baseWidth>>LevelSpriteSheet.BackgroundScaleRightShift,
baseHeight>>LevelSpriteSheet.BackgroundScaleRightShift),a.gl.clearColor(1,1,1,1),a.sheetTexture.load()}catch(e){throw a.recreateResourcesTimeout=setTimeout(a.recreateResourcesFromTimeout,500),e;}c?b.loadResources():a.backgroundFrameRequest=requestAnimationFrame(a.renderBackground)};a.renderBackground=function(b){var c=!a.currentView||!a.currentView.pausedBackground;a.backgroundFrameRequest=c?requestAnimationFrame(a.renderBackground):0;!a.drawBackground(b,0,c)&&a.backgroundFrameRequest&&(cancelAnimationFrame(a.backgroundFrameRequest),
a.backgroundFrameRequest=0)};Object.defineProperty(a,"loading",{get:function(){return a._loading},set:function(b){a._loading!==b&&((a._loading=b)?(a.divLoading||(a.divLoading=document.createElement("div"),a.divLoading.style.display="none",a.resizeLoading(),document.body.appendChild(a.divLoading)),a.divLoadingTimeout&&clearTimeout(a.divLoadingTimeout),a.divLoadingTimeout=setTimeout(function(){a.divLoadingTimeout=0;a.divLoading.style.display="";a.divLoading.className="loading"},100)):a.divLoading&&
...
(a.fadeLeft.style.backgroundColor="",a.fadeRight.style.backgroundColor="",a.fadeLeft.style.backgroundImage="",a.fadeRight.style.backgroundImage="");b&&(a.resizeLoading(),baseTopCss?a.fadeLeft.style.display||(a.fadeLeft.style.display="none",a.fadeRight.style.display="none"):a.fadeLeft.style.display&&(a.fadeLeft.style.display="",a.fadeRight.style.display=""),a.glCanvas.width=baseWidth*scaleFactor,a.glCanvas.height=baseHeight*scaleFactor,a.glCanvas.style.height=baseHeightCss+"px",a.gl.checkRecreate(a.glCanvas)&&
a.recreateResources(),a.currentView&&a.currentView.resize())};a.windowHistoryStatePopped=function(b){a.windowHistoryStatePushed=!1;a.pushHistoryStateIfNecessary();Modal.visible&&Modal.defaultCancelAction()};a.pushHistoryStateIfNecessary=function(){a.windowHistoryStatePushed||a.currentView&&a.currentView instanceof TitleView&&!a._fading&&!Modal.visible||(a.windowHistoryStatePushed=!0,window.history.state&&window.history.state.pixelMaze||window.history.pushState({pixelMaze:!0},"Pixel Maze"))};a.popHistoryStateIfNecessary=
...
c.style.fontSize=fontSizeCss;c.style.lineHeight=iconSizeCss}for(b=this.buttonImages.length-1;0<=b;b--)UISpriteSheet.resize(this.buttonImages[b]);for(b=this.buttonsWithMargin.length-1;0<=b;b--)this.buttonsWithMargin[b].style.marginLeft=buttonMarginCss;for(b=this.buttonsWithLargeMargin.length-1;0<=b;b--)this.buttonsWithLargeMargin[b].style.marginLeft=buttonLargeMarginCss};a.prototype.fadeInFinished=function(){};a.prototype.createButton=function(b,c,e){for(var d=[],f=3;f<arguments.length;f++)d[f-3]=
arguments[f];f=document.createElement("button");var g=UISpriteSheet.create(c,f);f.setAttribute("type","button");prepareButtonBlink(f,!1,e);b&&b.appendChild(f);this.buttons.push(f);this.buttonImages.push(g);if(d)for(g=0;g<d.length;g+=2)f.setAttribute(d[g],d[g+1]);return f};a.prototype.finishFadeIn=function(b){var c=this;setTimeout(function(){c.resize();a.backgroundFrameRequest&&(cancelAnimationFrame(a.backgroundFrameRequest),a.backgroundFrameRequest=0);c.usesGL?c.loadResources():a.backgroundFrameRequest=
requestAnimationFrame(a.renderBackground);a.cover.classList.remove("visible");setTimeout(function(){a._fading=!1;a.popHistoryStateIfNecessary();document.body.removeChild(a.cover);c.fadeInFinished();b()},520)},50)};a.prototype.fadeIn=function(){return __awaiter(this,void 0,void 0,function(){var b=this;return __generator(this,function(c){if(a._fading||a.currentView===this)return[2,null];a._fading=!0;a.currentView=this;return[2,new Promise(function(e,d){if((d=b.initialElements)&&!b.attached){for(var f=
0;f<d.length;f++){var g=d[f];g&&a.main.appendChild(g)}b.attached=!0;if(d=b.attach()){d.then(function(){b.finishFadeIn(e)},function(h){console.error(h)});return}}b.finishFadeIn(e)})]})})};a.prototype.fadeOut=function(b){return __awaiter(this,void 0,void 0,function(){var c=this;return __generator(this,function(e){if(a._fading||a.currentView!==this)return[2,null];a._fading=!0;a.backgroundFrameRequest&&(cancelAnimationFrame(a.backgroundFrameRequest),a.backgroundFrameRequest=0);return[2,new Promise(function(d,
f){document.body.appendChild(a.cover);setTimeout(function(){a.cover.classList.add("visible");setTimeout(function(){return __awaiter(c,void 0,void 0,function(){return __generator(this,function(g){switch(g.label){case 0:return[4,this.destroy(b)];case 1:return g.sent(),b&&a.viewStack.push(this),a.currentView=null,a._fading=!1,a.pushHistoryStateIfNecessary(),d(),[2]}})})},520)},50)})]})})};a.prototype.fadeTo=function(b,c){void 0===c&&(c=!1);return __awaiter(this,void 0,void 0,function(){return __generator(this,
function(e){switch(e.label){case 0:return a._fading||a.currentView!==this?[2,null]:[4,this.fadeOut(c)];case 1:return e.sent(),[2,("string"===typeof b?new viewClasses[b]:b).fadeIn()]}})})};a.prototype.fadeToPrevious=function(){return __awaiter(this,void 0,void 0,function(){return __generator(this,function(b){switch(b.label){case 0:return a._fading||a.currentView!==this||!a.viewStack.length?[2,null]:[4,this.fadeOut(!1)];case 1:return b.sent(),[2,a.viewStack.pop().fadeIn()]}})})};a.main=document.getElementById("main");
a.fadeLeft=document.getElementById("fadeLeft");a.fadeRight=document.getElementById("fadeRight");a.glCanvas=document.getElementById("glCanvas");a.cover=document.getElementById("cover");a._loading=!1;a._fading=!1;a.currentView=null;a.viewStack=[];a.divLoading=null;a.divLoadingTimeout=0;a.windowHistoryStatePushed=!1;a.gl=null;a.sheetTexture=null;a.backgroundFrameRequest=0;a.recreateResourcesTimeout=0;return a}(),EditorView=function(a){function b(c,e){var d=a.call(this)||this;d.baseElement=document.createElement("div");
d.baseElement.className="base-element editor";d.baseElement.innerHTML='\n\t\t<div class="hidden-container"><input id="fileInput" type="file" accept="image/*" tabindex="-1" /></div>\n\t\t<div id="toolbarTop" class="toolbar toolbar-top"></div>\n\t\t<div id="container"></div>\n\t\t<div id="toolbarBottom" class="toolbar toolbar-bottom"></div>\n\t\t';d.initialElements.push(d.baseElement);d.fileInput=d.baseElement.querySelector("#fileInput");d.toolbarTop=d.baseElement.querySelector("#toolbarTop");d.toolbarBottom=
d.baseElement.querySelector("#toolbarBottom");d.scrollContainer=new ScrollContainer(null,!0,"scroll-container-editor",d.baseElement.querySelector("#container"));d.setGridBackground();d.canvas=document.createElement("canvas");d.canvas.width=baseWidth;d.canvas.height=maxHeight;d.scrollContainer.containerElement.appendChild(d.canvas);d.pointerCursor=document.createElement("div");d.pointerCursor.className="pointer-cursor";var f=d.toolbarTop,g=d.toolbarBottom;d.createButton(f,UISpriteSheet.Back,d.back.bind(d)).style.float=
"left";d.firstPencilButtonIndex=d.buttons.length;for(var h=d.changeToolPencil.bind(d),l=0;l<colors.length-1;l++)d.createButton(f,UISpriteSheet.Border,h,"data-i",l.toString()).firstChild.style.backgroundColor=colorsCss[l];d.createButton(f,UISpriteSheet.Rainbow,h,"data-i",(colors.length-1).toString());d.createButton(f,UISpriteSheet.Eraser,d.changeToolEraser.bind(d));d.firstLineWidthButtonIndex=d.buttons.length;f=d.changeBrushWidth.bind(d);d.createButton(g,UISpriteSheet.LineWidth0,f,"data-i","0");d.createButton(g,
UISpriteSheet.LineWidth1,f,"data-i","1");d.createButton(g,UISpriteSheet.LineWidth2,f,"data-i","2");d.createButton(g,UISpriteSheet.LineWidth3,f,"data-i","3");d.firstObjectToolButtonIndex=d.buttons.length;for(l=LevelObject.TypeBall;l<=LevelObject.LastType;l++)d.createButton(g,LevelObject.ImagesByType[l],d.changeTool.bind(d),"data-tool",(b.ToolBall+l-LevelObject.TypeBall).toString());d.buttonsWithLargeMargin.push(d.buttons[d.firstObjectToolButtonIndex]);d.createButton(g,UISpriteSheet.Eraser,d.changeTool.bind(d),
"data-tool",b.ToolDeleteObject.toString());d.buttonsWithLargeMargin.push(d.createButton(g,UISpriteSheet.Open,d.open.bind(d)));d.createButton(g,UISpriteSheet.Download,d.download.bind(d));d.createButton(g,UISpriteSheet.Clear,d.clear.bind(d));d.createButton(g,UISpriteSheet.Accept,d.accept.bind(d)).style.float="right";d.createButton(g,UISpriteSheet.Play,d.play.bind(d)).style.float="right";d.fileInput.onchange=d.openFile.bind(d);d.selectionView=!!e;d.boundDocumentKeyUp=androidWrapper||isPWA?null:d.documentKeyUp.bind(d);
d.tool=b.ToolPencil;d.dirty=!1;d.context=null;d.contextGlobalCompositeOperation="source-over";d.lastPencilColor=0;d.lastPencilRainbowIndex=0;d.lastBrushWidth=0;d.lastObjectType=LevelObject.TypeBall;d.brushCanvas=null;d.brushContext=null;d.loadOptions=c||null;d.level=null;d.levelBallCount=0;d.pointerHandler=null;d.pointerLastX=0;d.pointerLastY=0;d.pointerCursorAttached=!1;d.objectImages=[];d.objectImageDrag=null;d.objectImageDragOffsetXCss=0;d.objectImageDragOffsetYCss=0;d.keyUpTime=0;d.keyUpCounter=
0;d.highlightTool();return d}__extends(b,a);b.prototype.setGridBackground=function(){this.scrollContainer.containerElement.style.backgroundImage="url('assets/images/grid"+(5>=scaleFactor?scaleFactor:1)+".png')"};Object.defineProperty(b.prototype,"pausedBackground",{get:function(){return!0},enumerable:!1,configurable:!0});b.prototype.resize=function(){var c=css(63),e=css(maxHeight),d=css(b.BrushWidths[this.lastBrushWidth]);this.toolbarTop.style.height=toolbarAvailableHeightCss;this.toolbarTop.style.borderBottomWidth=
borderWidthCss;this.toolbarBottom.style.height=toolbarAvailableHeightCss;this.toolbarBottom.style.borderTopWidth=borderWidthCss;this.canvas.style.height=e;this.setGridBackground();this.scrollContainer.containerElement.style.backgroundSize=c+" "+c;this.scrollContainer.resize(toolbarTotalHeight,baseHeight-(toolbarTotalHeight<<1));this.pointerCursor.style.borderWidth=borderWidthCss;this.pointerCursor.style.width=d;this.pointerCursor.style.height=d;c=this.level.objects;for(e=c.length-1;0<=e;e--){d=c[e];
var f=this.objectImages[e];f.style.left=css(d.x-iconRadius);f.style.top=css(d.y-iconRadius);UISpriteSheet.resize(f)}a.prototype.resize.call(this)};b.prototype.attach=function(){return __awaiter(this,void 0,void 0,function(){var c,e,d,f,g,h,l;return __generator(this,function(k){switch(k.label){case 0:View.glCanvas.style.display="none";if(this.level)return[3,2];c=this;return[4,LevelCache.loadLevelFromOptions(this.loadOptions)];case 1:c.level=k.sent();this.loadOptions&&(this.loadOptions.levelNameOverride&&
...
4;b.ToolCucumber=5;b.ToolDeleteObject=6;b.FirstObjectTool=b.ToolBall;b.ObjectToolCount=5;b.BrushOffsets=[0,10,26,46];b.BrushWidths=[9,15,19,39];return b}(View),GameView=function(a){function b(c,e){var d=a.call(this)||this,f=d.createButton(null,UISpriteSheet.Back,d.back.bind(d));f.style.position="absolute";f.style.left="0";f.style.top="0";d.backButton=f;e&&d.initialElements.push(f);(d.preview=e)?(d.restartButton=null,d.timeDisplayImage=null,d.editNameButton=null,d.timeDisplay=null):(e=d.createButton(null,
UISpriteSheet.Restart,d.restart.bind(d)),e.style.position="absolute",e.style.top="0",d.restartButton=e,e=document.createElement("div"),e.style.position="absolute",d.timeDisplayImage=UISpriteSheet.create(UISpriteSheet.Clock,e),e.appendChild(d.timeDisplayText=document.createTextNode(Strings.Time)),d.editNameButton=d.createButton(e,UISpriteSheet.Edit,d.editName.bind(d)),d.timeDisplay=e);e=d.createButton(null,UISpriteSheet.Pause,d.pause.bind(d));e.style.position="absolute";e.style.right="0";e.style.top=
"0";d.initialElements.push(e);d.resourceStorage=new ResourceStorage;d.boundRender=d.render.bind(d);d.alive=!0;d.paused=!1;d.finished=!1;d.alreadyCreated=!1;d.loadOptions=c;d.level=null;d.viewY=null;d.frameRequest=0;d.finalUIAttached=!1;d.pointerHandler=null;d.pointerCursorAttached=null;d.totalElapsedMilliseconds=null;d.victory=null;d.pointerCursorCenterX=null;d.pointerCursorCenterY=null;d.pointerCursorX=null;d.pointerCursorY=null;d.levelTexture=null;return d}__extends(b,a);Object.defineProperty(b.prototype,
"usesGL",{get:function(){return!0},enumerable:!1,configurable:!0});b.prototype.releaseResources=function(){this.alive&&this.resourceStorage.release()};b.prototype.loadResources=function(){this.alive&&(this.resourceStorage.load(),LevelSpriteSheet.LevelModelCoordinates.setCoordinates(0,0,this.levelTexture.width*scaleFactor,this.levelTexture.height*scaleFactor),this.alreadyCreated?(this.frameRequest&&(cancelAnimationFrame(this.frameRequest),this.frameRequest=0),this.frameRequest=requestAnimationFrame(this.boundRender)):
(this.alreadyCreated=!0,this.restart()))};b.prototype.resize=function(){this.restartButton&&(this.restartButton.style.left=css(buttonHeight+buttonMargin));this.timeDisplay&&(this.timeDisplay.style.top=buttonMarginCss,this.timeDisplay.style.left=css(3*buttonHeight+buttonMargin),this.timeDisplay.style.lineHeight=iconSizeCss,this.editNameButton.style.marginTop="-"+buttonMarginCss,UISpriteSheet.resize(this.timeDisplayImage),this.timeDisplayImage.style.marginRight=buttonMarginCss);this.level.viewResized();
a.prototype.resize.call(this)};b.prototype.attach=function(){return __awaiter(this,void 0,void 0,function(){var c,e,d,f,g,h;return __generator(this,function(l){switch(l.label){case 0:return c=this,[4,LevelCache.loadLevelFromOptions(this.loadOptions)];case 1:c.level=l.sent();this.loadOptions=null;this.pointerHandler=new PointerHandler(View.glCanvas,this.mouseDown.bind(this),this.mouseMove.bind(this),this.mouseUp.bind(this));if(this.levelTexture)return[3,3];e=this;d=Texture.bind;f=[void 0,View.gl];
return[4,loadImage(this.level.processedImage)];case 2:e.levelTexture=new (d.apply(Texture,f.concat([l.sent()]))),this.resourceStorage.add("levelTexture",this.levelTexture),l.label=3;case 3:if(!androidWrapper)return[3,4];androidWrapper.setKeepScreenOn(!0);return[3,8];case 4:l.trys.push([4,7,,8]);g=navigator.wakeLock;if(!g||!g.request||b.wakeLockSentinel)return[3,6];h=b;return[4,g.request("screen")];case 5:h.wakeLockSentinel=l.sent(),l.label=6;case 6:return[3,8];case 7:return l.sent(),[3,8];case 8:return[2]}})})};
b.prototype.detach=function(){return __awaiter(this,void 0,void 0,function(){return __generator(this,function(c){switch(c.label){case 0:this.pointerHandler&&(this.pointerHandler.destroy(),this.pointerHandler=null);if(!androidWrapper)return[3,1];androidWrapper.setKeepScreenOn(!1);return[3,6];case 1:if(!b.wakeLockSentinel)return[3,6];c.label=2;case 2:return c.trys.push([2,5,,6]),b.wakeLockSentinel.release?[4,b.wakeLockSentinel.release()]:[3,4];case 3:c.sent(),b.wakeLockSentinel=null,c.label=4;case 4:return[3,
6];case 5:return c.sent(),[3,6];case 6:return[2]}})})};b.prototype.destroyInternal=function(c){this.alreadyCreated=this.alive=!1;this.level.destroyLevelPtr();this.pointerCursorY=this.pointerCursorX=this.pointerCursorCenterY=this.pointerCursorCenterX=this.victory=this.totalElapsedMilliseconds=this.pointerCursorAttached=this.viewY=null;c?this.resourceStorage.release():this.resourceStorage.destroy()};b.prototype.restart=function(){if(!this.alive)return!1;this.finalUIAttached&&(this.finalUIAttached=!1,
this.preview||(View.main.removeChild(this.backButton),View.main.removeChild(this.restartButton),View.main.removeChild(this.timeDisplay)));this.finished=this.paused=!1;this.level.restart();var c=cLib.HEAP8.buffer,e=cLib._getFirstPropertyPtr(this.level.levelPtr);this.viewY=new Float32Array(c,cLib._getViewYPtr(this.level.levelPtr),1);this.pointerCursorAttached=new Int32Array(c,e,1);e+=4;this.totalElapsedMilliseconds=new Int32Array(c,e,1);e+=4;this.victory=new Int32Array(c,e,1);e+=4;this.pointerCursorCenterX=
new Float32Array(c,e,1);e+=4;this.pointerCursorCenterY=new Float32Array(c,e,1);e+=4;this.pointerCursorX=new Float32Array(c,e,1);this.pointerCursorY=new Float32Array(c,e+4,1);this.frameRequest&&(cancelAnimationFrame(this.frameRequest),this.frameRequest=0);this.frameRequest=requestAnimationFrame(this.boundRender);return!0};b.prototype.back=function(c){if(!this.alive)return!1;this.alive=!1;this.paused=!0;this.frameRequest&&(cancelAnimationFrame(this.frameRequest),this.frameRequest=0);this.fadeToPrevious();
...
UISpriteSheet.change(document.getElementById("controlMode").firstChild,ControlMode.modeImage);break;case "restart":e.restart(),Modal.hide()}}})))return!1;this.paused=!this.paused;this.frameRequest&&(cancelAnimationFrame(this.frameRequest),this.frameRequest=0);this.alive&&(this.frameRequest=requestAnimationFrame(this.boundRender));return!0};b.prototype.mouseDown=function(c){if(View.loading||!this.alive||this.paused||ControlMode.mode!==ControlMode.Pointer||this.finished)return!1;this.pointerCursorAttached[0]=
1;this.pointerCursorCenterX[0]=this.pointerCursorX[0]=model(c.clientX-baseLeftCss);this.pointerCursorCenterY[0]=this.pointerCursorY[0]=model(c.clientY-baseTopCss);return!0};b.prototype.mouseMove=function(c){this.pointerCursorX[0]=modelFrac(c.clientX-baseLeftCss);this.pointerCursorY[0]=modelFrac(c.clientY-baseTopCss)};b.prototype.mouseUp=function(c){this.pointerCursorAttached[0]=0};b.prototype.checkRecord=function(){if(!(this.alive&&this.level&&this.totalElapsedMilliseconds&&this.victory&&this.victory[0]))return null;
var c=LevelCache.getLevelRecord(this.level.name);return c&&c.time<=this.totalElapsedMilliseconds[0]?null:LevelCache.LastRecordName||""};b.prototype.setTimeDisplayTextRecord=function(c){this.timeDisplayText.nodeValue=LevelCache.formatLevelRecordTime(this.totalElapsedMilliseconds[0])+" - "+(c||Strings.NoName)};b.prototype.editName=function(c){var e=this;return this.alive&&this.level&&this.totalElapsedMilliseconds&&this.victory&&this.victory[0]?Modal.show({title:Strings.NewRecord,html:'<label for="name">'+
Strings.Name+'</label><input id="name" spellcheck="false" autocomplete="off" maxlength="8" /><br/><label>'+Strings.Time+"</label><label>"+LevelCache.formatLevelRecordTime(this.totalElapsedMilliseconds[0])+"</label>",okcancel:!0,okcancelsubmit:!0,onshowing:function(){var d=Modal.currentModalHeaderElement;if(d){d.setAttribute("data-style","line-height:"+iconSize);var f=UISpriteSheet.create(UISpriteSheet.Trophy);f.setAttribute("data-style","margin-right:"+buttonMargin);d.insertBefore(f,d.firstChild);
UISpriteSheet.create(UISpriteSheet.Trophy,d).setAttribute("data-style","margin-left:"+buttonMargin)}document.getElementById("name").value=LevelCache.LastRecordName||""},onshown:function(){document.getElementById("name").focus()},onok:function(){return __awaiter(e,void 0,void 0,function(){var d;return __generator(this,function(f){if(!this.alive||!this.level||!this.totalElapsedMilliseconds)return[2];(d=document.getElementById("name").value.trim())?LevelCache.setLevelRecord(this.level.name,this.totalElapsedMilliseconds[0],
d):(LevelCache.deleteLevelRecord(this.level.name),LevelCache.clearLastRecordName());this.setTimeDisplayTextRecord(d);Modal.hide();return[2]})})}}):!1};b.prototype.render=function(c){if(this.alive){this.frameRequest=requestAnimationFrame(this.boundRender);var e=this.level;View.drawBackground(c,e.levelPtr,!0)?(ControlMode.mode!==ControlMode.Pointer&&androidWrapper&&ControlMode.processAndroidAcceleration(),e.step(this.paused),c=View.gl,c.draw(this.levelTexture,LevelSpriteSheet.LevelModelCoordinates,
1,LevelSpriteSheet.FullTextureCoordinates,0,-(this.viewY[0]*scaleFactor|0)),c.prepareNativeDraw(View.sheetTexture),cLib._render(c.verticesPtr,e.levelPtr,LevelSpriteSheet.LevelSpriteSheetPtr,scaleFactor)&&(this.finished=!0,this.pointerCursorAttached[0]=0,this.preview?this.pause(null):(this.totalElapsedMilliseconds&&(e=this.checkRecord(),null===e?(UISpriteSheet.change(this.timeDisplayImage,UISpriteSheet.Clock),this.timeDisplayText.nodeValue=LevelCache.formatLevelRecordTime(this.totalElapsedMilliseconds[0]),
this.editNameButton.style.display="none"):(e&&LevelCache.setLevelRecord(this.level.name,this.totalElapsedMilliseconds[0],e),UISpriteSheet.change(this.timeDisplayImage,UISpriteSheet.Trophy),this.setTimeDisplayTextRecord(e),this.editNameButton.style.display="")),this.finalUIAttached||(this.finalUIAttached=!0,this.preview||(View.main.appendChild(this.backButton),View.main.appendChild(this.restartButton),View.main.appendChild(this.timeDisplay)))))):this.frameRequest&&(cancelAnimationFrame(this.frameRequest),
...
c.initialElements.push(c.baseElement);c.fileInput=c.baseElement.querySelector("#fileInput");c.toolbarTop=c.baseElement.querySelector("#toolbarTop");c.scrollContainer=new ScrollContainer(c.baseElement);c.createButton(c.toolbarTop,UISpriteSheet.Back,c.back.bind(c)).style.float="left";c.fileInput.onchange=c.openFile.bind(c);c.createButton(c.toolbarTop,UISpriteSheet.Open,c.open.bind(c));androidWrapper||isPWA||c.buttonsWithMargin.push(c.createButton(c.toolbarTop,UISpriteSheet.Fullscreen,c.fullscreen.bind(c)));
c.boundPlay=c.play.bind(c);c.boundShowMenu=c.showMenu.bind(c);c.thumbnails=null;c.thumbnailImages=null;c.thumbnailRecords=null;c.anchors=null;c.hr=null;c.lastPlayedThumbnail=null;return c}__extends(b,a);b.prototype.resize=function(){var c=this.thumbnails,e=this.thumbnailImages,d=this.thumbnailRecords,f=this.anchors,g=cssNumber(thumbnailWidth),h=cssNumber(thumbnailHeight);cssNumber(iconSize);var l=borderWidthCss+" 0 0 "+borderWidthCss,k=toolbarAvailableHeightCss+" 0 0 "+css(27),m=css(borderWidth<<
1),p=m+" 0";m+=" 0 0";this.hr&&(this.hr.style.marginTop=toolbarAvailableHeightCss,this.hr.style.borderTopWidth=borderWidthCss);this.toolbarTop.style.height=toolbarAvailableHeightCss;this.toolbarTop.style.borderBottomWidth=borderWidthCss;for(var n=c.length-1;0<=n;n--){c[n].style.width=thumbnailWidthCss;c[n].style.borderWidth=borderWidthCss;c[n].style.margin=k;c[n].style.padding=p;c[n].style.lineHeight=iconSizeCss;e[n].width=g;e[n].height=h;e[n].style.margin=m;d[n].style.borderTopWidth=borderWidthCss;
...
(e=0);baseTopCss=e/pixelRatio;View.main.style.left=baseLeftCss+"px";View.main.style.top=baseTopCss+"px";e="scale("+Math.ceil(.25*a)+","+Math.ceil(.25*b)+")";View.cover.style.webkitTransform=e;View.cover.style.mozTransform=e;View.cover.style.transform=e;b>a||baseTopCss?landscapeWarning||(landscapeWarning=document.createElement("div"),landscapeWarning.style.pointerEvents="none",landscapeWarning.style.fontSize="2em",landscapeWarning.style.textAlign="center",landscapeWarning.style.position="absolute",
