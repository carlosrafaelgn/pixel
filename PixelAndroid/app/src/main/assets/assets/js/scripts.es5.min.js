...
a.fadeLeft.style.display||(a.fadeLeft.style.display="none",a.fadeRight.style.display="none"):a.fadeLeft.style.display&&(a.fadeLeft.style.display="",a.fadeRight.style.display=""),a.glCanvas.width=baseWidth*scaleFactor,a.glCanvas.height=baseHeight*scaleFactor,a.glCanvas.style.width=baseWidthCss+"px",a.glCanvas.style.height=baseHeightCss+"px",a.gl.checkRecreate(a.glCanvas)&&a.recreateResources(),a.currentView&&a.currentView.resize())};a.windowHistoryStatePopped=function(b){a.windowHistoryStatePushed=
