...
cover.className="cover";setTimeout(()=>{View._fading=!1;View.popHistoryStateIfNecessary();document.body.removeChild(cover);this.fadeInFinished();a()},520)},50)}fadeIn(){return __awaiter(this,void 0,void 0,function*(){if(View._fading||View.currentView===this)return null;View._fading=!0;View.currentView=this;return new Promise((a,b)=>{if((b=this.initialElements)&&!this.attached){for(let c=0;c<b.length;c++){const d=b[c];d&&main.appendChild(d)}this.attached=!0;if(b=this.attach()){b.then(()=>{this.finishFadeIn(a)},
c=>{console.error(c)});return}}this.finishFadeIn(a)})})}fadeOut(a){return __awaiter(this,void 0,void 0,function*(){if(View._fading||View.currentView!==this)return null;View._fading=!0;View.backgroundFrameRequest&&(cancelAnimationFrame(View.backgroundFrameRequest),View.backgroundFrameRequest=0);return new Promise((b,c)=>{cover.className="cover";document.body.appendChild(cover);setTimeout(()=>{cover.className="cover visible";setTimeout(()=>__awaiter(this,void 0,void 0,function*(){yield this.destroy(a);
