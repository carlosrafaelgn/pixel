...
class PointerHandler{constructor(a,b=null,c=null,d=null){this.documentTarget=document.documentElement||document.body;this.captured=!1;this.pointerId=-1;this.referenceElement=a;this.downCallback=b;this.moveCallback=c;this.upCallback=d;"ontouchstart"in this.documentTarget?(this.documentDownEvent="touchstart",this.documentMoveEvent="touchmove",this.documentUpEvent="touchend",this.documentCancelEvent="touchcancel",this.boundDocumentDown=this.touchStart.bind(this),this.boundDocumentUp=this.touchEnd.bind(this),
this.boundDocumentMove=this.touchMove.bind(this)):"onpointerdown"in this.documentTarget?(this.documentDownEvent="pointerdown",this.documentMoveEvent="pointermove",this.documentUpEvent="pointerup",this.documentCancelEvent="pointercancel",this.boundDocumentDown=this.pointerDown.bind(this),this.boundDocumentUp=this.pointerUp.bind(this),this.boundDocumentMove=this.pointerMove.bind(this)):(this.documentDownEvent="mousedown",this.documentMoveEvent="mousemove",this.documentUpEvent="mouseup",this.documentCancelEvent=
null,this.boundDocumentDown=this.mouseDown.bind(this),this.boundDocumentUp=this.mouseUp.bind(this),this.boundDocumentMove=this.mouseMove.bind(this));this.documentTarget.addEventListener(this.documentDownEvent,this.boundDocumentDown)}destroy(){this.boundDocumentDown&&this.documentTarget.removeEventListener(this.documentDownEvent,this.boundDocumentDown);this.mouseUp(null);zeroObject(this)}pointerDown(a){if(0<=this.pointerId&&"mouse"!==a.pointerType)return cancelEvent(a);const b=this.mouseDown(a);this.captured&&
(this.pointerId=a.pointerId);return b}pointerMove(a){if(this.captured&&a.pointerId===this.pointerId)return this.mouseMove(a)}pointerUp(a){if(this.captured&&a.pointerId===this.pointerId)return this.pointerId=-1,this.mouseUp(a)}touchStart(a){if(!(1<a.touches.length))return 0<=this.pointerId&&this.touchEnd(a),this.pointerId=1,a.clientX=a.touches[0].clientX,a.clientY=a.touches[0].clientY,a=this.mouseDown(a),void 0===a&&(this.pointerId=-1),a}touchMove(a){if(this.captured&&!(1<a.touches.length))return a.clientX=
a.touches[0].clientX,a.clientY=a.touches[0].clientY,this.mouseMove(a)}touchEnd(a){if(this.captured&&!(0>this.pointerId))return this.pointerId=-1,this.mouseUp(a)}mouseDown(a){this.mouseUp(a);if(!(a.button||View.fading||a.target&&a.target!==this.referenceElement)){if(this.downCallback&&!this.downCallback(a))return cancelEvent(a);this.captured=!0;this.documentTarget.addEventListener(this.documentMoveEvent,this.boundDocumentMove,{capture:!0,passive:!1});this.documentTarget.addEventListener(this.documentUpEvent,
this.boundDocumentUp,!0);this.documentCancelEvent&&this.documentTarget.addEventListener(this.documentCancelEvent,this.boundDocumentUp,!0);return cancelEvent(a)}}mouseMove(a){if(this.captured)return this.moveCallback&&this.moveCallback(a),cancelEvent(a)}mouseUp(a){if(this.captured)return this.documentTarget.removeEventListener(this.documentUpEvent,this.boundDocumentUp,!0),this.documentTarget.removeEventListener(this.documentMoveEvent,this.boundDocumentMove,!0),this.documentCancelEvent&&this.documentTarget.removeEventListener(this.documentCancelEvent,
this.boundDocumentUp,!0),this.captured=!1,this.upCallback&&this.upCallback(a),cancelEvent(a)}}
...
this.containerElement.appendChild(this.modalElement);main.appendChild(this.containerElement);this.boundDocumentKeyDown=this.documentKeyDown.bind(this);document.addEventListener("keydown",this.boundDocumentKeyDown,!0);this.fading=!0;setTimeout(()=>{if(a.onshowing)a.onshowing();this.resizeInternal();this.containerElement.className="base-element modal-container visible";setTimeout(()=>{this.fading=!1;View.pushHistoryStateIfNecessary();if(this.options.onshown)this.options.onshown()},520)},50)}static get visible(){return!!Modal.modal}static get currentModalElement(){return Modal.modal?
...
fade.className="fade";setTimeout(()=>{View._fading=!1;View.popHistoryStateIfNecessary();this.fadeInFinished();document.body.removeChild(fade);a()},520)},50)}fadeIn(){return __awaiter(this,void 0,void 0,function*(){if(View._fading||View.currentView===this)return null;View._fading=!0;View.currentView=this;return new Promise((a,b)=>{if((b=this.initialElements)&&!this.attached){for(let c=0;c<b.length;c++){const d=b[c];d&&main.appendChild(d)}this.attached=!0;if(b=this.attach()){b.then(()=>{this.finishFadeIn(a)},
c=>{console.error(c)});return}}this.finishFadeIn(a)})})}fadeOut(a){return __awaiter(this,void 0,void 0,function*(){if(View._fading||View.currentView!==this)return null;View._fading=!0;View.backgroundFrameRequest&&(cancelAnimationFrame(View.backgroundFrameRequest),View.backgroundFrameRequest=0);return new Promise((b,c)=>{fade.className="fade";document.body.appendChild(fade);setTimeout(()=>{fade.className="fade visible";setTimeout(()=>__awaiter(this,void 0,void 0,function*(){yield this.destroy(a);a&&
View.viewStack.push(this);View.currentView=null;View._fading=!1;View.pushHistoryStateIfNecessary();b()}),520)},50)})})}fadeTo(a,b=!1){return __awaiter(this,void 0,void 0,function*(){if(View._fading||View.currentView!==this)return null;yield this.fadeOut(b);return("string"===typeof a?new viewClasses[a]:a).fadeIn()})}fadeToPrevious(){return __awaiter(this,void 0,void 0,function*(){if(View._fading||View.currentView!==this||!View.viewStack.length)return null;yield this.fadeOut(!1);return View.viewStack.pop().fadeIn()})}}
View._loading=!1;View._fading=!1;View.currentView=null;View.viewStack=[];View.divLoading=null;View.divLoadingTimeout=0;View.windowHistoryStatePushed=!1;View.gl=null;View.sheetTexture=null;View.backgroundFrameRequest=0;View.recreateResourcesTimeout=0;
...
a+" "+a;this.scrollContainer.resize(toolbarTotalHeight,baseHeight-(toolbarTotalHeight<<1));this.pointerCursor.style.borderWidth=borderWidthCss;this.pointerCursor.style.width=c;this.pointerCursor.style.height=c;a=this.level.objects;for(b=a.length-1;0<=b;b--){c=a[b];const d=this.objectImages[b];d.style.left=css(c.x-iconRadius);d.style.top=css(c.y-iconRadius);UISpriteSheet.resize(d)}super.resize()}attach(){return __awaiter(this,void 0,void 0,function*(){glCanvas.style.display="none";if(!this.level){this.level=
...
0,0);this.context.globalCompositeOperation=this.contextGlobalCompositeOperation;this.boundDocumentKeyUp&&document.addEventListener("keyup",this.boundDocumentKeyUp,!0)})}detach(){return __awaiter(this,void 0,void 0,function*(){glCanvas.style.display="";this.pointerHandler&&(this.pointerHandler.destroy(),this.pointerHandler=null);this.scrollContainer.detach();this.brushContext=this.brushCanvas=this.context=null;this.boundDocumentKeyUp&&document.removeEventListener("keyup",this.boundDocumentKeyUp,!0)})}destroyInternal(a){this.save()}save(){if(this.dirty||
...
"";b.result?loadImage(b.result).then(c=>{this.clearImage();this.context.globalCompositeOperation="source-over";setContextQuality(this.context,!0);const d=c.width,e=c.height;if(d<=baseWidth&&e<=maxHeight)this.context.drawImage(c,baseWidth-d>>1,0);else{let f=d,g=e;f>baseWidth&&(g*=baseWidth/f,f=baseWidth);g>maxHeight&&(f*=maxHeight/g,g=maxHeight);f|=0;g|=0;this.context.drawImage(c,0,0,d,e,baseWidth-f>>1,0,f,g)}setContextQuality(this.context,!1);this.context.globalCompositeOperation=this.contextGlobalCompositeOperation},
()=>{Modal.show({html:Strings.ErrorLoadingImage+UISpriteSheet.html(UISpriteSheet.Error)})}):(View.loading=!1,Modal.show({html:Strings.EmptyImage+UISpriteSheet.html(UISpriteSheet.Error)}))};b.onerror=()=>{this.fileInput.value="";View.loading=!1;Modal.show({html:Strings.ErrorReadingImage+UISpriteSheet.html(UISpriteSheet.Error)})};b.readAsDataURL(this.fileInput.files[0])}else Modal.show({html:Strings.InvalidImage+UISpriteSheet.html(UISpriteSheet.Error)})}open(a){if(Modal.visible)return!1;this.fileInput.click();
...
{this.level.name="";this.level.createdAt=0;this.level.modifiedAt=0;this.clearImage();this.clearObjects();Modal.hide()}}]});return!0}accept(a){if(Modal.visible)return!1;let b=!1,c=!1,d=!1;this.save();Modal.show({title:Strings.SaveLevel,html:`<label for="name">${Strings.LevelName}</label><input id="name" spellcheck="false" autocomplete="off" />`,okcancel:!0,okcancelsubmit:!0,onshowing:()=>{document.getElementById("name").value=this.level.name},onshown:()=>{document.getElementById("name").focus()},onok:()=>
__awaiter(this,void 0,void 0,function*(){var e=document.getElementById("name").value.trim();e?LevelCache.isNameValid(e)||(c=!0,Modal.hide()):(e=new Date,e=`${e.getFullYear()}-${format2(e.getMonth()+1)}-${format2(e.getDate())} ${format2(e.getHours())}${format2(e.getMinutes())}${format2(e.getSeconds())}`);e!==this.level.name&&(this.level.name=e,this.dirty=!0,this.save());View.loading=!0;try{yield this.level.prepare(),yield LevelCache.saveLevel(this.level,!1),b=!0}catch(f){d=!0}finally{View.loading=
!1,Modal.hide()}}),onhidden:()=>{c?Modal.show({html:Strings.NameCannotContain+" \\ / ? * : < > % "+UISpriteSheet.html(UISpriteSheet.Error)}):d?Modal.show({html:Strings.SomethingWentWrong+UISpriteSheet.html(UISpriteSheet.Error)}):b&&Modal.show({title:Strings.Success,html:Strings.LevelSaved+UISpriteSheet.html(UISpriteSheet.Success)})}});return!0}play(a){this.save();View.loading=!0;this.level.prepare().then(()=>{View.loading=!1;this.fadeTo(new GameView({level:this.level},!0),!0)},b=>{View.loading=!1;
if(b&&b.message){if(b.message===Level.MaxPolygonCountMessage){Modal.show({html:Strings.TooManyPolygons+Level.MaxPolygonCount+" "+UISpriteSheet.html(UISpriteSheet.Error)});return}if(b.message===Level.MaxPointCountMessage){Modal.show({html:Strings.TooManyPoints+Level.MaxPointCount+" "+UISpriteSheet.html(UISpriteSheet.Error)});return}}Modal.show({html:Strings.SomethingWentWrong+UISpriteSheet.html(UISpriteSheet.Error)})});return!0}documentKeyUp(a){if(!View.loading&&!Modal.visible)if("d"===a.key)this.keyUpTime=
Date.now(),this.keyUpCounter=1;else switch(this.keyUpCounter){case 1:this.keyUpCounter="b"===a.key&&2E3>Date.now()-this.keyUpTime?2:0;break;case 2:if(2E3>Date.now()-this.keyUpTime)switch(a.key){case "g":confirm(Strings.YouWillLoseYourLevel)&&this.devDebug();break;case "s":this.devSave()}this.keyUpCounter=0}}devDebug(){processImage(this.canvas,this.context,!0)}devSave(){return __awaiter(this,void 0,void 0,function*(){this.level.name="0";this.save();yield this.level.prepare();var a=document.createElement("a");
a.href=this.level.image;a.download="image.png";a.click();a=document.createElement("a");a.href=this.level.processedImage;a.download="processedImage.png";a.click();a=document.createElement("a");a.href=this.level.thumbnailImage;a.download="thumbnailImage.png";a.click();Modal.show({html:'I <input id="inputImage" type="file" accept="image/png" />\n\t\t\tP <input id="inputProcessedImage" type="file" accept="image/png" />\n\t\t\tT <input id="inputThumbnailImage" type="file" accept="image/png" />',okcancel:!0,
onok:()=>{const b=new FileReader;b.onload=()=>{const c=new FileReader;c.onload=()=>{const d=new FileReader;d.onload=()=>{this.level.createdAt=0;this.level.modifiedAt=0;this.level.image=b.result;this.level.processedImage=c.result;this.level.thumbnailImage=null;console.log("'"+JSON.stringify(this.level)+"',");console.log("'"+d.result+"',");Modal.hide()};d.readAsDataURL(document.getElementById("inputThumbnailImage").files[0])};c.readAsDataURL(document.getElementById("inputProcessedImage").files[0])};
...
"line-height:"+iconSize);const c=UISpriteSheet.create(UISpriteSheet.Trophy);c.setAttribute("data-style","margin-right:"+buttonMargin);b.insertBefore(c,b.firstChild);UISpriteSheet.create(UISpriteSheet.Trophy,b).setAttribute("data-style","margin-left:"+buttonMargin)}document.getElementById("name").value=LevelCache.LastRecordName||""},onshown:()=>{document.getElementById("name").focus()},onok:()=>__awaiter(this,void 0,void 0,function*(){if(this.alive&&this.level&&this.totalElapsedMilliseconds){var b=
document.getElementById("name").value.trim();b?LevelCache.setLevelRecord(this.level.name,this.totalElapsedMilliseconds[0],b):(LevelCache.deleteLevelRecord(this.level.name),LevelCache.clearLastRecordName());this.setTimeDisplayTextRecord(b);Modal.hide()}})}):!1}render(a){if(this.alive){this.frameRequest=requestAnimationFrame(this.boundRender);var b=this.level;View.drawBackground(a,b.levelPtr,!0)?(ControlMode.mode!==ControlMode.Pointer&&androidWrapper&&ControlMode.processAndroidAcceleration(),b.step(this.paused),
a=View.gl,a.draw(this.levelTexture,LevelSpriteSheet.LevelModelCoordinates,1,LevelSpriteSheet.FullTextureCoordinates,0,-(this.viewY[0]*scaleFactor|0)),a.prepareNativeDraw(View.sheetTexture),cLib._render(a.verticesPtr,b.levelPtr,LevelSpriteSheet.LevelSpriteSheetPtr,scaleFactor)&&(this.finished=!0,this.pointerCursorAttached[0]=0,this.preview?this.pause(null):(this.totalElapsedMilliseconds&&(b=this.checkRecord(),null===b?(UISpriteSheet.change(this.timeDisplayImage,UISpriteSheet.Clock),this.timeDisplayText.nodeValue=
LevelCache.formatLevelRecordTime(this.totalElapsedMilliseconds[0]),this.editNameButton.style.display="none"):(b&&LevelCache.setLevelRecord(this.level.name,this.totalElapsedMilliseconds[0],b),UISpriteSheet.change(this.timeDisplayImage,UISpriteSheet.Trophy),this.setTimeDisplayTextRecord(b),this.editNameButton.style.display="")),this.finalUIAttached||(this.finalUIAttached=!0,this.preview||(main.appendChild(this.backButton),main.appendChild(this.restartButton),main.appendChild(this.timeDisplay)))))):
this.frameRequest&&(cancelAnimationFrame(this.frameRequest),this.frameRequest=0)}else this.frameRequest=0}}GameView.FinishedThisFrame=1;GameView.FinishedVictory=2;GameView.FinishedLoss=4;GameView.wakeLockSentinel=null;
...
const b=a.target,c=this.getTargetThumbnail(b);if(!c)return!1;a=!!c.getAttribute("data-id");let d=!1,e=!1;return Modal.show({title:Strings.Menu,html:`<button type="button" id="edit" ${a?"":`data-style="margin-bottom: ${buttonMargin}"`}>${UISpriteSheet.html(UISpriteSheet.Edit)}${Strings.Edit}</button>
...
buttonMarginCss;super.resize()}attach(){return __awaiter(this,void 0,void 0,function*(){glCanvas.style.cursor="default"})}detach(){return __awaiter(this,void 0,void 0,function*(){glCanvas.style.cursor=""})}destroyInternal(a){}play(a){if(Modal.visible)return!1;this.fadeTo("SelectionView");return!0}edit(a){if(Modal.visible)return!1;this.fadeTo("EditorView");return!0}fullscreen(a){fullscreenControl.toggleFullscreen();return!0}exit(a){androidWrapper.exit();return!0}about(a){if(Modal.visible)return!1;
a=[{defaultCancel:!0,iconId:UISpriteSheet.Back,text:Strings.Close,onclick:Modal.hide}];!androidWrapper&&installationPrompt&&installationPrompt.prompt&&a.push({iconId:UISpriteSheet.Download,text:Strings.Install,onclick:(b,c)=>{if(installationPrompt)try{b=installationPrompt,installationPrompt=null,b.prompt()}catch(d){}setTimeout(()=>{c.style.display="none"},buttonBlinkTotalDurationMS)}});Modal.show({title:Strings.About,large:!0,html:Strings.About1+(2===View.gl.contextVersion?Strings.About2:"")+Strings.About3+
(window.pixelUsingWebAssembly?"":Strings.About4)+Strings.About5+UISpriteSheet.html(UISpriteSheet.Success)+"</p>"+(androidWrapper||navigator.wakeLock&&navigator.wakeLock.request?"":Strings.About6)+Strings.About7,buttons:a});return!0}}const viewClasses={EditorView,GameView,SelectionView,TitleView};
...
function model(a){return a*pixelRatio/scaleFactor|0}function modelFrac(a){return a*pixelRatio/scaleFactor}function smoothStep(a){return a*a*(3-2*a)}function handleButtonBlink(a){const b=a[0],c=a[1];0<b&&b<buttonBlinkLastCounter?(c.style.visibility=b&1?"":"hidden",a[0]=b+1):((a=parseInt(c.getAttribute("data-blink-interval")))&&clearInterval(a),c.style.visibility="",c.setAttribute("data-blink-interval",""))}
function prepareButtonBlink(a,b,c){a.onclick=d=>{View.loading||View.fading||!b&&Modal.visible||!c(d)||((d=parseInt(a.getAttribute("data-blink-interval")))&&clearInterval(d),a.style.visibility="hidden",a.setAttribute("data-blink-interval",setInterval(handleButtonBlink,buttonBlinkSingleDurationMS,[1,a]).toString()))}}
