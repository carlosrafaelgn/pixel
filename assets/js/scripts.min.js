...
!androidWrapper&&installationPrompt&&installationPrompt.prompt&&a.push({iconId:UISpriteSheet.Download,text:Strings.Install,onclick:(b,c)=>{if(installationPrompt)try{b=installationPrompt,installationPrompt=null,b.prompt()}catch(d){}setTimeout(()=>{c.style.display="none"},blinkTotalDurationMS)}});Modal.show({title:Strings.About+` <span style="float: right;">v${version}</span>`,large:!0,html:Strings.About1+(2===View.gl.contextVersion?Strings.About2:"")+Strings.About3+(window.pixelUsingWebAssembly?"":
