...
class PointerHandler{constructor(a,b=null,c=null,d=null){this.documentTarget=null;this.captured=!1;this.pointerId=-1;this.boundDocumentMove=this.boundDocumentUp=this.upCallback=this.moveCallback=this.downCallback=this.documentCancelEvent=this.documentUpEvent=this.documentMoveEvent=this.element=null;this.documentTarget=document.documentElement||document.body;this.element=a;this.downCallback=b;this.moveCallback=c;this.upCallback=d;"ontouchstart"in a?(this.documentMoveEvent="touchmove",this.documentUpEvent=
