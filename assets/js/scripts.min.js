...
document.body.appendChild(landscapeWarning)):landscapeWarning&&(document.body.removeChild(landscapeWarning),landscapeWarning=null);scaleFactor!==c||baseHeight!==f?(main.style.width=baseWidthCss+"px",main.style.height=baseHeightCss+"px",landscapeWarning&&(landscapeWarning.style.fontSize=css(16)),maxHeightCss=cssNumber(maxHeight),thumbnailWidthCss=css(thumbnailWidth),thumbnailHeightCss=css(thumbnailHeight),buttonHeightCss=css(buttonHeight),borderWidthCss=css(borderWidth),toolbarAvailableHeightCss=css(toolbarAvailableHeight),
toolbarTotalHeightCss=css(toolbarTotalHeight),iconSizeCss=css(iconSize),buttonMarginCss=css(buttonMargin),buttonLargeMarginCss=css(buttonLargeMargin),buttonPaddingCss=css(buttonPadding),fontSizeCss=css(8),document.body.style.fontSize=fontSizeCss,LevelSpriteSheet.recreateIfNecessary(),UISpriteSheet.windowResized(),View.windowResized(!0),Modal.windowResized()):View.windowResized(!1)}function beforeInstallPrompt(a){"preventDefault"in a&&a.preventDefault();installationPrompt=a}
