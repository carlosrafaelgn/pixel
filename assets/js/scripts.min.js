...
class FullscreenControl{static nop(){}static ignorePromise(a){try{a&&a.then&&a.then(FullscreenControl.nop,FullscreenControl.nop)}catch(b){}}requestFullscreen(a){a||(a=document.body);let b=!0,c=null;try{"requestFullscreen"in a?c=a.requestFullscreen():"webkitRequestFullscreen"in a?c=a.webkitRequestFullscreen():"mozRequestFullScreen"in a?c=a.mozRequestFullScreen():"msRequestFullScreen"in a?c=a.msRequestFullScreen():b=!1}catch(d){b=!1}b||a===document.body?FullscreenControl.ignorePromise(c):this.requestFullscreen(null)}exitFullscreen(){let a=
null;try{"exitFullscreen"in document?a=document.exitFullscreen():"webkitExitFullscreen"in document?a=document.webkitExitFullscreen():"mozExitFullScreen"in document?a=document.mozExitFullScreen():"msExitFullscreen"in document&&(a=document.msExitFullscreen())}catch(b){}FullscreenControl.ignorePromise(a)}get fullscreenElement(){let a=null;try{"fullscreenElement"in document&&(a=document.fullscreenElement),!a&&"webkitFullscreenElement"in document&&(a=document.webkitFullscreenElement),!a&&"mozFullscreenElement"in
document&&(a=document.mozFullscreenElement),!a&&"msFullscreenElement"in document&&(a=document.msFullscreenElement)}catch(b){}return a}get onfullscreenchange(){try{if("onfullscreenchange"in document)return document.onfullscreenchange;if("onwebkitfullscreenchange"in document)return document.onwebkitfullscreenchange;if("onmozfullscreenchange"in document)return document.onmozfullscreenchange;if("onmsfullscreenchange"in document)return document.onmsfullscreenchange}catch(a){}return null}set onfullscreenchange(a){try{"onfullscreenchange"in
document&&(document.onfullscreenchange=a),"onwebkitfullscreenchange"in document&&(document.onwebkitfullscreenchange=a),"onmozfullscreenchange"in document&&(document.onmozfullscreenchange=a),"onmsfullscreenchange"in document&&(document.onmsfullscreenchange=a)}catch(b){}}toggleFullscreen(){this.fullscreenMode=!this.fullscreenMode}get fullscreenMode(){return!!this.fullscreenElement}set fullscreenMode(a){a?this.requestFullscreen():this.exitFullscreen()}}const fullscreenControl=new FullscreenControl;
...
buttonPadding+"px",fontSizeCss="16px",installationPrompt=null,landscapeWarning=null;function cancelEvent(a){a&&("isCancelled"in a&&(a.isCancelled=!0),"preventDefault"in a&&a.preventDefault(),"stopPropagation"in a&&a.stopPropagation());return!1}function format2(a){return 10>a?"0"+a:a.toString()}function css(a){return(a|0)*scaleFactor/pixelRatio+"px"}function cssNumber(a){return(a|0)*scaleFactor/pixelRatio}function model(a){return a*pixelRatio/scaleFactor|0}
function modelFrac(a){return a*pixelRatio/scaleFactor}function smoothStep(a){return a*a*(3-2*a)}
...
function fullscreenChanged(a){if(screen.mozLockOrientation&&screen.mozUnlockOrientation)try{if(fullscreenControl.fullscreenMode){if(screen.mozLockOrientation("landscape-primary"))return}else if(screen.mozUnlockOrientation())return}catch(b){}if(screen.msLockOrientation&&screen.msUnlockOrientation)try{if(fullscreenControl.fullscreenMode){if(screen.msLockOrientation("landscape-primary"))return}else if(screen.msUnlockOrientation())return}catch(b){}if(screen.orientation&&screen.orientation.lock&&screen.orientation.unlock)try{fullscreenControl.fullscreenMode?
screen.orientation.lock("landscape-primary").then(()=>{},()=>{}):screen.orientation.unlock()}catch(b){}}
