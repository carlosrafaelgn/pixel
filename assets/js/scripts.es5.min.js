...
0;cLib.HEAPF32[f+1]=c?-c:0;cLib.HEAPF32[f+2]=e-b;cLib.HEAPF32[f+3]=d-c};return a}(),TextureCoordinates=function(){function a(b){this.ptr=b}a.prototype.setCoordinates=function(b,c,e,d){var f=this.ptr>>2;e=b+e;d=c+d;combineAlphaAndTexture?(cLib.HEAPF32[f]=b<<9|c<<1,cLib.HEAPF32[f+1]=b<<9|d<<1,cLib.HEAPF32[f+2]=e<<9|c<<1,cLib.HEAPF32[f+3]=e<<9|d<<1):(cLib.HEAPF32[f]=b/LevelSpriteSheet.TextureWidth,cLib.HEAPF32[f+1]=c/LevelSpriteSheet.TextureHeight,cLib.HEAPF32[f+2]=e/LevelSpriteSheet.TextureWidth,cLib.HEAPF32[f+
3]=d/LevelSpriteSheet.TextureHeight)};return a}(),Texture=function(a){function b(c,e,d,f){void 0===d&&(d=0);void 0===f&&(f=0);var g=a.call(this)||this;g.gl=c;g._width=0;g._height=0;g._image=null;g._texture=null;g.bindImage(e,d,f);return g}__extends(b,a);Object.defineProperty(b.prototype,"width",{get:function(){return this._width},enumerable:!1,configurable:!0});Object.defineProperty(b.prototype,"height",{get:function(){return this._height},enumerable:!1,configurable:!0});Object.defineProperty(b.prototype,
"image",{get:function(){return this._image},enumerable:!1,configurable:!0});Object.defineProperty(b.prototype,"texture",{get:function(){return this._texture},enumerable:!1,configurable:!0});Object.defineProperty(b.prototype,"loaded",{get:function(){return!!this._texture},enumerable:!1,configurable:!0});b.prototype.loadInternal=function(){this._image&&this.bindImage(this._image,this._width,this._height)};b.prototype.releaseInternal=function(){this.gl.context.deleteTexture(this._texture);this._texture=
null};b.prototype.destroyInternal=function(){this.gl=this._image=null};b.prototype.bindImage=function(c,e,d){this.release();e=c?c.width:e;d=c?c.height:d;this._width=e;this._height=d;this._image=c;var f=this.gl.context;if(f){if(0>=e||0>=d)throw Error("Invalid image size: "+e+" x "+d);var g=Math.min(4096,f.getParameter(f.MAX_TEXTURE_SIZE));if(e>g||d>g)throw Error("Image size too large: "+e+" x "+d+" / max: "+g);this.gl.clearErrors();g=f.createTexture();if(!g)throw Error("Null texture: "+f.getError());
this._texture=g;f.bindTexture(f.TEXTURE_2D,g);c?f.texImage2D(f.TEXTURE_2D,0,f.RGBA,f.RGBA,f.UNSIGNED_BYTE,c):f.texImage2D(f.TEXTURE_2D,0,f.RGBA,e,d,0,f.RGBA,f.UNSIGNED_BYTE,null);f.texParameteri(f.TEXTURE_2D,f.TEXTURE_MIN_FILTER,f.NEAREST);f.texParameteri(f.TEXTURE_2D,f.TEXTURE_MAG_FILTER,f.NEAREST);f.texParameteri(f.TEXTURE_2D,f.TEXTURE_WRAP_S,f.CLAMP_TO_EDGE);f.texParameteri(f.TEXTURE_2D,f.TEXTURE_WRAP_T,f.CLAMP_TO_EDGE);this.gl.throwIfError();f.bindTexture(f.TEXTURE_2D,null)}};return b}(Resource),
WebGL=function(){function a(){this.framebufferTextureViewHeight=this.framebufferTextureViewWidth=this.viewHeight=this.viewWidth=0;this.uniformViewConstants=this.currentTexture=this.indexBuffer=this.vertexBuffer=this.fragmentShader=this.vertexShader=this.program=null;this.verticesPtr=this.rectangleCount=0;this.context=this.vertices=null;this.contextVersion=0;this.framebufferTexture=this.framebuffer=null;window.drawNative=this.drawNative.bind(this)}a.prototype.clearErrors=function(){for(var b=this.context,
c=3;b.getError()!==b.NO_ERROR&&0<c--;)b.getError()};a.prototype.throwIfError=function(b){void 0===b&&(b=1);var c=this.context.getError();if(!b||c!==this.context.NO_ERROR)throw Error("WebGL error: "+c);};a.prototype.prepareNativeDraw=function(b){this.flush();this.currentTexture=b};a.prototype.drawNative=function(b){this.rectangleCount=b;this.flush()};a.prototype.checkRecreate=function(b){return!this.context||this.context.isContextLost()||b.width!==this.viewWidth||b.height!==this.viewHeight};a.nextPowerOfTwo=
function(b){if(!(b&b-1))return b;b|=b>>>1;b|=b>>>2;b|=b>>>4;b|=b>>>8;return(b|b>>>16)+1};a.prototype.recreate=function(b,c,e){var d=b.width,f=b.height;this.destroy(!0);if(!isIOSOrSafari&&"undefined"!==typeof WebGL2RenderingContext)try{this.context=b.getContext("webgl2",{alpha:!1,depth:!1,stencil:!1,antialias:!1,premultipliedAlpha:!0}),this.contextVersion=2}catch(h){}if(!this.context)try{this.context=b.getContext("webgl",{alpha:!1,depth:!1,stencil:!1,antialias:!1,premultipliedAlpha:!0}),this.contextVersion=
1}catch(h){}this.context||(this.context=b.getContext("experimental-webgl",{alpha:!1,depth:!1,stencil:!1,antialias:!1,premultipliedAlpha:!0}),this.contextVersion=1);if(!this.context)throw Error("WebGL apparently not supported");b=this.context;this.clearErrors();this.viewWidth=d;this.viewHeight=f;d=this.program=b.createProgram();this.throwIfError(d);f=this.vertexShader=b.createShader(b.VERTEX_SHADER);this.throwIfError(f);b.shaderSource(f,2===this.contextVersion?a.VertexShaderSource2:a.VertexShaderSource);
b.compileShader(f);if(!b.getShaderParameter(f,b.COMPILE_STATUS))throw Error("WebGL vertex shader compilation error: "+b.getShaderInfoLog(f));this.throwIfError();var g=this.fragmentShader=b.createShader(b.FRAGMENT_SHADER);this.throwIfError(g);b.shaderSource(g,2===this.contextVersion?a.FragmentShaderSource2:a.FragmentShaderSource);b.compileShader(g);if(!b.getShaderParameter(g,b.COMPILE_STATUS))throw Error("WebGL fragment shader compilation error: "+b.getShaderInfoLog(g));this.throwIfError();b.attachShader(d,
f);b.attachShader(d,g);b.linkProgram(d);b.useProgram(d);this.throwIfError();this.uniformViewConstants=b.getUniformLocation(d,"uViewConstants");b.activeTexture(b.TEXTURE0);b.uniform1i(b.getUniformLocation(d,"uTexture"),0);this.throwIfError();b.disable(b.DEPTH_TEST);b.disable(b.CULL_FACE);b.disable(b.DITHER);b.disable(b.SCISSOR_TEST);b.disable(b.POLYGON_OFFSET_FILL);b.disable(b.SAMPLE_ALPHA_TO_COVERAGE);b.disable(b.SAMPLE_COVERAGE);b.disable(b.STENCIL_TEST);b.enable(b.BLEND);b.pixelStorei(b.UNPACK_PREMULTIPLY_ALPHA_WEBGL,
!0);this.setDefaultComposition();this.throwIfError();this.vertexBuffer=b.createBuffer();this.indexBuffer=b.createBuffer();this.allocateRectangleBuffers();f=a.nextPowerOfTwo(c);g=a.nextPowerOfTwo(e);c=Math.ceil(c*LevelSpriteSheet.TextureWidth/f);e=Math.ceil(e*LevelSpriteSheet.TextureHeight/g);this.framebufferTextureViewWidth=c*f/LevelSpriteSheet.TextureWidth|0;this.framebufferTextureViewHeight=e*g/LevelSpriteSheet.TextureHeight|0;this.framebufferTexture=new Texture(this,null,f,g);LevelSpriteSheet.FramebufferTextureCoordinates.setCoordinates(0,
0,c,e);this.throwIfError();this.framebuffer=b.createFramebuffer();this.throwIfError();b.bindFramebuffer(b.FRAMEBUFFER,this.framebuffer);b.framebufferTexture2D(b.FRAMEBUFFER,b.COLOR_ATTACHMENT0,b.TEXTURE_2D,this.framebufferTexture.texture,0);this.useFramebuffer(!1);e=b.getAttribLocation(d,"aPosition");b.enableVertexAttribArray(e);b.vertexAttribPointer(e,a.FloatsPerPosition,b.FLOAT,!1,a.BytesPerVertex,a.BufferIndexPosition);combineAlphaAndTexture?(e=b.getAttribLocation(d,"aAlphaTextureCoordinates"),
b.enableVertexAttribArray(e),b.vertexAttribPointer(e,a.FloatsPerAlphaTextureCoordinates,b.FLOAT,!1,a.BytesPerVertex,a.BufferIndexAlphaTextureCoordinates)):(e=b.getAttribLocation(d,"aAlpha"),d=b.getAttribLocation(d,"aTextureCoordinates"),b.enableVertexAttribArray(e),b.enableVertexAttribArray(d),b.vertexAttribPointer(e,a.FloatsPerAlpha,b.FLOAT,!1,a.BytesPerVertex,a.BufferIndexAlpha),b.vertexAttribPointer(d,a.FloatsPerTextureCoordinates,b.FLOAT,!1,a.BytesPerVertex,a.BufferIndexTextureCoordinates))};
a.prototype.destroy=function(b){var c=this.context,e=this.verticesPtr,d=this.vertices;c&&(c.bindFramebuffer(c.FRAMEBUFFER,null),this.framebufferTexture&&this.framebufferTexture.destroy(),this.framebuffer&&c.deleteFramebuffer(this.framebuffer),this.program&&c.deleteProgram(this.program),this.vertexShader&&c.deleteShader(this.vertexShader),this.fragmentShader&&c.deleteShader(this.fragmentShader),this.vertexBuffer&&c.deleteBuffer(this.vertexBuffer),this.indexBuffer&&c.deleteBuffer(this.indexBuffer));
zeroObject(this);b?(this.verticesPtr=e,this.vertices=d):e&&cLib._freeBuffer(e)};a.prototype.flush=function(){var b=this.rectangleCount;if(b){var c=this.context;c.bufferSubData(c.ARRAY_BUFFER,0,this.vertices.subarray(0,a.FloatsPerRectangle*b));c.bindTexture(c.TEXTURE_2D,this.currentTexture.texture);c.drawElements(c.TRIANGLES,6*b,c.UNSIGNED_SHORT,0);this.rectangleCount=0}};a.prototype.checkForLostContext=function(){var b=this.context;return b?b.isContextLost()?(this.destroy(!0),!1):!0:!1};a.prototype.setSumComposition=
...
this.currentTexture=b;cLib._drawScaleRotate(this.verticesPtr+a.BytesPerRectangle*this.rectangleCount,c.ptr,e,d.ptr,f,g,h,l);this.rectangleCount++};a.RectangleCapacity=512;a.FloatsPerPosition=2;a.FloatsPerAlpha=1;a.FloatsPerTextureCoordinates=2;a.FloatsPerAlphaTextureCoordinates=combineAlphaAndTexture?1:a.FloatsPerAlpha+a.FloatsPerTextureCoordinates;a.FloatsPerVertex=a.FloatsPerPosition+a.FloatsPerAlphaTextureCoordinates;a.BytesPerVertex=4*a.FloatsPerVertex;a.FloatsPerRectangle=4*a.FloatsPerVertex;
a.BytesPerRectangle=4*a.FloatsPerRectangle;a.BufferIndexPosition=0;a.BufferIndexAlphaTextureCoordinates=a.BufferIndexPosition+4*a.FloatsPerPosition;a.BufferIndexAlpha=a.BufferIndexPosition+4*a.FloatsPerPosition;a.BufferIndexTextureCoordinates=a.BufferIndexAlpha+4;a.VertexShaderSource2=combineAlphaAndTexture?"#version 300 es\nprecision highp float;\nin vec2 aPosition;\nin float aAlphaTextureCoordinates;\nflat out lowp float vAlpha;\nout lowp vec2 vTextureCoordinates;\nuniform vec2 uViewConstants;\nconst vec2 uViewOffsets = vec2(-1.0, 1.0);\nvoid main() {\n\tgl_Position = vec4(aPosition * uViewConstants + uViewOffsets, 0.0, 1.0);\n\tvAlpha = mod(aAlphaTextureCoordinates, 2.0);\n\tvTextureCoordinates = floor(vec2(\n\t\taAlphaTextureCoordinates * 0.001953125,\n\t\tmod(aAlphaTextureCoordinates * 0.5, 256.0)\n\t)) * 0.0078125;\n}":
...
a.FragmentShaderSource="#version 100\nprecision lowp float;\nvarying float vAlpha;\nvarying vec2 vTextureCoordinates;\nuniform sampler2D uTexture;\nvoid main() {\n\tgl_FragColor = texture2D(uTexture, vTextureCoordinates) * vAlpha;\n}";return a}(),UISpriteSheet=function(){function a(){}a.resize=function(b){var c=parseInt(b.getAttribute(a.SheetId)),e=c&255,d=c>>>8&255,f=c>>>16&255,g=c>>>24&255;b.style.backgroundSize=a.BackgroundSizeCss;1===e?(b.style.width=iconSizeCss,b.style.height=iconSizeCss,b.style.backgroundPositionX=
css(-((f<<4)+2)),b.style.backgroundPositionY=css(-((g<<4)+2))):(b.style.width=css(c===a.ScrollThumb?24:e<<4),b.style.height=css(d<<4),b.style.backgroundPositionX=css(c===a.ScrollThumb?-72:-(f<<4)),b.style.backgroundPositionY=css(-(g<<4)))};a.change=function(b,c){b.setAttribute(a.SheetId,c.toString());a.resize(b)};a.create=function(b,c){var e=document.createElement("span");e.style.backgroundImage="url(assets/images/uiSheet.png)";a.change(e,b);c&&c.appendChild(e);return e};a.html=function(b){return"<span "+
a.SheetId+'="'+b+'"></span>'};a.finishHTMLCreation=function(b){b.style.backgroundImage="url(assets/images/uiSheet.png)";a.change(b,parseInt(b.getAttribute(a.SheetId)))};a.windowResized=function(){a.BackgroundSizeCss=css(a.TextureWidth)+" "+css(a.TextureHeight)};a.TextureWidth=96;a.TextureHeight=112;a.BackgroundSizeCss=null;a.SheetId="data-sheet-id";a.Ball=257;a.Goal=65793;a.Bomb=131329;a.Cucumber=196865;a.Edit=262401;a.Question=327937;a.DeviceH=16777473;a.DeviceV=16843009;a.Hand=16908545;a.Fullscreen=
16974081;a.Restart=17039617;a.Open=17105153;a.Accept=33554689;a.AcceptGreen=33620225;a.Clear=33685761;a.ClearRed=33751297;a.Back=33816833;a.Border=33882369;a.LineWidth0=50331905;a.LineWidth1=50397441;a.LineWidth2=50462977;a.LineWidth3=50528513;a.ScrollThumb=50594562;a.Eraser=67109121;a.Rainbow=67174657;a.Pause=67240193;a.Play=67305729;a.PlayGreen=83886337;a.Exit=83951873;a.Menu=84017409;a.Download=84082945;a.Success=100663553;a.Error=100729089;a.Trophy=100794625;a.Clock=100860161;a.DeviceHI=100925697;
a.DeviceVI=100991233;return a}(),LevelObject=function(){function a(b,c,e){switch(b){case a.TypeBall:case a.TypeGoal:case a.TypeBomb:case a.TypeCucumber:break;default:throw Error("Invalid level object type: "+b);}this.type=parseInt(b);this.radius=a.RadiusByType[this.type];this.move(parseInt(c)||0,parseInt(e)||0)}a.prototype.move=function(b,c){this.x=b<=iconRadius?iconRadius:b>baseWidth-iconRadius?baseWidth-iconRadius:b;this.y=c<=iconRadius?iconRadius:c>maxHeight-iconRadius?maxHeight-iconRadius:c};
a.revive=function(b){return new a(b.type,b.x,b.y)};a.TypeBall=0;a.TypeGoal=1;a.TypeBomb=2;a.TypeCucumber=3;a.TypeCount=4;a.VisibilityNone=0;a.VisibilityVisible=1;a.VisibilityAlive=2;a.VisibilityAll=a.VisibilityVisible|a.VisibilityAlive;a.FragmentsPerBall=64;a.FragmentsMaxTime=1.5;a.FragmentsMaxTimeSaved=3.5;a.VictoryFragmentCount=500;a.LastType=a.TypeCucumber;a.RadiusByType=[6,5,5,6];a.ImagesByType=[UISpriteSheet.Ball,UISpriteSheet.Goal,UISpriteSheet.Bomb,UISpriteSheet.Cucumber];return a}(),Level=
function(){function a(){this.name="";this.modifiedAt=this.createdAt=0;this.width=baseWidth;this.height=maxHeight;this.processedImage=this.image=this.thumbnailImage="";this.polygons=[];this.objects=[];this.levelPtr=0}a.prototype.toJSON=function(){return this.toLevelFullInfo()};a.prototype.toLevelFullInfo=function(){return{name:this.name,createdAt:this.createdAt,modifiedAt:this.modifiedAt,width:this.width,height:this.height,thumbnailImage:this.thumbnailImage,image:this.image,processedImage:this.processedImage,
polygons:this.polygons,objects:this.objects}};a.prototype.toLevelInfo=function(){return{name:this.name,createdAt:this.createdAt,modifiedAt:this.modifiedAt,width:this.width,height:this.height,thumbnailImage:this.thumbnailImage}};a.revive=function(b){var c=new a;if(b&&("string"===typeof b&&(b=JSON.parse(b)),b))for(var e in c)"function"!==typeof c[e]&&(c[e]=b[e]);c.levelPtr=0;c.name=(c.name||"").trim();if(!c.createdAt||0>c.createdAt)c.createdAt=0;if(!c.modifiedAt||0>c.modifiedAt)c.modifiedAt=0;c.width=
baseWidth;c.height=!c.height||c.height<=iconSize||c.height>maxHeight?maxHeight:parseInt(c.height.toString());c.image||(c.image="");c.processedImage?c.image||(c.image=c.processedImage):c.processedImage="";c.thumbnailImage||(c.thumbnailImage="");if(c.polygons){if(c.polygons.length>a.MaxPolygonCount)return null;e=0;for(b=c.polygons.length-1;0<=b;b--)if(c.polygons[b]=Polygon.revive(c.polygons[b]),e+=c.polygons[b].points.length,e>a.MaxPointCount)return null}else c.polygons=[];if(c.objects){if(c.objects.length>
a.MaxObjectCount)return null;e=0;for(b=c.objects.length-1;0<=b;b--)if(c.objects[b]=LevelObject.revive(c.objects[b]),c.objects[b].type===LevelObject.TypeBall&&(e++,e>a.MaxBallCount))return null}else c.objects=[];return c};a.prototype.prepare=function(){return __awaiter(this,void 0,void 0,function(){var b,c,e,d,f,g,h,l,k,m;return __generator(this,function(p){switch(p.label){case 0:return!this.image||this.processedImage&&this.thumbnailImage?[3,2]:[4,loadImage(this.image)];case 1:b=p.sent();c=document.createElement("canvas");
c.width=thumbnailWidth;c.height=thumbnailHeight;e=c.getContext("2d",{alpha:!0});e.clearRect(0,0,c.width,c.height);e.drawImage(b,0,0,b.width>>2,b.height>>2);removeSemiAlpha(c,e);this.thumbnailImage=c.toDataURL("image/png");c.width=baseWidth;c.height=maxHeight<=b.height?maxHeight:b.height;e.clearRect(0,0,c.width,c.height);e.drawImage(b,0,0);this.width=baseWidth;m=processImage(c,e,!1);this.polygons=m[0];this.height=m[1];this.height<iconSize?this.height=iconSize:(this.height++,this.height>maxHeight&&
(this.height=maxHeight));if(this.polygons.length>a.MaxPolygonCount)throw Error(a.MaxPolygonCountMessage);d=0;for(f=this.polygons.length-1;0<=f;f--)d+=this.polygons[f].points.length;if(d>a.MaxPointCount)throw Error(a.MaxPointCountMessage);g=this.height;for(f=this.objects.length-1;0<=f;f--)h=this.objects[f].y+iconRadius,this.height<h&&(this.height=h);this.height>maxHeight&&(this.height=maxHeight);l=c;k=e;g!==c.height&&(l=document.createElement("canvas"),l.width=baseWidth,l.height=g,k=l.getContext("2d",
{alpha:!0}),k.clearRect(0,0,l.width,l.height),k.drawImage(b,0,0),this.image=l.toDataURL("image/png"),k.clearRect(0,0,l.width,l.height),k.drawImage(c,0,0));this.processedImage=l.toDataURL("image/png");p.label=2;case 2:return[2]}})})};a.prototype.viewResized=function(){this.levelPtr&&cLib._viewResized(this.levelPtr,baseWidth,baseHeight)};a.prototype.createLevelPtr=function(b){this.destroyLevelPtr();for(var c=this.polygons,e=this.objects,d=4,f=c.length-1;0<=f;f--){var g=c[f].points.length;d+=2===g?1:
g}g=this.objects.length;var h=cLib.stackSave();f=cLib.HEAP8.buffer;var l=d<<3,k=g<<2,m=g<<3,p=cLib.stackAlloc(l),n=cLib.stackAlloc(l),q=cLib.stackAlloc(l);l=cLib.stackAlloc(l);k=cLib.stackAlloc(k);var u=cLib.stackAlloc(m),v=cLib.stackAlloc(m);m=cLib.stackAlloc(m);var w=new Float32Array(f,p,d),x=new Float32Array(f,n,d),y=new Float32Array(f,q,d),z=new Float32Array(f,l,d),C=new Int32Array(f,k,g),D=new Float32Array(f,u,g),E=new Float32Array(f,v,g),F=new Float32Array(f,m,g);w[0]=-1;x[0]=-1;y[0]=this.width;
z[0]=-1;w[1]=this.width;x[1]=-1;y[1]=this.width;z[1]=this.height;w[2]=this.width;x[2]=this.height;y[2]=-1;z[2]=this.height;w[3]=-1;x[3]=this.height;y[3]=-1;z[3]=-1;f=0;for(var r=4;f<c.length;f++){for(var t=c[f].points,B=t.length-1,A=0;A<B;A++)w[r]=t[A].x,x[r]=t[A].y,y[r]=t[A+1].x,z[r]=t[A+1].y,r++;1<B&&(w[r]=t[B].x,x[r]=t[B].y,y[r]=t[0].x,z[r]=t[0].y,r++)}for(f=0;f<g;f++)c=e[f],C[f]=c.type,D[f]=c.x,E[f]=c.y,F[f]=c.radius;this.levelPtr=cLib._init(this.height,baseWidth,baseHeight,d,p,n,q,l,g,k,u,v,
m,b);cLib.stackRestore(h)};a.prototype.destroyLevelPtr=function(){this.levelPtr&&(cLib._destroy(this.levelPtr),this.levelPtr=0)};a.prototype.clearImage=function(){this.width=baseWidth;this.height=maxHeight;this.thumbnailImage=this.processedImage=this.image=""};a.prototype.clearObjects=function(){this.polygons=[];this.objects=[]};a.prototype.restart=function(b){this.createLevelPtr(b)};a.prototype.step=function(b){this.levelPtr&&cLib._step(this.levelPtr,ControlMode.accelerationX,ControlMode.accelerationY,
ControlMode.mode,b)};a.MaxPolygonCountMessage="Level.MaxPolygonCount";a.MaxPointCountMessage="Level.MaxPointCount";a.MaxPolygonCount=5E3;a.MaxPointCount=2E4;a.MaxObjectCount=256;a.MaxBallCount=40;return a}(),LevelCache=function(){function a(){}a.isSupported=function(){try{return"caches"in window&&"open"in caches}catch(b){}return!1};a.loadBuiltInLevels=function(){return new Promise(function(b,c){a.BuiltInLevelIds?b():a.BuiltInLevelsLoadFinished=b})};a.builtInLevelThumbnailPath=function(b){if(0>b||
b>=a.BuiltInLevelThumbnails.length)throw Error("Invalid id");return a.BuiltInLevelThumbnails[b]};a.loadBuiltInLevel=function(b){if(0>b||b>=a.BuiltInLevels.length)throw Error("Invalid id");try{return Level.revive(a.BuiltInLevels[b])}catch(c){return null}};a.isNameValid=function(b){b=(b||"").trim();return!!b&&!b.endsWith(a.LevelInfoExtension)&&!/^\.+$/.test(b)&&!/[\\\/\?\*:<>%]/.test(b)&&!/^\d+$/.test(b)};a.getLevelNames=function(b){void 0===b&&(b=!0);return __awaiter(this,void 0,void 0,function(){var c,
e,d,f,g,h,l,k;return __generator(this,function(m){switch(m.label){case 0:b&&(View.loading=!0),m.label=1;case 1:return m.trys.push([1,4,5,6]),[4,caches.open(a.CacheName)];case 2:return c=m.sent(),[4,c.keys()];case 3:e=m.sent();if(!e||!e.length)return[2,[]];d=Array(e.length>>1);f=a.LevelInfoExtension;g=e.length-1;for(h=0;0<=g;g--)l=e[g].url,l.endsWith(f)||(k=l.lastIndexOf("/"),d[h++]=decodeURIComponent(0>k?l:l.substr(k+1)));d.sort();return[2,d];case 4:return m.sent(),[2,[]];case 5:return b&&(View.loading=
!1),[7];case 6:return[2]}})})};a.loadLevelInfo=function(b,c){void 0===c&&(c=!0);return __awaiter(this,void 0,void 0,function(){var e,d,f;return __generator(this,function(g){switch(g.label){case 0:if(!a.isNameValid(b))throw Error("Invalid name");c&&(View.loading=!0);g.label=1;case 1:return g.trys.push([1,5,6,7]),[4,caches.open(a.CacheName)];case 2:return e=g.sent(),[4,e.match(encodeURIComponent(b+a.LevelInfoExtension))];case 3:return(d=g.sent())?[4,d.text()]:[2,null];case 4:f=g.sent();if(!f)return[2,
null];try{return[2,JSON.parse(f)]}catch(h){return[2,null]}case 5:return g.sent(),[2,null];case 6:return c&&(View.loading=!1),[7];case 7:return[2]}})})};a.saveLevel=function(b,c){void 0===c&&(c=!0);return __awaiter(this,void 0,void 0,function(){var e,d;return __generator(this,function(f){switch(f.label){case 0:if(!b||!a.isNameValid(b.name))throw Error("Invalid level");c&&(View.loading=!0);e=b.thumbnailImage;f.label=1;case 1:return f.trys.push([1,,5,6]),[4,caches.open(a.CacheName)];case 2:return d=
f.sent(),[4,d.put(encodeURIComponent(b.name+a.LevelInfoExtension),new Response(new Blob([JSON.stringify(b.toLevelInfo())],{type:"application/json"})))];case 3:return f.sent(),b.thumbnailImage=null,[4,d.put(encodeURIComponent(b.name),new Response(new Blob([JSON.stringify(b)],{type:"application/json"})))];case 4:return f.sent(),[3,6];case 5:return b.thumbnailImage=e,c&&(View.loading=!1),[7];case 6:return[2]}})})};a.loadLevel=function(b,c){void 0===c&&(c=!0);return __awaiter(this,void 0,void 0,function(){var e,
d,f;return __generator(this,function(g){switch(g.label){case 0:if(!a.isNameValid(b))throw Error("Invalid name");c&&(View.loading=!0);g.label=1;case 1:return g.trys.push([1,,5,6]),[4,caches.open(a.CacheName)];case 2:return e=g.sent(),[4,e.match(encodeURIComponent(b))];case 3:return(d=g.sent())?[4,d.text()]:[2,null];case 4:f=g.sent();if(!f)return[2,null];try{return[2,Level.revive(f)]}catch(h){return[2,null]}case 5:return c&&(View.loading=!1),[7];case 6:return[2]}})})};a.deleteLevel=function(b,c){void 0===
c&&(c=!0);return __awaiter(this,void 0,void 0,function(){var e;return __generator(this,function(d){switch(d.label){case 0:if(!a.isNameValid(b))throw Error("Invalid name");c&&(View.loading=!0);d.label=1;case 1:return d.trys.push([1,,5,6]),[4,caches.open(a.CacheName)];case 2:return e=d.sent(),[4,e.delete(encodeURIComponent(b))];case 3:return d.sent(),[4,e.delete(encodeURIComponent(b+a.LevelInfoExtension))];case 4:return d.sent(),a.deleteLevelRecord(b),[3,6];case 5:return c&&(View.loading=!1),[7];case 6:return[2]}})})};
a.downloadLevel=function(b,c,e){void 0===c&&(c=-1);void 0===e&&(e=!0);return __awaiter(this,void 0,void 0,function(){var d,f,g,h,l;return __generator(this,function(k){switch(k.label){case 0:if(!a.isNameValid(b))throw Error("Invalid name");if(!BlobDownloader.supported)return[2,a.DownloadLevelError];e&&(View.loading=!0);k.label=1;case 1:k.trys.push([1,7,8,9]);f=d=void 0;if(!(0<=c&&c<a.BuiltInLevels.length))return[3,2];d=a.BuiltInLevels[c];f=d.indexOf('"name":"')+8;d=d.substr(0,f)+b+d.substr(d.indexOf('"',
f));return[3,6];case 2:return[4,caches.open(a.CacheName)];case 3:return g=k.sent(),[4,g.match(encodeURIComponent(b))];case 4:return(h=k.sent())?[4,h.text()]:[2,a.DownloadLevelError];case 5:d=k.sent();if(!d)return[2,a.DownloadLevelError];k.label=6;case 6:return b+=".json",f=d.indexOf('"processedImage":'),0<=f&&(f+=17,'"'===d.charAt(f)&&(l=d.indexOf('"',f+1),l>f&&(d=d.substr(0,f)+"null"+d.substr(l+1)))),f=d.indexOf('"thumbnailImage":'),0<=f&&(f+=17,'"'===d.charAt(f)&&(l=d.indexOf('"',f+1),l>f&&(d=d.substr(0,
f)+"null"+d.substr(l+1)))),f=d.indexOf('"polygons":'),0<=f&&(f+=11,"["===d.charAt(f)&&(l=d.indexOf("],",f+1),l>f?d=d.substr(0,f)+"null"+d.substr(l+1):(l=d.indexOf("}]}]}",f+1),l>f&&(d=d.substr(0,f)+"null"+d.substr(l+4))))),[2,androidWrapper?androidWrapper.downloadLevel(b,d,null):BlobDownloader.download(d,b,"application/json")?a.DownloadLevelSuccess:a.DownloadLevelError];case 7:return k.sent(),[2,a.DownloadLevelError];case 8:return e&&(View.loading=!1),[7];case 9:return[2]}})})};a.downloadLevelImage=
function(b,c,e){void 0===e&&(e=!0);return __awaiter(this,void 0,void 0,function(){var d,f;return __generator(this,function(g){a.isNameValid(b)||(b=Strings.Level);if(!BlobDownloader.supported)return[2,a.DownloadLevelError];e&&(View.loading=!0);try{return b+=".png",androidWrapper?(d=c.toDataURL("image/png"),f=d.indexOf("data:image/png;base64,"),0<=f&&(d=d.substr(f+22)),[2,androidWrapper.downloadLevel(b,null,d)]):[2,new Promise(function(h,l){var k;c.toBlob?c.toBlob(function(m){h(m&&BlobDownloader.download(m,
b,"image/png")?a.DownloadLevelSuccess:a.DownloadLevelError)},"image/png"):c.msToBlob&&(k=c.msToBlob())?h(BlobDownloader.download(k,b,"image/png")?a.DownloadLevelSuccess:a.DownloadLevelError):h(a.DownloadLevelError)})]}catch(h){return[2,a.DownloadLevelError]}finally{e&&(View.loading=!1)}return[2]})})};a.renameLevel=function(b,c,e){void 0===e&&(e=!0);return __awaiter(this,void 0,void 0,function(){var d,f;return __generator(this,function(g){switch(g.label){case 0:if(!a.isNameValid(b)||!a.isNameValid(c))throw Error("Invalid name");
e&&(View.loading=!0);g.label=1;case 1:return g.trys.push([1,,6,7]),[4,a.loadLevel(b,!1)];case 2:return d=g.sent(),[4,a.loadLevelInfo(b,!1)];case 3:f=g.sent();if(!d||!f)return[2,!1];d.name=c;d.thumbnailImage=f.thumbnailImage;return[4,a.saveLevel(d,!1)];case 4:return g.sent(),[4,a.deleteLevel(b,!1)];case 5:return g.sent(),[2,!0];case 6:return e&&(View.loading=!1),[7];case 7:return[2]}})})};a.sendLevelToEditor=function(b,c,e){void 0===c&&(c=null);void 0===e&&(e=!0);return __awaiter(this,void 0,void 0,
function(){var d,f,g;return __generator(this,function(h){switch(h.label){case 0:if(!b&&!c||b&&c||b&&!a.isNameValid(b))throw Error("Invalid level");e&&(View.loading=!0);h.label=1;case 1:return h.trys.push([1,,7,8]),d=null,b?[4,caches.open(a.CacheName)]:[3,5];case 2:return f=h.sent(),[4,f.match(encodeURIComponent(b))];case 3:return(g=h.sent())?[4,g.text()]:[2,!1];case 4:return d=h.sent(),[3,6];case 5:d=JSON.stringify(c),h.label=6;case 6:if(!d)return[2,!1];localStorage.setItem(a.EditorLevelName,d);return[2,
...
b.level)?[3,5]:b.levelName?[4,a.loadLevel(b.levelName,!1)]:[3,3];case 2:return d=f.sent(),[3,4];case 3:d=a.loadBuiltInLevel(b.levelId),f.label=4;case 4:e=d,f.label=5;case 5:c=e,f.label=6;case 6:return[2,c]}})})};a.getLevelRecord=function(b){if(!a.LevelRecords){try{var c=localStorage.getItem(a.LevelRecordsName);c&&(a.LevelRecords=JSON.parse(c))}catch(d){}if(a.LevelRecords)for(var e in a.LevelRecords){if(c=a.LevelRecords[e])if(0<=c.fmt.indexOf(Strings.OppositeDecimalSeparator))c.fmt=c.fmt.replace(Strings.OppositeDecimalSeparator,
Strings.DecimalSeparator);else break}else a.LevelRecords={};a.LastRecordName=localStorage.getItem(a.LastRecordNameName)}return a.LevelRecords[b]||null};a.setLevelRecord=function(b,c,e){var d=a.getLevelRecord(b);e=e?e.trim():"";d?(d.time=c,d.name=e||"-",d.fmt=a.formatLevelRecordTime(c)):a.LevelRecords[b]={time:c,name:e||"-",fmt:a.formatLevelRecordTime(c)};localStorage.setItem(a.LevelRecordsName,JSON.stringify(a.LevelRecords));a.LastRecordName!==e&&localStorage.setItem(a.LastRecordNameName,a.LastRecordName=
e)};a.deleteLevelRecord=function(b){a.getLevelRecord(b)&&(delete a.LevelRecords[b],localStorage.setItem(a.LevelRecordsName,JSON.stringify(a.LevelRecords)))};a.clearLastRecordName=function(){a.LastRecordName&&localStorage.setItem(a.LastRecordNameName,a.LastRecordName="")};a.formatLevelRecordTime=function(b){if(!b||0>b)return"-";b=b/10|0;99999<b&&(b=99999);return(b/100|0)+Strings.DecimalSeparator+format2(b%100)+" s"};a.DownloadLevelSuccess=1;a.DownloadLevelError=0;a.DownloadLevelNoPermission=-1;a.DownloadLevelFileAlreadyExists=
-2;a.BuiltInLevelIds=null;a.BuiltInLevels=null;a.BuiltInLevelThumbnails=null;a.BuiltInLevelsLoadFinished=null;a.LevelInfoExtension=".levelinfo";a.CacheName="pixel-level-cache";a.EditorLevelName="pixel-editor-level";a.LastRecordNameName="pixel-editor-last-name";a.LevelRecordsName="pixel-editor-level-records";a.LevelRecords=null;a.LastRecordName=null;return a}(),LevelSpriteSheet=function(){function a(){}a.allocateCoordinates=function(){var b=cLib._initLevelSpriteSheet();a.LevelSpriteSheetPtr=b;a.LevelModelCoordinates=
new ModelCoordinates(b);b+=16;a.FullTextureCoordinates=new TextureCoordinates(b);b+=16;a.FramebufferTextureCoordinates=new TextureCoordinates(b);b+=16;for(var c=0;c<a.BackgroundModelCoordinates.length;c++)a.BackgroundModelCoordinates[c]=new ModelCoordinates(b),b+=16;for(c=0;c<a.BackgroundTextureCoordinates.length;c++)a.BackgroundTextureCoordinates[c]=new TextureCoordinates(b),b+=16;a.LevelObjectModelCoordinates=new ModelCoordinates(b);b+=16;for(c=0;c<a.LevelObjectTextureCoordinatesByType.length;c++)a.LevelObjectTextureCoordinatesByType[c]=
...
new TextureCoordinates(b),b+=16;a.CursorCenterModelCoordinates=new ModelCoordinates(b);b+=16;a.CursorCenterTextureCoordinates=new TextureCoordinates(b);b+=16;a.CursorTargetModelCoordinates=new ModelCoordinates(b);b+=16;a.CursorTargetTextureCoordinates=new TextureCoordinates(b);b+=16;a.FaceModelCoordinates=new ModelCoordinates(b);b+=16;a.SadFaceTextureCoordinates=new TextureCoordinates(b);b+=16;a.HappyFaceTextureCoordinates=new TextureCoordinates(b);a.ClearBackgroundTextureCoordinates=new TextureCoordinates(b+
16)};a.setupFixedCoordinates=function(){a.FullTextureCoordinates.setCoordinates(0,0,a.TextureWidth,a.TextureHeight);var b=a.BackgroundScale,c=a.BackgroundScaleRightShift,e=baseWidth<<1>>c,d=Math.ceil(Math.sqrt(2)*(baseWidth>>c));a.BackgroundModelCoordinates[0].setCoordinates(e>>c,-.4*b*baseWidth,e,d);a.BackgroundModelCoordinates[1].setCoordinates(e>>c,-.38*b*baseWidth,e,d);a.BackgroundModelCoordinates[2].setCoordinates(e>>c,-.36*b*baseWidth,e,d);a.BackgroundModelCoordinates[3].setCoordinates(e>>c,
-.34*b*baseWidth,e,d);a.BackgroundModelCoordinates[4].setCoordinates(e>>c,-.32*b*baseWidth,e,d);a.BackgroundModelCoordinates[5].setCoordinates(e>>c,-.3*b*baseWidth,e,d);a.BackgroundModelCoordinates[6].setCoordinates(e>>c,-.28*b*baseWidth,e,d);a.BackgroundModelCoordinates[7].setCoordinates(e>>c,-.26*b*baseWidth,e,d);a.BackgroundModelCoordinates[8].setCoordinates(e>>c,-.24*b*baseWidth,e,d);a.BackgroundModelCoordinates[9].setCoordinates(e>>c,-.2*b*baseWidth,e,d);a.BackgroundModelCoordinates[10].setCoordinates(e>>
c,-.16*b*baseWidth,e,d);a.BackgroundModelCoordinates[11].setCoordinates(e>>c,-.12*b*baseWidth,e,d);a.BackgroundModelCoordinates[12].setCoordinates(e>>c,-.08*b*baseWidth,e,d);a.BackgroundModelCoordinates[13].setCoordinates(e>>c,-.04*b*baseWidth,e,d);a.BackgroundModelCoordinates[14].setCoordinates(e>>c,-0*b*baseWidth,e,d);a.BackgroundTextureCoordinates[0].setCoordinates(3,53,2,72);a.BackgroundTextureCoordinates[1].setCoordinates(9,53,2,72);a.BackgroundTextureCoordinates[2].setCoordinates(15,53,2,72);
a.BackgroundTextureCoordinates[3].setCoordinates(21,53,2,72);a.BackgroundTextureCoordinates[4].setCoordinates(27,53,2,72);a.BackgroundTextureCoordinates[5].setCoordinates(33,53,2,72);a.BackgroundTextureCoordinates[6].setCoordinates(39,53,2,72);a.BackgroundTextureCoordinates[7].setCoordinates(45,53,2,72);a.LevelObjectTextureCoordinatesByType[LevelObject.TypeBall].setCoordinates(2,2,iconSize,iconSize);a.LevelObjectTextureCoordinatesByType[LevelObject.TypeGoal].setCoordinates(18,2,iconSize,iconSize);
a.LevelObjectTextureCoordinatesByType[LevelObject.TypeBomb].setCoordinates(34,2,iconSize,iconSize);a.LevelObjectTextureCoordinatesByType[LevelObject.TypeCucumber].setCoordinates(50,2,iconSize,iconSize);a.ExplosionBgTextureCoordinates.setCoordinates(36,20,8,8);a.FadeBgTextureCoordinates.setCoordinates(52,20,8,8);a.FadeBgSadTextureCoordinates.setCoordinates(52,36,8,8);a.FragmentTextureCoordinates[0].setCoordinates(2,17,3,3);a.FragmentTextureCoordinates[1].setCoordinates(7,17,3,3);a.FragmentTextureCoordinates[2].setCoordinates(12,
17,3,4);a.FragmentTextureCoordinates[3].setCoordinates(2,22,3,3);a.FragmentTextureCoordinates[4].setCoordinates(7,22,3,4);a.FragmentTextureCoordinates[5].setCoordinates(12,23,3,4);a.FragmentTextureCoordinates[6].setCoordinates(2,27,3,4);a.FragmentTextureCoordinates[7].setCoordinates(7,28,3,3);a.FragmentTextureCoordinates[8].setCoordinates(18,17,3,3);a.FragmentTextureCoordinates[9].setCoordinates(23,17,3,3);a.FragmentTextureCoordinates[10].setCoordinates(28,17,3,4);a.FragmentTextureCoordinates[11].setCoordinates(18,
22,3,3);a.FragmentTextureCoordinates[12].setCoordinates(23,22,3,4);a.FragmentTextureCoordinates[13].setCoordinates(28,23,3,4);a.FragmentTextureCoordinates[14].setCoordinates(18,27,3,4);a.FragmentTextureCoordinates[15].setCoordinates(23,28,3,3);a.CursorCenterTextureCoordinates.setCoordinates(66,2,a.CursorCenterSize,a.CursorCenterSize);a.CursorTargetTextureCoordinates.setCoordinates(98,2,a.CursorTargetSize,a.CursorTargetSize);a.SadFaceTextureCoordinates.setCoordinates(96,32,31,31);a.HappyFaceTextureCoordinates.setCoordinates(96,
80,31,31);a.ClearBackgroundTextureCoordinates.setCoordinates(105,8,8,8)};a.recreateIfNecessary=function(){var b=scaleFactor,c=baseWidth*b,e=baseHeight*b;a.scaleFactor===scaleFactor&&a.LevelModelCoordinates?a.FullViewModelCoordinates.setCoordinates(0,0,c,e):(a.scaleFactor=scaleFactor,a.LevelModelCoordinates||(a.allocateCoordinates(),a.setupFixedCoordinates()),a.LevelObjectModelCoordinates.setCoordinates(iconRadius*b,iconRadius*b,iconSize*b,iconSize*b),a.FullViewModelCoordinates.setCoordinates(0,0,
...
b,1*b,3*b,3*b),a.CursorCenterModelCoordinates.setCoordinates(.5*a.CursorCenterSize*b|0,.5*a.CursorCenterSize*b|0,a.CursorCenterSize*b,a.CursorCenterSize*b),a.CursorTargetModelCoordinates.setCoordinates(.5*a.CursorTargetSize*b|0,.5*a.CursorTargetSize*b|0,a.CursorTargetSize*b,a.CursorTargetSize*b),a.FaceModelCoordinates.setCoordinates(15*b,15*b,31*b,31*b))};a.preload=function(){return __awaiter(this,void 0,void 0,function(){var b;return __generator(this,function(c){switch(c.label){case 0:if(a.image)return[3,
2];b=a;return[4,loadImage("assets/images/sheet.png")];case 1:b.image=c.sent(),c.label=2;case 2:return[2]}})})};a.createTexture=function(b){return new Texture(b,a.image)};a.TextureWidth=128;a.TextureHeight=128;a.CursorCenterSize=25;a.CursorTargetSize=25;a.LevelSpriteSheetPtr=0;a.BackgroundCount=15;a.BackgroundScale=.5;a.BackgroundScaleRightShift=1;a.LevelModelCoordinates=null;a.FullTextureCoordinates=null;a.FramebufferTextureCoordinates=null;a.BackgroundModelCoordinates=Array(a.BackgroundCount);a.BackgroundTextureCoordinates=
Array(8);a.LevelObjectModelCoordinates=null;a.LevelObjectTextureCoordinatesByType=Array(LevelObject.TypeCount);a.FullViewModelCoordinates=null;a.ExplosionBgTextureCoordinates=null;a.FadeBgModelCoordinates=null;a.FadeBgTextureCoordinates=null;a.FadeBgSadTextureCoordinates=null;a.FragmentModelCoordinates=Array(8);a.FragmentTextureCoordinates=Array(16);a.CursorCenterModelCoordinates=null;a.CursorCenterTextureCoordinates=null;a.CursorTargetModelCoordinates=null;a.CursorTargetTextureCoordinates=null;a.FaceModelCoordinates=
null;a.SadFaceTextureCoordinates=null;a.HappyFaceTextureCoordinates=null;a.ClearBackgroundTextureCoordinates=null;a.image=null;a.scaleFactor=0;return a}(),ControlMode=function(){function a(){}Object.defineProperty(a,"mode",{get:function(){return a._mode},enumerable:!1,configurable:!0});Object.defineProperty(a,"accelerationSupported",{get:function(){return a._accelerationSupported},enumerable:!1,configurable:!0});Object.defineProperty(a,"modeImage",{get:function(){return a.ImagesByMode[a._mode]},enumerable:!1,
configurable:!0});a.toggleMode=function(){var b=a._mode+1;if(b>a.AccelerometerVI||!a._accelerationSupported)b=a.Pointer;a._mode=b;localStorage.setItem(a.ControlModeName,b.toString());a.prepare()};a.init=function(){a._accelerationSupported=androidWrapper&&androidWrapper.isSupported()||"DeviceMotionEvent"in window;if(a._accelerationSupported){var b=parseInt(localStorage.getItem(a.ControlModeName));a._mode=isNaN(b)||b<a.Pointer||b>a.AccelerometerVI?a.Pointer:b}else a._mode=a.Pointer;a.prepare()};a.prepare=
function(){window.removeEventListener("devicemotion",a.deviceMotion);a.invertXY=a._mode===a.AccelerometerV||a._mode===a.AccelerometerVI;a.invertSign=a._mode===a.AccelerometerHI||a._mode===a.AccelerometerVI;a._mode!==a.Pointer&&window.addEventListener("devicemotion",a.deviceMotion)};a.processAndroidAcceleration=function(){if(a.skipAndroid)a.skipAndroid=!1;else{a.skipAndroid=!0;if(a.invertXY){var b=androidWrapper.getY();var c=androidWrapper.getX()}else b=-androidWrapper.getX(),c=androidWrapper.getY();
a.invertSign&&(b=-b,c=-c);-.3<b&&.3>b&&(b=0);-.3<c&&.3>c&&(c=0);a.accelerationX=.8*a.accelerationX+.2*b;a.accelerationY=.8*a.accelerationY+.2*c}};a.deviceMotion=function(b){var c=b.accelerationIncludingGravity;a.invertXY?(b=c.y,c=c.x):(b=-c.x,c=c.y);a.invertSign&&(b=-b,c=-c);-.3<b&&.3>b&&(b=0);-.3<c&&.3>c&&(c=0);a.accelerationX=.8*a.accelerationX+.2*b;a.accelerationY=.8*a.accelerationY+.2*c};a.ControlModeName="pixel-control-mode";a.ImagesByMode=[UISpriteSheet.Hand,UISpriteSheet.DeviceH,UISpriteSheet.DeviceV,
UISpriteSheet.DeviceHI,UISpriteSheet.DeviceVI];a.Pointer=0;a.AccelerometerH=1;a.AccelerometerV=2;a.AccelerometerHI=3;a.AccelerometerVI=4;a._mode=a.Pointer;a._accelerationSupported=!1;a.skipAndroid=!1;a.invertXY=!1;a.invertSign=!1;a.accelerationX=0;a.accelerationY=0;return a}(),FullscreenControl=function(){function a(){}a.requestFullscreen=function(b){b||(b=document.body);var c=!0,e=null;try{b.requestFullscreen?e=b.requestFullscreen():b.webkitRequestFullscreen?e=b.webkitRequestFullscreen():b.mozRequestFullScreen?
e=b.mozRequestFullScreen():b.msRequestFullscreen?e=b.msRequestFullscreen():c=!1}catch(d){c=!1}c||b===document.body?ignorePromise(e):a.requestFullscreen(null)};a.exitFullscreen=function(){var b=null;try{document.exitFullscreen?b=document.exitFullscreen():document.webkitExitFullscreen?b=document.webkitExitFullscreen():document.mozExitFullScreen?b=document.mozExitFullScreen():document.msExitFullscreen&&(b=document.msExitFullscreen())}catch(c){}ignorePromise(b)};Object.defineProperty(a,"fullscreenElement",
{get:function(){var b=null;try{"fullscreenElement"in document&&(b=document.fullscreenElement),!b&&"webkitFullscreenElement"in document&&(b=document.webkitFullscreenElement),!b&&"mozFullscreenElement"in document&&(b=document.mozFullscreenElement),!b&&"msFullscreenElement"in document&&(b=document.msFullscreenElement)}catch(c){}return b},enumerable:!1,configurable:!0});Object.defineProperty(a.prototype,"onfullscreenchange",{get:function(){try{if("onfullscreenchange"in document)return document.onfullscreenchange;
if("onwebkitfullscreenchange"in document)return document.onwebkitfullscreenchange;if("onmozfullscreenchange"in document)return document.onmozfullscreenchange;if("onmsfullscreenchange"in document)return document.onmsfullscreenchange}catch(b){}return null},enumerable:!1,configurable:!0});Object.defineProperty(a,"onfullscreenchange",{set:function(b){try{"onfullscreenchange"in document&&(document.onfullscreenchange=b),"onwebkitfullscreenchange"in document&&(document.onwebkitfullscreenchange=b),"onmozfullscreenchange"in
document&&(document.onmozfullscreenchange=b),"onmsfullscreenchange"in document&&(document.onmsfullscreenchange=b)}catch(c){}},enumerable:!1,configurable:!0});a.toggleFullscreen=function(){a.fullscreenMode=!a.fullscreenMode};Object.defineProperty(a,"fullscreenMode",{get:function(){return!!a.fullscreenElement},set:function(b){b?a.requestFullscreen():a.exitFullscreen()},enumerable:!1,configurable:!0});return a}(),PointerHandler=function(){function a(b,c,e,d){void 0===c&&(c=null);void 0===e&&(e=null);
void 0===d&&(d=null);this.documentTarget=document.documentElement||document.body;this.element=b;this.downCallback=c;this.moveCallback=e;this.upCallback=d;this.elementHasExtraTouchStartHandler=!1;"onpointerdown"in b?(this.documentDownEvent="pointerdown",this.documentMoveEvent="pointermove",this.documentUpEvent="pointerup",this.documentCancelEvent="pointercancel",this.boundDocumentDown=this.pointerDown.bind(this),this.boundDocumentUp=this.pointerUp.bind(this),this.boundDocumentMove=this.pointerMove.bind(this),
...
cancelEvent(b)};return a}(),ScrollContainer=function(){function a(b,c,e,d){void 0===c&&(c=!1);void 0===e&&(e=null);void 0===d&&(d=null);d?(this.parent=d.parentNode,this.container=d):(this.parent=b,this.container=document.createElement("div"),b.appendChild(this.container));this.container.className=c?"container":"container scrollable-container";c||(this.parent.style.overflow="hidden");this.scrollContainer=document.createElement("div");this.scrollContainer.className=e?"scroll-container "+e:"scroll-container";
this.container.appendChild(this.scrollContainer);this.scrollThumb=UISpriteSheet.create(UISpriteSheet.ScrollThumb,this.parent);this.scrollThumb.className="scroll-thumb";this.containerPointerHandler=this.pointerHandler=null;this.boundDocumentWheel=this.documentWheel.bind(this);this.scrollThumbInitialTopCss=this.scrollThumbTopCss=this.scrollThumbTopPercent=this.scrollContainerTopCss=this.contentHeight=this.availableHeight=this.containerTopCss=this.pointerLastY=0;this.scrollThumbOnly=c;this.ignoreScroll=
!1;c||(this.container.onscroll=this.containerScroll.bind(this))}Object.defineProperty(a.prototype,"topCss",{get:function(){return this.scrollContainerTopCss},enumerable:!1,configurable:!0});Object.defineProperty(a.prototype,"element",{get:function(){return this.container},enumerable:!1,configurable:!0});Object.defineProperty(a.prototype,"containerElement",{get:function(){return this.scrollContainer},enumerable:!1,configurable:!0});a.prototype.resize=function(b,c){this.containerTopCss=cssNumber(b);
this.availableHeight=c;1>this.availableHeight&&(this.availableHeight=1);this.container.style.top=css(b);this.container.style.height=css(c);UISpriteSheet.resize(this.scrollThumb);b=this.scrollContainer.getBoundingClientRect();this.contentHeight=model(b.bottom-b.top);1>this.contentHeight&&(this.contentHeight=1);b=this.contentHeight<=this.availableHeight?"none":"";this.scrollThumb.style.display!==b&&(this.scrollThumb.style.display=b);this.scrollTo(this.scrollThumbTopPercent)};a.prototype.attach=function(){this.pointerHandler=
new PointerHandler(this.scrollThumb,this.mouseDown.bind(this),this.mouseMove.bind(this));document.addEventListener("wheel",this.boundDocumentWheel,{capture:!0,passive:!1})};a.prototype.detach=function(){this.pointerHandler&&(this.pointerHandler.destroy(),this.pointerHandler=null);document.removeEventListener("wheel",this.boundDocumentWheel,!0)};a.prototype.adjustScrollUI=function(b,c){void 0===c&&(c=-1);this.contentHeight<=this.availableHeight||0>=b?c=b=0:(1<b&&(b=1),0>c&&(c=cssNumber(b*(this.availableHeight-
scrollThumbHeight))));this.scrollThumbTopPercent=b;this.scrollThumbTopCss=c;this.scrollThumb.style.top=this.containerTopCss+c+"px";this.scrollContainerTopCss=this.contentHeight<=this.availableHeight?0:cssNumber(-this.scrollThumbTopPercent*(this.contentHeight-this.availableHeight))};a.prototype.scrollTo=function(b,c){void 0===c&&(c=-1);this.adjustScrollUI(b,c);this.scrollThumbOnly?this.scrollContainer.style.marginTop=this.scrollContainerTopCss+"px":(this.ignoreScroll=!0,this.container.scrollTop=-this.scrollContainerTopCss)};
a.prototype.mouseDown=function(b){var c=this.container.getBoundingClientRect();this.pointerLastY=b.clientY-c.top;this.scrollThumbInitialTopCss=this.scrollThumbTopCss;return!0};a.prototype.mouseMove=function(b){var c=this.container.getBoundingClientRect();b=this.scrollThumbInitialTopCss+(b.clientY-c.top-this.pointerLastY);b=0>b?0:model(b)+scrollThumbHeight>this.availableHeight?cssNumber(this.availableHeight-scrollThumbHeight):(b*pixelRatio|0)/pixelRatio;b!==this.scrollThumbTopCss&&this.scrollTo(model(b)/
(this.availableHeight-scrollThumbHeight),b)};a.prototype.documentWheel=function(b){return Modal.visible?!1:(0>b.deltaY?this.scrollTo(this.scrollThumbTopPercent-.1):0<b.deltaY&&this.scrollTo(this.scrollThumbTopPercent+.1),cancelEvent(b))};a.prototype.containerScroll=function(b){this.ignoreScroll?this.ignoreScroll=!1:(b=this.contentHeight-this.availableHeight,this.adjustScrollUI(0>=b||!this.availableHeight?0:model(this.container.scrollTop)/b))};return a}(),Modal=function(){function a(b){var c=this;
...
"modal-body";"string"===typeof b.html?this.modalBodyElement.innerHTML=b.html:this.modalBodyElement.appendChild(b.html);var e=this.modalBodyElement.getElementsByTagName("button");if(e&&e.length)for(var d=function(l){var k=e[l];prepareButtonBlink(k,!0,function(){if(c.fading)return!1;if(c.options.onbuttonclick)c.options.onbuttonclick(k.id,k);return!0})},f=e.length-1;0<=f;f--)d(f);if((d=this.modalBodyElement.getElementsByTagName("span"))&&d.length)for(f=d.length-1;0<=f;f--){var g=d[f];g.getAttribute(UISpriteSheet.SheetId)&&
UISpriteSheet.finishHTMLCreation(g)}this.modalFooterElement=document.createElement("div");this.modalFooterElement.className="modal-decoration";this.defaultSubmitButton=this.defaultCancelButton=null;d=function(l){var k=b.buttons[l],m=document.createElement("button");k.defaultCancel&&(h.defaultCancelButton=m);k.defaultSubmit&&(h.defaultSubmitButton=m);m.style.height=buttonHeightCss;m.style.borderWidth=borderWidthCss;k.className&&(m.className=k.className);l&&(m.style.float="right");m.setAttribute("type",
...
setTimeout(function(){a.modal=null;View.popHistoryStateIfNecessary();if(b.options.onhidden)b.options.onhidden();View.main.removeChild(b.containerElement);for(var c=b.options.buttons.length-1;0<=c;c--)zeroObject(b.options.buttons[c]);zeroObject(b.options);zeroObject(b);View.resumeGL()},520))};a.prototype.documentKeyDown=function(b){"Escape"!==b.key&&27!==b.keyCode||this.defaultCancelActionInternal()};a.prototype.defaultCancelActionInternal=function(){this.defaultCancelButton&&this.defaultCancelButton.click()};
a.prototype.submit=function(b){cancelEvent(b);this.defaultSubmitButton&&this.defaultSubmitButton.click();return!1};a.prototype.resizeInternal=function(){if(a.modal===this){this.modalElement.style.fontSize=fontSizeCss;this.modalElement.style.maxWidth=css(this.options.large?baseWidth:baseWidth>>1);this.modalElement.style.margin=this.options.large?"0":iconSizeCss+" auto";this.modalHeaderElement.style.padding=buttonPaddingCss;this.modalBodyElement.style.padding=iconSizeCss+" "+buttonPaddingCss;this.modalBodyElement.style.lineHeight=
iconSizeCss;this.modalFooterElement.style.padding=buttonPaddingCss;var b=this.modalElement.querySelectorAll("[data-style]");if(b&&b.length)for(var c=b.length-1;0<=c;c--)for(var e=b[c],d=e.getAttribute("data-style").split(";"),f=0;f<d.length;f++){var g=d[f],h=g.indexOf(":");0<=h&&(e.style[g.substr(0,h)]=css(parseInt(g.substr(h+1))))}if((b=this.modalElement.getElementsByTagName("input"))&&b.length)for(e=css(2),c=b.length-1;0<=c;c--)d=b[c],d.style.borderWidth=borderWidthCss,d.style.padding=e,d.style.marginTop=
e;if((b=this.modalElement.getElementsByTagName("button"))&&b.length)for(c=b.length-1;0<=c;c--)e=b[c],e.style.height=buttonHeightCss,e.style.borderWidth=borderWidthCss,e.style.fontSize=fontSizeCss,e.style.lineHeight=iconSizeCss,e.style.paddingLeft=buttonPaddingCss,e.style.paddingRight=buttonPaddingCss;if((b=this.modalElement.getElementsByTagName("span"))&&b.length)for(c=b.length-1;0<=c;c--)e=b[c],e.getAttribute(UISpriteSheet.SheetId)&&(UISpriteSheet.resize(e),"BUTTON"===e.parentNode.tagName&&(e.style.marginRight=
buttonMarginCss));if(this.options.onresized)this.options.onresized()}};a.modal=null;return a}(),View=function(){function a(){var b=this;this.destroy=function(c){return __awaiter(b,void 0,void 0,function(){var e;return __generator(this,function(d){switch(d.label){case 0:if(!this.initialElements)return[3,3];if(!this.attached)return[3,2];for(e=a.main.childNodes.length-1;3<=e;e--)a.main.removeChild(a.main.childNodes[e]);this.attached=!1;return[4,this.detach()];case 1:d.sent(),d.label=2;case 2:this.destroyInternal(c),
c||zeroObject(this),d.label=3;case 3:return[2]}})})};this.buttons=[];this.buttonsWithMargin=[];this.buttonsWithLargeMargin=[];this.buttonImages=[];this.initialElements=[];this.attached=!1}a.drawBackground=function(b,c,e,d){var f=a.gl;if(!f.checkForLostContext())return a.recreateResourcesTimeout||(a.recreateResourcesTimeout=setTimeout(a.recreateResourcesFromTimeout,1E3)),!1;f.prepareNativeDraw(a.sheetTexture);d?(f.useFramebuffer(!0),cLib._renderBackground(f.verticesPtr,c,LevelSpriteSheet.LevelSpriteSheetPtr,
baseHeight,b,e),f.useFramebuffer(!1),f.draw(f.framebufferTexture,LevelSpriteSheet.FullViewModelCoordinates,1,LevelSpriteSheet.FramebufferTextureCoordinates,0,0),f.flush()):cLib._renderCompactBackground(f.verticesPtr,c,LevelSpriteSheet.LevelSpriteSheetPtr,b);return!0};a.recreateResourcesFromTimeout=function(){a.recreateResourcesTimeout&&(a.recreateResourcesTimeout=0,a.recreateResources())};a.recreateResources=function(){a.recreateResourcesTimeout&&(clearTimeout(a.recreateResourcesTimeout),a.recreateResourcesTimeout=
0);var b=a.currentView;b&&b.usesGL&&b.releaseResources();a.sheetTexture.release();a.backgroundFrameRequest&&(cancelAnimationFrame(a.backgroundFrameRequest),a.backgroundFrameRequest=0);try{a.gl.recreate(a.glCanvas,baseWidth>>LevelSpriteSheet.BackgroundScaleRightShift,baseHeight>>LevelSpriteSheet.BackgroundScaleRightShift),a.sheetTexture.load()}catch(c){throw a.recreateResourcesTimeout=setTimeout(a.recreateResourcesFromTimeout,500),c;}a.refreshGL()};a.renderBackground=function(b){var c=!a.glPaused;
...
a.pauseGL=function(){a.glPaused=!0};a.resumeGL=function(){a.glPaused=!1;a.refreshGL()};a.refreshGL=function(b){b||(b=a.currentView);a.backgroundFrameRequest&&(cancelAnimationFrame(a.backgroundFrameRequest),a.backgroundFrameRequest=0);b&&(b.usesGL?b.loadResources():b.pausedBackground||(a.backgroundFrameRequest=requestAnimationFrame(a.renderBackground)))};a.createInitialView=function(){return a.currentView||a._loading||a._fading||a.viewStack.length?null:(new TitleView).fadeIn()};a.resizeLoading=function(){a.divLoading&&
(a.divLoading.style.backgroundSize=css(43)+" "+css(11),a.divLoading.style.width=css(43+iconSize),a.divLoading.style.height=css(11+iconSize))};a.windowResized=function(b){if(8>baseLeftCss){if(!a.fadeLeft.style.backgroundColor){var c=androidWrapper||isPWA?"#99f":"#000";a.fadeLeft.style.backgroundColor=c;a.fadeRight.style.backgroundColor=c;a.fadeLeft.style.backgroundImage="none";a.fadeRight.style.backgroundImage="none"}}else a.fadeLeft.style.backgroundColor&&(a.fadeLeft.style.backgroundColor="",a.fadeRight.style.backgroundColor=
"",a.fadeLeft.style.backgroundImage="",a.fadeRight.style.backgroundImage="");b&&(a.resizeLoading(),baseTopCss?a.fadeLeft.style.display||(a.fadeLeft.style.display="none",a.fadeRight.style.display="none"):a.fadeLeft.style.display&&(a.fadeLeft.style.display="",a.fadeRight.style.display=""),a.glCanvas.width=baseWidth*scaleFactor,a.glCanvas.height=baseHeight*scaleFactor,a.glCanvas.style.width=baseWidthCss+"px",a.glCanvas.style.height=baseHeightCss+"px",a.gl.checkRecreate(a.glCanvas)&&a.recreateResources(),
a.currentView&&a.currentView.resize())};a.windowHistoryStatePopped=function(b){a.windowHistoryStatePushed=!1;a.pushHistoryStateIfNecessary();Modal.visible&&Modal.defaultCancelAction()};a.pushHistoryStateIfNecessary=function(){a.windowHistoryStatePushed||a.currentView&&a.currentView instanceof TitleView&&!a._fading&&!Modal.visible||(a.windowHistoryStatePushed=!0,window.history.pushState({pixelMaze:!0},"Pixel Maze"))};a.popHistoryStateIfNecessary=function(){a.windowHistoryStatePushed&&window.history.back()};
Object.defineProperty(a.prototype,"usesGL",{get:function(){return!1},enumerable:!1,configurable:!0});Object.defineProperty(a.prototype,"pausedBackground",{get:function(){return!1},enumerable:!1,configurable:!0});a.prototype.releaseResources=function(){};a.prototype.loadResources=function(){};a.prototype.resize=function(){for(var b=this.buttons.length-1;0<=b;b--){var c=this.buttons[b];c.style.width=buttonHeightCss;c.style.height=buttonHeightCss;c.style.fontSize=fontSizeCss;c.style.lineHeight=iconSizeCss}for(b=
this.buttonImages.length-1;0<=b;b--)UISpriteSheet.resize(this.buttonImages[b]);for(b=this.buttonsWithMargin.length-1;0<=b;b--)this.buttonsWithMargin[b].style.marginLeft=buttonMarginCss;for(b=this.buttonsWithLargeMargin.length-1;0<=b;b--)this.buttonsWithLargeMargin[b].style.marginLeft=buttonLargeMarginCss};a.prototype.fadeInFinished=function(){};a.prototype.createButton=function(b,c,e){for(var d=[],f=3;f<arguments.length;f++)d[f-3]=arguments[f];f=document.createElement("button");var g=UISpriteSheet.create(c,
f);f.setAttribute("type","button");prepareButtonBlink(f,!1,e);b&&b.appendChild(f);this.buttons.push(f);this.buttonImages.push(g);if(d)for(g=0;g<d.length;g+=2)f.setAttribute(d[g],d[g+1]);return f};a.prototype.finishFadeIn=function(b){var c=this;setTimeout(function(){c.resize();a.refreshGL(c);a.cover.classList.remove("visible");setTimeout(function(){a._fading=!1;a.popHistoryStateIfNecessary();document.body.removeChild(a.cover);c.fadeInFinished();b()},520)},50)};a.prototype.fadeIn=function(){return __awaiter(this,
void 0,void 0,function(){var b=this;return __generator(this,function(c){if(a._fading||a.currentView===this)return[2,null];a._fading=!0;a.currentView=this;return[2,new Promise(function(e,d){if((d=b.initialElements)&&!b.attached){for(var f=0;f<d.length;f++){var g=d[f];g&&a.main.appendChild(g)}b.attached=!0;if(d=b.attach()){d.then(function(){b.finishFadeIn(e)},function(h){console.error(h)});return}}b.finishFadeIn(e)})]})})};a.prototype.fadeOut=function(b){return __awaiter(this,void 0,void 0,function(){var c=
this;return __generator(this,function(e){if(a._fading||a.currentView!==this)return[2,null];a._fading=!0;a.backgroundFrameRequest&&(cancelAnimationFrame(a.backgroundFrameRequest),a.backgroundFrameRequest=0);return[2,new Promise(function(d,f){document.body.appendChild(a.cover);setTimeout(function(){a.cover.classList.add("visible");setTimeout(function(){return __awaiter(c,void 0,void 0,function(){return __generator(this,function(g){switch(g.label){case 0:return[4,this.destroy(b)];case 1:return g.sent(),
...
this.alive=!1;this.paused=!0;this.frameRequest&&(cancelAnimationFrame(this.frameRequest),this.frameRequest=0);this.fadeToPrevious();return!0};b.prototype.pause=function(c){var e=this;if(!this.alive)return!1;if(!this.paused){c=ControlMode.accelerationSupported?UISpriteSheet.html(ControlMode.modeImage):null;var d=!1,f=!1;if(!Modal.show({title:Strings.Pause,html:(androidWrapper||isPWA?"":'<button type="button" id="fullscreen" data-style="margin-bottom: '+buttonMargin+'">'+UISpriteSheet.html(UISpriteSheet.Fullscreen)+
Strings.Fullscreen+"</button><br/>")+(c?'<button type="button" id="controlMode" data-style="margin-bottom: '+buttonMargin+'">'+c+Strings.ControlMode+"</button><br/>":"")+('<button type="button" id="restart">'+UISpriteSheet.html(UISpriteSheet.Restart)+Strings.Restart+"</button>"),buttons:[{iconId:UISpriteSheet.Back,text:Strings.Exit,onclick:function(){Modal.hide();e.back(null)}},{defaultCancel:!0,iconId:UISpriteSheet.PlayGreen,text:Strings.Play,className:"accept",onclick:function(){d=!0;Modal.hide()}}],
onbuttonclick:function(g){switch(g){case "fullscreen":FullscreenControl.toggleFullscreen();break;case "controlMode":ControlMode.toggleMode();UISpriteSheet.change(document.getElementById("controlMode").firstChild,ControlMode.modeImage);break;case "restart":f=!0,Modal.hide()}},onhidden:function(){d?e.pause(null):f&&e.restart()}}))return!1}this.paused=!this.paused;this.frameRequest&&(cancelAnimationFrame(this.frameRequest),this.frameRequest=0);this.alive&&(this.frameRequest=requestAnimationFrame(this.boundRender));
return!0};b.prototype.mouseDown=function(c){if(View.loading||!this.alive||this.paused||ControlMode.mode!==ControlMode.Pointer||this.finished)return!1;var e=model(c.clientX-baseLeftCss);c=model(c.clientY-baseTopCss);this.pointerCursorAttached[0]=1;this.pointerCursorCenterX[0]=e;this.pointerCursorX[0]=e;this.pointerCursorCenterY[0]=c;this.pointerCursorY[0]=c;return!0};b.prototype.mouseMove=function(c){this.pointerCursorX[0]=modelFrac(c.clientX-baseLeftCss);this.pointerCursorY[0]=modelFrac(c.clientY-
baseTopCss)};b.prototype.mouseUp=function(c){this.pointerCursorAttached[0]=0};b.prototype.checkRecord=function(){if(!(this.alive&&this.level&&this.totalElapsedMilliseconds&&this.victory&&this.victory[0]))return null;var c=LevelCache.getLevelRecord(this.level.name);return c&&c.time<=this.totalElapsedMilliseconds[0]?null:LevelCache.LastRecordName||""};b.prototype.setTimeDisplayTextRecord=function(c){this.timeDisplayText.nodeValue=LevelCache.formatLevelRecordTime(this.totalElapsedMilliseconds[0])+" - "+
(c||Strings.NoName)};b.prototype.editName=function(c){var e=this;return this.alive&&this.level&&this.totalElapsedMilliseconds&&this.victory&&this.victory[0]?Modal.show({title:Strings.NewRecord,html:'<label for="name">'+Strings.Name+'</label><input id="name" spellcheck="false" autocomplete="off" maxlength="8" /><br/><label>'+Strings.Time+"</label><label>"+LevelCache.formatLevelRecordTime(this.totalElapsedMilliseconds[0])+"</label>",okcancel:!0,okcancelsubmit:!0,onshowing:function(){var d=Modal.currentModalHeaderElement;
if(d){d.setAttribute("data-style","line-height:"+iconSize);var f=UISpriteSheet.create(UISpriteSheet.Trophy);f.setAttribute("data-style","margin-right:"+buttonMargin);d.insertBefore(f,d.firstChild);UISpriteSheet.create(UISpriteSheet.Trophy,d).setAttribute("data-style","margin-left:"+buttonMargin)}document.getElementById("name").value=LevelCache.LastRecordName||""},onshown:function(){document.getElementById("name").focus()},onok:function(){return __awaiter(e,void 0,void 0,function(){var d;return __generator(this,
function(f){if(!this.alive||!this.level||!this.totalElapsedMilliseconds)return[2];(d=document.getElementById("name").value.trim())?LevelCache.setLevelRecord(this.level.name,this.totalElapsedMilliseconds[0],d):(LevelCache.deleteLevelRecord(this.level.name),LevelCache.clearLastRecordName());this.setTimeDisplayTextRecord(d);Modal.hide();return[2]})})}}):!1};b.prototype.render=function(c){var e=this;if(this.alive){this.frameRequest=View.glPaused?0:requestAnimationFrame(this.boundRender);var d=this.level;
View.drawBackground(c,d.levelPtr,!0,!this.finished)?(ControlMode.mode!==ControlMode.Pointer&&androidWrapper&&ControlMode.processAndroidAcceleration(),d.step(this.paused),c=View.gl,c.draw(this.levelTexture,LevelSpriteSheet.LevelModelCoordinates,this.globalAlpha[0],LevelSpriteSheet.FullTextureCoordinates,0,-(this.viewY[0]*scaleFactor|0)),c.prepareNativeDraw(View.sheetTexture),cLib._render(c.verticesPtr,d.levelPtr,LevelSpriteSheet.LevelSpriteSheetPtr,scaleFactor)&&(this.finished=!0,this.pointerCursorAttached[0]=
0,this.preview?this.pause(null):(this.totalElapsedMilliseconds&&(d=this.checkRecord(),null===d?(UISpriteSheet.change(this.timeDisplayImage,UISpriteSheet.Clock),this.timeDisplayText.nodeValue=LevelCache.formatLevelRecordTime(this.totalElapsedMilliseconds[0]),this.editNameButton.style.display="none"):(d&&LevelCache.setLevelRecord(this.level.name,this.totalElapsedMilliseconds[0],d),UISpriteSheet.change(this.timeDisplayImage,UISpriteSheet.Trophy),this.setTimeDisplayTextRecord(d),this.editNameButton.style.display=
