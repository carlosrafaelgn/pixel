...
buttonHeightCss,e.style.borderWidth=borderWidthCss,e.style.fontSize=fontSizeCss,e.style.lineHeight=iconSizeCss,e.style.paddingLeft=buttonPaddingCss,e.style.paddingRight=buttonPaddingCss;if((b=this.modalElement.getElementsByTagName("span"))&&b.length)for(c=b.length-1;0<=c;c--)e=b[c],e.getAttribute(UISpriteSheet.SheetId)&&(UISpriteSheet.resize(e),"BUTTON"===e.parentNode.tagName&&(e.style.marginRight=buttonMarginCss));if(this.options.onresized)this.options.onresized()}};a.modal=null;return a}(),View=
...
!1;a.pushHistoryStateIfNecessary();Modal.visible&&Modal.defaultCancelAction()};a.pushHistoryStateIfNecessary=function(){a.windowHistoryStatePushed||a.currentView&&a.currentView instanceof TitleView&&!a._fading&&!Modal.visible||(a.windowHistoryStatePushed=!0,window.history.pushState({pixelMaze:!0},"Pixel Maze"))};a.popHistoryStateIfNecessary=function(){a.windowHistoryStatePushed&&window.history.back()};Object.defineProperty(a.prototype,"usesGL",{get:function(){return!1},enumerable:!1,configurable:!0});
