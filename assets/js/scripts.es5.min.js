...
b.appendChild(this.container));this.container.className=c?"container":"container scrollable-container";c||(this.parent.style.overflow="hidden");this.scrollContainer=document.createElement("div");this.scrollContainer.className=e?"scroll-container "+e:"scroll-container";this.container.appendChild(this.scrollContainer);this.scrollThumb=UISpriteSheet.create(UISpriteSheet.ScrollThumb,this.parent);this.scrollThumb.className="scroll-thumb";this.containerPointerHandler=this.pointerHandler=null;this.boundDocumentWheel=
this.documentWheel.bind(this);this.scrollThumbInitialTopCss=this.scrollThumbTopCss=this.scrollThumbTopPercent=this.scrollContainerTopCss=this.contentHeight=this.availableHeight=this.containerTopCss=this.pointerLastY=0;this.scrollThumbOnly=c;this.ignoreScroll=!1;c||(this.container.onscroll=this.containerScroll.bind(this))}Object.defineProperty(a.prototype,"topCss",{get:function(){return this.scrollContainerTopCss},enumerable:!1,configurable:!0});Object.defineProperty(a.prototype,"element",{get:function(){return this.container},
