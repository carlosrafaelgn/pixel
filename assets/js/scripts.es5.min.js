...
!0;this.documentTarget.addEventListener(this.documentMoveEvent,this.boundDocumentMove,{capture:!0,passive:!1});this.documentTarget.addEventListener(this.documentUpEvent,this.boundDocumentUp,!0);this.documentCancelEvent&&this.documentTarget.addEventListener(this.documentCancelEvent,this.boundDocumentUp,!0);return cancelEvent(b)}};a.prototype.mouseMove=function(b){if(this.captured)return this.moveCallback&&this.moveCallback(b),cancelEvent(b)};a.prototype.mouseUp=function(b){if(this.captured)return this.documentTarget.removeEventListener(this.documentUpEvent,
this.boundDocumentUp,!0),this.documentTarget.removeEventListener(this.documentMoveEvent,this.boundDocumentMove,!0),this.documentCancelEvent&&this.documentTarget.removeEventListener(this.documentCancelEvent,this.boundDocumentUp,!0),this.captured=!1,this.upCallback&&this.upCallback(b),cancelEvent(b)};return a}(),ScrollContainer=function(){function a(b,c,e,d){void 0===c&&(c=!1);void 0===e&&(e=null);void 0===d&&(d=null);d?(this.parent=d.parentNode,this.container=d):(this.parent=b,this.container=document.createElement("div"),
b.appendChild(this.container));this.container.className=c?"container":"container scrollable-container";this.scrollContainer=document.createElement("div");this.scrollContainer.className=e?"scroll-container "+e:"scroll-container";this.container.appendChild(this.scrollContainer);this.scrollThumb=UISpriteSheet.create(UISpriteSheet.ScrollThumb,this.parent);this.scrollThumb.className="scroll-thumb";this.containerPointerHandler=this.pointerHandler=null;this.boundDocumentWheel=this.documentWheel.bind(this);
this.scrollThumbInitialTopCss=this.scrollThumbTopCss=this.scrollThumbTopPercent=this.scrollContainerTopCss=this.contentHeight=this.availableHeight=this.containerTopCss=this.pointerLastY=0;this.scrollThumbOnly=c;this.ignoreScroll=!1;c||(this.container.onscroll=this.containerScroll.bind(this))}Object.defineProperty(a.prototype,"topCss",{get:function(){return this.scrollContainerTopCss},enumerable:!1,configurable:!0});Object.defineProperty(a.prototype,"element",{get:function(){return this.container},
enumerable:!1,configurable:!0});Object.defineProperty(a.prototype,"containerElement",{get:function(){return this.scrollContainer},enumerable:!1,configurable:!0});a.prototype.resize=function(b,c){this.containerTopCss=cssNumber(b);this.availableHeight=c;1>this.availableHeight&&(this.availableHeight=1);this.container.style.top=css(b);this.container.style.height=css(c);UISpriteSheet.resize(this.scrollThumb);b=this.scrollContainer.getBoundingClientRect();this.contentHeight=model(b.bottom-b.top);1>this.contentHeight&&
(this.contentHeight=1);b=this.contentHeight<=this.availableHeight?"none":"";this.scrollThumb.style.display!==b&&(this.scrollThumb.style.display=b);this.scrollTo(this.scrollThumbTopPercent)};a.prototype.attach=function(){this.pointerHandler=new PointerHandler(this.scrollThumb,this.mouseDown.bind(this),this.mouseMove.bind(this));document.addEventListener("wheel",this.boundDocumentWheel,{capture:!0,passive:!1})};a.prototype.detach=function(){this.pointerHandler&&(this.pointerHandler.destroy(),this.pointerHandler=
null);document.removeEventListener("wheel",this.boundDocumentWheel,!0)};a.prototype.adjustScrollUI=function(b,c){void 0===c&&(c=-1);this.contentHeight<=this.availableHeight||0>=b?c=b=0:(1<b&&(b=1),0>c&&(c=cssNumber(b*(this.availableHeight-scrollThumbHeight))));this.scrollThumbTopPercent=b;this.scrollThumbTopCss=c;this.scrollThumb.style.top=this.containerTopCss+c+"px";this.scrollContainerTopCss=this.contentHeight<=this.availableHeight?0:cssNumber(-this.scrollThumbTopPercent*(this.contentHeight-this.availableHeight))};
a.prototype.scrollTo=function(b,c){void 0===c&&(c=-1);this.adjustScrollUI(b,c);this.scrollThumbOnly?this.scrollContainer.style.marginTop=this.scrollContainerTopCss+"px":(this.ignoreScroll=!0,this.container.scrollTop=-this.scrollContainerTopCss)};a.prototype.mouseDown=function(b){var c=this.container.getBoundingClientRect();this.pointerLastY=b.clientY-c.top;this.scrollThumbInitialTopCss=this.scrollThumbTopCss;return!0};a.prototype.mouseMove=function(b){var c=this.container.getBoundingClientRect();
b=this.scrollThumbInitialTopCss+(b.clientY-c.top-this.pointerLastY);b=0>b?0:model(b)+scrollThumbHeight>this.availableHeight?cssNumber(this.availableHeight-scrollThumbHeight):(b*pixelRatio|0)/pixelRatio;b!==this.scrollThumbTopCss&&this.scrollTo(model(b)/(this.availableHeight-scrollThumbHeight),b)};a.prototype.documentWheel=function(b){return Modal.visible?!1:(0>b.deltaY?this.scrollTo(this.scrollThumbTopPercent-.1):0<b.deltaY&&this.scrollTo(this.scrollThumbTopPercent+.1),cancelEvent(b))};a.prototype.containerScroll=
...
document.createElement("div");this.modalHeaderElement.className="modal-decoration";this.modalHeaderElement.innerHTML=b.title||Strings.Oops;this.modalBodyElement=document.createElement("div");this.modalBodyElement.className="modal-body";"string"===typeof b.html?this.modalBodyElement.innerHTML=b.html:this.modalBodyElement.appendChild(b.html);var e=this.modalBodyElement.getElementsByTagName("button");if(e&&e.length)for(var d=function(l){var k=e[l];prepareButtonBlink(k,!0,function(){if(c.fading)return!1;
if(c.options.onbuttonclick)c.options.onbuttonclick(k.id,k);return!0})},f=e.length-1;0<=f;f--)d(f);if((d=this.modalBodyElement.getElementsByTagName("span"))&&d.length)for(f=d.length-1;0<=f;f--){var g=d[f];g.getAttribute(UISpriteSheet.SheetId)&&UISpriteSheet.finishHTMLCreation(g)}this.modalFooterElement=document.createElement("div");this.modalFooterElement.className="modal-decoration";this.defaultSubmitButton=this.defaultCancelButton=null;d=function(l){var k=b.buttons[l],m=document.createElement("button");
k.defaultCancel&&(h.defaultCancelButton=m);k.defaultSubmit&&(h.defaultSubmitButton=m);m.style.height=buttonHeightCss;m.style.borderWidth=borderWidthCss;k.className&&(m.className=k.className);l&&(m.style.float="right");m.setAttribute("type","button");UISpriteSheet.create(k.iconId,m);m.appendChild(document.createTextNode(k.text));prepareButtonBlink(m,!0,function(){if(c.fading)return!1;if(k.onclick)k.onclick(k.id,m);if(c.options.onbuttonclick)c.options.onbuttonclick(k.id,m);return!0});h.modalFooterElement.appendChild(m)};
var h=this;for(f=0;f<b.buttons.length;f++)d(f);this.modalElement.appendChild(this.modalHeaderElement);this.modalElement.appendChild(this.modalBodyElement);this.modalElement.appendChild(this.modalFooterElement);this.containerElement.appendChild(this.modalElement);View.main.appendChild(this.containerElement);this.boundDocumentKeyDown=this.documentKeyDown.bind(this);document.addEventListener("keydown",this.boundDocumentKeyDown,!0);this.fading=!0;setTimeout(function(){if(b.onshowing)b.onshowing();c.resizeInternal();
c.containerElement.classList.add("visible");setTimeout(function(){c.fading=!1;View.pushHistoryStateIfNecessary();if(c.options.onshown)c.options.onshown()},520)},50)}Object.defineProperty(a,"visible",{get:function(){return!!a.modal},enumerable:!1,configurable:!0});Object.defineProperty(a,"currentModalElement",{get:function(){return a.modal?a.modal.modalElement:null},enumerable:!1,configurable:!0});Object.defineProperty(a,"currentModalHeaderElement",{get:function(){return a.modal?a.modal.modalHeaderElement:
...
0;d.keyUpTime=0;d.keyUpCounter=0;d.highlightTool();return d}__extends(b,a);b.prototype.setGridBackground=function(){this.scrollContainer.containerElement.style.backgroundImage="url('assets/images/grid"+(5>=scaleFactor?scaleFactor:1)+".png')"};Object.defineProperty(b.prototype,"pausedBackground",{get:function(){return!0},enumerable:!1,configurable:!0});b.prototype.resize=function(){var c=css(63),e=css(maxHeight),d=css(b.BrushWidths[this.lastBrushWidth]);this.toolbarTop.style.height=toolbarAvailableHeightCss;
this.toolbarTop.style.borderBottomWidth=borderWidthCss;this.toolbarBottom.style.height=toolbarAvailableHeightCss;this.toolbarBottom.style.borderTopWidth=borderWidthCss;this.canvas.style.height=e;this.setGridBackground();this.scrollContainer.containerElement.style.backgroundSize=c+" "+c;this.scrollContainer.resize(toolbarTotalHeight,baseHeight-(toolbarTotalHeight<<1));this.pointerCursor.style.borderWidth=borderWidthCss;this.pointerCursor.style.width=d;this.pointerCursor.style.height=d;c=this.level.objects;
for(e=c.length-1;0<=e;e--){d=c[e];var f=this.objectImages[e];f.style.left=css(d.x-iconRadius);f.style.top=css(d.y-iconRadius);UISpriteSheet.resize(f)}a.prototype.resize.call(this)};b.prototype.attach=function(){return __awaiter(this,void 0,void 0,function(){var c,e,d,f,g,h,l;return __generator(this,function(k){switch(k.label){case 0:View.glCanvas.style.display="none";if(this.level)return[3,2];c=this;return[4,LevelCache.loadLevelFromOptions(this.loadOptions)];case 1:c.level=k.sent();this.loadOptions&&
(this.loadOptions.levelNameOverride&&(this.level.name=this.loadOptions.levelNameOverride),this.loadOptions=null);e=this.level.objects;d=e.length;for(f=0;f<d;f++)this.addObject(e[f],!0);k.label=2;case 2:return this.pointerHandler=new PointerHandler(this.canvas,this.mouseDown.bind(this),this.mouseMove.bind(this),this.mouseUp.bind(this)),this.scrollContainer.attach(),[4,loadImage(b.brushesImageDataBase64)];case 3:g=k.sent();this.brushCanvas=document.createElement("canvas");this.brushCanvas.width=g.width;
this.brushCanvas.height=g.height;this.brushContext=this.brushCanvas.getContext("2d",{alpha:!0});this.brushContext.drawImage(g,0,0);this.updateBrushColor(colors[this.lastPencilColor]);this.context=this.canvas.getContext("2d",{alpha:!0});this.context.globalCompositeOperation="source-over";this.context.clearRect(0,0,baseWidth,maxHeight);setContextQuality(this.context,!1);if(!this.level.image)return[3,5];l=(h=this.context).drawImage;return[4,loadImage(this.level.image)];case 4:l.apply(h,[k.sent(),0,0]),
k.label=5;case 5:return this.context.globalCompositeOperation=this.contextGlobalCompositeOperation,this.boundDocumentKeyUp&&document.addEventListener("keyup",this.boundDocumentKeyUp,!0),[2]}})})};b.prototype.detach=function(){return __awaiter(this,void 0,void 0,function(){return __generator(this,function(c){View.glCanvas.style.display="";this.pointerHandler&&(this.pointerHandler.destroy(),this.pointerHandler=null);this.scrollContainer.detach();this.brushContext=this.brushCanvas=this.context=null;
this.boundDocumentKeyUp&&document.removeEventListener("keyup",this.boundDocumentKeyUp,!0);return[2]})})};b.prototype.destroyInternal=function(c){this.save()};b.prototype.save=function(){if(this.dirty||!this.level.image)this.level.modifiedAt=(new Date).getTime(),this.level.createdAt||(this.level.createdAt=this.level.modifiedAt),this.level.thumbnailImage="",this.level.image=this.canvas.toDataURL("image/png"),this.level.processedImage="",this.level.polygons=[],LevelCache.saveEditorLevel(this.level),
this.dirty=!1};b.prototype.updatePointerCursor=function(c,e){var d=cssNumber(.5*b.BrushWidths[this.lastBrushWidth]+1);this.pointerCursor.style.left=c-d+"px";this.pointerCursor.style.top=e-d+this.scrollContainer.topCss+"px"};b.prototype.mouseDown=function(c){if(View.loading)return!1;var e=this.scrollContainer.containerElement.getBoundingClientRect(),d=c.clientX-e.left;c=c.clientY-e.top;this.dirty=!0;switch(this.tool){case b.ToolPencil:case b.ToolEraser:this.pointerCursorAttached||(this.pointerCursorAttached=
!0,this.updatePointerCursor(d,c),this.scrollContainer.element.appendChild(this.pointerCursor));this.draw((this.pointerLastX=model(d)-1)+1,this.pointerLastY=model(c));break;default:this.handleObjectToolDown(d,c)}return!0};b.prototype.mouseMove=function(c){var e=this.scrollContainer.containerElement.getBoundingClientRect(),d=c.clientX-e.left;c=c.clientY-e.top;switch(this.tool){case b.ToolPencil:case b.ToolEraser:e=model(d);var f=model(c);if(this.pointerLastX!==e||this.pointerLastY!==f)this.updatePointerCursor(d,
c),this.draw(e,f),this.pointerLastX=e,this.pointerLastY=f;break;default:this.handleObjectToolMove(d,c)}};b.prototype.mouseUp=function(c){this.objectImageDrag=null;this.pointerCursorAttached&&(this.pointerCursorAttached=!1,this.scrollContainer.element.removeChild(this.pointerCursor));switch(this.tool){case b.ToolPencil:case b.ToolEraser:return}c=this.level.objects;var e=this.objectImages;e.sort(function(h,l){h=h.object;l=l.object;return h.type-l.type||l.y-h.y});for(var d=e.length-1,f=1;0<=d;d--,f++){var g=
e[d];g.style.zIndex=f.toString();c[d]=g.object}};b.prototype.draw=function(c,e){c-=this.pointerLastX;e-=this.pointerLastY;var d=Math.abs(c),f=Math.abs(e);if(d||f){var g=b.BrushWidths[this.lastBrushWidth],h=g>>1,l=b.BrushOffsets[this.lastBrushWidth];d=Math.max(d,f);f=this.pointerLastX;var k=this.pointerLastY;c/=d;for(e/=d;0<d;)d--,f+=c,k+=e,d&1||(this.lastPencilColor===colors.length-1&&(this.lastPencilRainbowIndex++,this.lastPencilRainbowIndex>=rainbowColors.length&&(this.lastPencilRainbowIndex=0),
this.updateBrushColor(rainbowColors[this.lastPencilRainbowIndex])),this.context.drawImage(this.brushCanvas,l,0,g,g,(f|0)-h,(k|0)-h,g,g))}};b.prototype.handleObjectToolDown=function(c,e){var d=model(c),f=model(e);if(this.tool>=b.ToolBall&&this.tool<=b.ToolCucumber){this.objectImageDrag=this.findObjectWithinRadius(-1,d,f);if(!this.objectImageDrag&&(this.objectImageDrag=this.addObject(new LevelObject(this.lastObjectType,d,f),!1),!this.objectImageDrag))return;d=this.scrollContainer.containerElement.getBoundingClientRect();
f=this.objectImageDrag.getBoundingClientRect();this.objectImageDragOffsetXCss=f.left-d.left-c;this.objectImageDragOffsetYCss=f.top-d.top-e}else(c=this.findObjectWithinRadius(-1,d,f))&&this.removeObject(c)};b.prototype.handleObjectToolMove=function(c,e){if(this.tool>=b.ToolBall&&this.tool<=b.ToolCucumber&&this.objectImageDrag){var d=this.objectImageDrag.object;d&&(d.move(model(c+this.objectImageDragOffsetXCss)+iconRadius,model(e+this.objectImageDragOffsetYCss)+iconRadius),this.objectImageDrag.style.left=
css(d.x-iconRadius),this.objectImageDrag.style.top=css(d.y-iconRadius))}};b.prototype.highlightTool=function(){for(var c=this.firstPencilButtonIndex,e=c+(this.tool===b.ToolEraser?colors.length:this.lastPencilColor);c<e;c++)this.buttons[c].style.backgroundColor="";if(this.tool===b.ToolPencil||this.tool===b.ToolEraser)this.buttons[c++].style.backgroundColor="#fff";for(e=this.firstPencilButtonIndex+colors.length;c<=e;c++)this.buttons[c].style.backgroundColor="";c=this.firstLineWidthButtonIndex;for(e=
c+this.lastBrushWidth;c<e;c++)this.buttons[c].style.backgroundColor="";if(this.tool===b.ToolPencil||this.tool===b.ToolEraser)this.buttons[c++].style.backgroundColor="#fff";for(e=this.firstLineWidthButtonIndex+b.BrushWidths.length;c<e;c++)this.buttons[c].style.backgroundColor="";c=this.firstObjectToolButtonIndex;for(e=c+this.tool-b.FirstObjectTool;c<e;c++)this.buttons[c].style.backgroundColor="";this.tool>=b.FirstObjectTool&&(this.buttons[c++].style.backgroundColor="#fff");for(e=this.firstObjectToolButtonIndex+
...
document.getElementById("name").value.trim(),h?LevelCache.isNameValid(h)||(f=!0,Modal.hide()):(l=new Date,h=l.getFullYear()+"-"+format2(l.getMonth()+1)+"-"+format2(l.getDate())+" "+format2(l.getHours())+format2(l.getMinutes())+format2(l.getSeconds())),h!==this.level.name&&(this.level.name=h,this.dirty=!0,this.save()),View.loading=!0,k.label=1;case 1:return k.trys.push([1,4,5,6]),[4,this.level.prepare()];case 2:return k.sent(),[4,LevelCache.saveLevel(this.level,!1)];case 3:return k.sent(),d=!0,[3,
6];case 4:return k.sent(),g=!0,[3,6];case 5:return View.loading=!1,Modal.hide(),[7];case 6:return[2]}})})},onhidden:function(){f?Modal.show({html:Strings.NameCannotContain+" \\ / ? * : < > % "+UISpriteSheet.html(UISpriteSheet.Error)}):g?Modal.show({html:Strings.SomethingWentWrong+UISpriteSheet.html(UISpriteSheet.Error)}):d&&Modal.show({title:Strings.Success,html:Strings.LevelSaved+UISpriteSheet.html(UISpriteSheet.Success)})}});return!0};b.prototype.play=function(c){var e=this;this.save();View.loading=
!0;this.level.prepare().then(function(){View.loading=!1;e.fadeTo(new GameView({level:e.level},!0),!0)},function(d){View.loading=!1;if(d&&d.message){if(d.message===Level.MaxPolygonCountMessage){Modal.show({html:Strings.TooManyPolygons+Level.MaxPolygonCount+" "+UISpriteSheet.html(UISpriteSheet.Error)});return}if(d.message===Level.MaxPointCountMessage){Modal.show({html:Strings.TooManyPoints+Level.MaxPointCount+" "+UISpriteSheet.html(UISpriteSheet.Error)});return}}Modal.show({html:Strings.SomethingWentWrong+
UISpriteSheet.html(UISpriteSheet.Error)})});return!0};b.prototype.documentKeyUp=function(c){if(!View.loading&&!Modal.visible)if("d"===c.key)this.keyUpTime=Date.now(),this.keyUpCounter=1;else switch(this.keyUpCounter){case 1:this.keyUpCounter="b"===c.key&&2E3>Date.now()-this.keyUpTime?2:0;break;case 2:if(2E3>Date.now()-this.keyUpTime)switch(c.key){case "g":confirm(Strings.YouWillLoseYourLevel)&&this.devDebug();break;case "s":this.devSave()}this.keyUpCounter=0}};b.prototype.devDebug=function(){processImage(this.canvas,
this.context,!0)};b.prototype.devSave=function(){return __awaiter(this,void 0,void 0,function(){var c,e,d,f=this;return __generator(this,function(g){switch(g.label){case 0:return this.level.name="0",this.save(),[4,this.level.prepare()];case 1:return g.sent(),c=document.createElement("a"),c.href=this.level.image,c.download="image.png",c.click(),e=document.createElement("a"),e.href=this.level.processedImage,e.download="processedImage.png",e.click(),d=document.createElement("a"),d.href=this.level.thumbnailImage,
d.download="thumbnailImage.png",d.click(),Modal.show({html:'I <input id="inputImage" type="file" accept="image/png" />\n\t\t\tP <input id="inputProcessedImage" type="file" accept="image/png" />\n\t\t\tT <input id="inputThumbnailImage" type="file" accept="image/png" />',okcancel:!0,onok:function(){var h=new FileReader;h.onload=function(){var l=new FileReader;l.onload=function(){var k=new FileReader;k.onload=function(){f.level.createdAt=0;f.level.modifiedAt=0;f.level.image=h.result;f.level.processedImage=
l.result;f.level.thumbnailImage=null;console.log("'"+JSON.stringify(f.level)+"',");console.log("'"+k.result+"',");Modal.hide()};k.readAsDataURL(document.getElementById("inputThumbnailImage").files[0])};l.readAsDataURL(document.getElementById("inputProcessedImage").files[0])};h.readAsDataURL(document.getElementById("inputImage").files[0])}}),[2]}})})};b.brushesImageDataBase64="data:image/png;base64,";
b.ToolPencil=0;b.ToolEraser=1;b.ToolBall=2;b.ToolGoal=3;b.ToolBomb=4;b.ToolCucumber=5;b.ToolDeleteObject=6;b.FirstObjectTool=b.ToolBall;b.ObjectToolCount=5;b.BrushOffsets=[0,10,26,46];b.BrushWidths=[9,15,19,39];return b}(View),GameView=function(a){function b(c,e){var d=a.call(this)||this,f=d.createButton(null,UISpriteSheet.Back,d.back.bind(d));f.style.position="absolute";f.style.left="0";f.style.top="0";d.backButton=f;e&&d.initialElements.push(f);(d.preview=e)?(d.restartButton=null,d.timeDisplayImage=
null,d.editNameButton=null,d.timeDisplay=null):(e=d.createButton(null,UISpriteSheet.Restart,d.restart.bind(d)),e.style.position="absolute",e.style.top="0",d.restartButton=e,e=document.createElement("div"),e.style.position="absolute",d.timeDisplayImage=UISpriteSheet.create(UISpriteSheet.Clock,e),e.appendChild(d.timeDisplayText=document.createTextNode(Strings.Time)),d.editNameButton=d.createButton(e,UISpriteSheet.Edit,d.editName.bind(d)),d.timeDisplay=e);e=d.createButton(null,UISpriteSheet.Pause,d.pause.bind(d));
e.style.position="absolute";e.style.right="0";e.style.top="0";d.initialElements.push(e);d.resourceStorage=new ResourceStorage;d.boundRender=d.render.bind(d);d.alive=!0;d.paused=!1;d.finished=!1;d.alreadyCreated=!1;d.loadOptions=c;d.level=null;d.viewY=null;d.frameRequest=0;d.finalUIAttached=!1;d.pointerHandler=null;d.pointerCursorAttached=null;d.totalElapsedMilliseconds=null;d.victory=null;d.pointerCursorCenterX=null;d.pointerCursorCenterY=null;d.pointerCursorX=null;d.pointerCursorY=null;d.levelTexture=
null;return d}__extends(b,a);Object.defineProperty(b.prototype,"usesGL",{get:function(){return!0},enumerable:!1,configurable:!0});b.prototype.releaseResources=function(){this.alive&&this.resourceStorage.release()};b.prototype.loadResources=function(){this.alive&&(this.resourceStorage.load(),LevelSpriteSheet.LevelModelCoordinates.setCoordinates(0,0,this.levelTexture.width*scaleFactor,this.levelTexture.height*scaleFactor),this.alreadyCreated?(this.frameRequest&&(cancelAnimationFrame(this.frameRequest),
...
[3,4];case 3:c.sent(),b.wakeLockSentinel=null,c.label=4;case 4:return[3,6];case 5:return c.sent(),[3,6];case 6:return[2]}})})};b.prototype.destroyInternal=function(c){this.alreadyCreated=this.alive=!1;this.level.destroyLevelPtr();this.pointerCursorY=this.pointerCursorX=this.pointerCursorCenterY=this.pointerCursorCenterX=this.victory=this.totalElapsedMilliseconds=this.pointerCursorAttached=this.viewY=null;c?this.resourceStorage.release():this.resourceStorage.destroy()};b.prototype.restart=function(){if(!this.alive)return!1;
...
LevelCache.formatLevelRecordTime(this.totalElapsedMilliseconds[0]),this.editNameButton.style.display="none"):(e&&LevelCache.setLevelRecord(this.level.name,this.totalElapsedMilliseconds[0],e),UISpriteSheet.change(this.timeDisplayImage,UISpriteSheet.Trophy),this.setTimeDisplayTextRecord(e),this.editNameButton.style.display="")),this.finalUIAttached||(this.finalUIAttached=!0,this.preview||(View.main.appendChild(this.backButton),View.main.appendChild(this.restartButton),View.main.appendChild(this.timeDisplay)))))):
