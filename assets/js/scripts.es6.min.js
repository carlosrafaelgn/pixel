...
cover.classList.remove("visible");setTimeout(()=>{View._fading=!1;View.popHistoryStateIfNecessary();document.body.removeChild(cover);this.fadeInFinished();a()},520)},50)}fadeIn(){return __awaiter(this,void 0,void 0,function*(){if(View._fading||View.currentView===this)return null;View._fading=!0;View.currentView=this;return new Promise((a,b)=>{if((b=this.initialElements)&&!this.attached){for(let c=0;c<b.length;c++){const d=b[c];d&&main.appendChild(d)}this.attached=!0;if(b=this.attach()){b.then(()=>
{this.finishFadeIn(a)},c=>{console.error(c)});return}}this.finishFadeIn(a)})})}fadeOut(a){return __awaiter(this,void 0,void 0,function*(){if(View._fading||View.currentView!==this)return null;View._fading=!0;View.backgroundFrameRequest&&(cancelAnimationFrame(View.backgroundFrameRequest),View.backgroundFrameRequest=0);return new Promise((b,c)=>{document.body.appendChild(cover);setTimeout(()=>{cover.classList.add("visible");setTimeout(()=>__awaiter(this,void 0,void 0,function*(){yield this.destroy(a);
...
buttonMarginCss;super.resize()}attach(){return __awaiter(this,void 0,void 0,function*(){glCanvas.style.cursor="default"})}detach(){return __awaiter(this,void 0,void 0,function*(){glCanvas.style.cursor=""})}destroyInternal(a){}play(a){this.fadeTo("SelectionView");return!0}edit(a){this.fadeTo("EditorView");return!0}fullscreen(a){fullscreenControl.toggleFullscreen();return!0}exit(a){androidWrapper.exit();return!0}about(a){a=[{defaultCancel:!0,iconId:UISpriteSheet.Back,text:Strings.Close,onclick:Modal.hide}];
!androidWrapper&&installationPrompt&&installationPrompt.prompt&&a.push({iconId:UISpriteSheet.Download,text:Strings.Install,onclick:(b,c)=>{if(installationPrompt)try{b=installationPrompt,installationPrompt=null,b.prompt()}catch(d){}setTimeout(()=>{c.style.display="none"},blinkTotalDurationMS)}});Modal.show({title:Strings.About+` <span style="float: right;">v${version}${window.pixelES2017?"":"es6"}</span>`,large:!0,html:Strings.About1+(2===View.gl.contextVersion?Strings.About2:"")+Strings.About3+(window.pixelUsingWebAssembly?
