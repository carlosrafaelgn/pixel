...
this.toolbarTop.style.height=toolbarAvailableHeightCss;this.toolbarTop.style.borderBottomWidth=borderWidthCss;for(let k=a.length-1;0<=k;k--){a[k].style.width=thumbnailWidthCss;a[k].style.borderWidth=borderWidthCss;a[k].style.margin=h;a[k].style.padding=m;a[k].style.lineHeight=iconSizeCss;b[k].width=e;b[k].height=f;b[k].style.margin=l;c[k].style.borderTopWidth=borderWidthCss;c[k].style.padding=l;d[k].style.borderWidth=g;d[k].style.padding=buttonPaddingCss;UISpriteSheet.resize(d[k].firstChild);const n=
c[k].childNodes;n[0].style.marginRight=buttonMarginCss;n[3].style.marginRight=buttonMarginCss;UISpriteSheet.resize(n[0]);UISpriteSheet.resize(n[3])}this.scrollContainer.containerElement.style.paddingBottom=toolbarAvailableHeightCss;this.scrollContainer.resize(toolbarTotalHeight,baseHeight-toolbarTotalHeight);super.resize()}updateThumbnailRecord(a,b){if(a&&b){for(a=LevelCache.getLevelRecord(a);b.firstChild;)b.removeChild(b.firstChild);UISpriteSheet.create(UISpriteSheet.Trophy,b);b.appendChild(document.createTextNode(a?
